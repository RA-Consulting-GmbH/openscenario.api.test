...
public class CardinalityCheckerHelper {


	public makeClassJavaDoc(element, version, indent = "")
	{
		def lines = [];
		lines.add("A helper class for adding all cardinality checker rules to a loaded scenario")
		lines.add("all properties and children are checked if they are not optional")
