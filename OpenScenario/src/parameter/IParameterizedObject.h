...
namespace RAC_OPENSCENARIO
{
    ...
    public:
         ...
         */
        virtual std::vector<std::string> GetParameterizedAttributeKeys() = 0;
         ...
         */
        virtual void ResolveParameter(IParserMessageLogger& logger, std::string& attributeKey, std::string& value) = 0;
         ...
         */
        virtual bool HasParameterDefinitions() = 0;

        /**
         * All parameter definition of a parameter.
         * @return a list of ParameterValues
         */
        virtual std::vector<std::shared_ptr<ParameterValue>> GetParameterDefinitions() = 0;
         ...
         */
        virtual std::shared_ptr<Textmarker> GetTextmarker(std::string& attributeKey) = 0;
         ...
         */
        virtual std::string GetParameterNameFromAttribute(std::string& attributeKey) = 0;
         ...
         */
        virtual std::string GetTypeFromAttributeName(std::string& attributeKey) = 0;
    };
}
