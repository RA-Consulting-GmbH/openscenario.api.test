...
namespace RAC_OPENSCENARIO
{
    ...
    private:
        ...
        RAC_XML_INDEXER::ElementNode _elementNode;
        std::string _characters;
        std::shared_ptr < tinyxml2::XMLElement> _element;
        std::shared_ptr<IndexedElement> _parent;
        bool _isMixedNode = false;

    public:

        IndexedElement(): _elementNode(-1,-1), _element(nullptr), _parent(nullptr) {}
        ...
        */
        IndexedElement(std::shared_ptr<tinyxml2::XMLElement>& element, RAC_XML_INDEXER::ElementNode& elementNode, std::shared_ptr<IndexedElement>& parent) :
        ...
        * @return dom element
        */
        std::shared_ptr<tinyxml2::XMLElement> GetElement() const
        {
            return _element;
        }
         ...
         * @return the position
         */
        RAC_XML_INDEXER::Position GetAttributeStartPosition(std::string& attributeName)
        {
         ...
         * @return the position
         */
        RAC_XML_INDEXER::Position GetAttributeEndPosition(std::string& attributeName)
        {
            const auto kAttributeNode = _elementNode.GetAttributeNode(attributeName);
            if (kAttributeNode)
