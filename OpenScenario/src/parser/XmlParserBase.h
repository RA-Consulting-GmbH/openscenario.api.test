...
namespace RAC_OPENSCENARIO
{
    ...
    */
    ...
    public:
         ...
         */
        virtual void ParseSubElements(std::vector<std::shared_ptr<IndexedElement>>& parentElements, ParserContext& parserContext, T& object) {};
         ...
         * @return parsed value
         */
        unsigned long ParseUnsignedInt(std::string& xmlValue, Textmarker& textMarker)
        {
    ...
    */
    ...
    public:
         ...
         * @param object the model object to be filled during the parsing process
         */
        virtual void Parse(RAC_XML_INDEXER::Position& startPosition, RAC_XML_INDEXER::Position& endPosition, std::string& attributeName, std::string& attributeValue, std::shared_ptr<T>& object) {}
