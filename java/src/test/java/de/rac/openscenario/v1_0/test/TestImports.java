...
public class TestImports extends TestBase{
	...
	public void testImportSuccess() {
		try {
			...
			IOpenScenario openScenario =  executeImportParsing(inputDir + "simpleImport/simpleImport.xosc",catalogMessageLogger);
	...
	public void testImportWithParametersSuccess() {
		try {
			...
			IOpenScenario openScenario = executeImportParsing(inputDir + "simpleImportWithParameters/importWithParameters.xosc",catalogMessageLogger);
