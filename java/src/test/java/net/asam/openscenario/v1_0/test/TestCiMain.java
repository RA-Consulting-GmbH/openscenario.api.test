...
public class TestCiMain extends TestBase {
  ...
  public void testDirectorySuccess() {
    ...
    int result =  OpenScenarioCiChecker.mainWrapper(
        new String[] {"-conf",getResourceFile("continuousIntegration/successConf.yml").getAbsolutePath(), "-d",getResourceFile("continuousIntegration").getAbsolutePath()});
