...
import de.rac.openscenario.v1_0.impl.RelativeDistanceConditionImpl;
...
import de.rac.openscenario.v1_0.impl.RelativeSpeedConditionImpl;
import de.rac.openscenario.v1_0.impl.TraveledDistanceConditionImpl;
...
import de.rac.openscenario.v1_0.impl.SpeedConditionImpl;
import de.rac.openscenario.v1_0.impl.ReachPositionConditionImpl;
...
public class EntityConditionXmlParser extends XmlComplexTypeParser<EntityConditionImpl> {
	...
	@Override
	public void parseElement(IndexedElement indexedElement, ParserContext parserContext,EntityConditionImpl object) {
		messageLogger.logMessage(new FileContentMessage("Start Parsing EntityCondition", ErrorLevel.DEBUG, new Textmarker(indexedElement.getStartElementLocation().getLine(), indexedElement.getStartElementLocation().getColumn(), filename))); 
		super.parseElement(indexedElement,  parserContext, object);
		messageLogger.logMessage(new FileContentMessage("End Parsing EntityCondition", ErrorLevel.DEBUG, new Textmarker(indexedElement.getEndElementLocation().getLine(), indexedElement.getEndElementLocation().getColumn(), filename))); 
	
	}			
	
	@Override
	protected  Map<String, IAttributeParser<EntityConditionImpl>> getAttributeNameToAttributeParserMap()
	{
		Map<String, IAttributeParser<EntityConditionImpl>> result  = new Hashtable<String, IAttributeParser<EntityConditionImpl>>();
		return result;
	}
	...
	private class SubElementParser extends XmlChoiceParser<EntityConditionImpl>{
		...
		{
			List<IElementParser<EntityConditionImpl>> result = new ArrayList<IElementParser<EntityConditionImpl>>();
	...
	private class SubElementEndOfRoadConditionParser implements IElementParser<EntityConditionImpl> {
		...
		@Override
		public void parse(IndexedElement indexedElement, ParserContext parserContext,EntityConditionImpl object)
		{
		...
		{
			return
				elementName.equals(OscConstants.ELEMENT__END_OF_ROAD_CONDITION) ;
		}
		
		@Override
		public String[] getExpectedTagNames()
		{		 	return new String[]{
				OscConstants.ELEMENT__END_OF_ROAD_CONDITION
					};
		}
	}
	/**
	...
	private class SubElementCollisionConditionParser implements IElementParser<EntityConditionImpl> {
		...
		{
			return
				elementName.equals(OscConstants.ELEMENT__COLLISION_CONDITION) ;
		}
		
		@Override
		public String[] getExpectedTagNames()
		{		 	return new String[]{
				OscConstants.ELEMENT__COLLISION_CONDITION
					};
		}
	}
	/**
	...
	private class SubElementOffroadConditionParser implements IElementParser<EntityConditionImpl> {
		...
		{
			return
				elementName.equals(OscConstants.ELEMENT__OFFROAD_CONDITION) ;
		}
		
		@Override
		public String[] getExpectedTagNames()
		{		 	return new String[]{
				OscConstants.ELEMENT__OFFROAD_CONDITION
					};
		}
	}
	/**
	 ...
	 */
	private class SubElementTimeHeadwayConditionParser implements IElementParser<EntityConditionImpl> {
		...
		public void parse(IndexedElement indexedElement, ParserContext parserContext,EntityConditionImpl object)
		{
			...
			timeHeadwayConditionXmlParser.parseElement(indexedElement,parserContext, timeHeadwayCondition);
		...
		{
			return
				elementName.equals(OscConstants.ELEMENT__TIME_HEADWAY_CONDITION) ;
		}
		
		@Override
		public String[] getExpectedTagNames()
		{		 	return new String[]{
				OscConstants.ELEMENT__TIME_HEADWAY_CONDITION
					};
		}
	}
	/**
	 ...
	 */
	private class SubElementTimeToCollisionConditionParser implements IElementParser<EntityConditionImpl> {
		...
		{
			super();
			timeToCollisionConditionXmlParser = new TimeToCollisionConditionXmlParser(messageLogger, filename);
		}
		...
		public void parse(IndexedElement indexedElement, ParserContext parserContext,EntityConditionImpl object)
		{
			...
			timeToCollisionConditionXmlParser.parseElement(indexedElement,parserContext, timeToCollisionCondition);
		...
		{
			return
				elementName.equals(OscConstants.ELEMENT__TIME_TO_COLLISION_CONDITION) ;
		}
		
		@Override
		public String[] getExpectedTagNames()
		{		 	return new String[]{
				OscConstants.ELEMENT__TIME_TO_COLLISION_CONDITION
					};
		}
	}
	/**
	 ...
	 */
	private class SubElementAccelerationConditionParser implements IElementParser<EntityConditionImpl> {
		...
		public void parse(IndexedElement indexedElement, ParserContext parserContext,EntityConditionImpl object)
		{
			...
			accelerationConditionXmlParser.parseElement(indexedElement,parserContext, accelerationCondition);
		...
		{
			return
				elementName.equals(OscConstants.ELEMENT__ACCELERATION_CONDITION) ;
		}
		
		@Override
		public String[] getExpectedTagNames()
		{		 	return new String[]{
				OscConstants.ELEMENT__ACCELERATION_CONDITION
					};
		}
	}
	/**
	...
	private class SubElementStandStillConditionParser implements IElementParser<EntityConditionImpl> {
		...
		{
			return
				elementName.equals(OscConstants.ELEMENT__STAND_STILL_CONDITION) ;
		}
		
		@Override
		public String[] getExpectedTagNames()
		{		 	return new String[]{
				OscConstants.ELEMENT__STAND_STILL_CONDITION
					};
		}
	}
	/**
	...
	private class SubElementSpeedConditionParser implements IElementParser<EntityConditionImpl> {
		...
		{
			return
				elementName.equals(OscConstants.ELEMENT__SPEED_CONDITION) ;
		}
		
		@Override
		public String[] getExpectedTagNames()
		{		 	return new String[]{
				OscConstants.ELEMENT__SPEED_CONDITION
					};
		}
	}
	/**
	 ...
	 */
	private class SubElementRelativeSpeedConditionParser implements IElementParser<EntityConditionImpl> {
		...
		{
			super();
			relativeSpeedConditionXmlParser = new RelativeSpeedConditionXmlParser(messageLogger, filename);
		}
		...
		public void parse(IndexedElement indexedElement, ParserContext parserContext,EntityConditionImpl object)
		{
			...
			relativeSpeedConditionXmlParser.parseElement(indexedElement,parserContext, relativeSpeedCondition);
		...
		{
			return
				elementName.equals(OscConstants.ELEMENT__RELATIVE_SPEED_CONDITION) ;
		}
		
		@Override
		public String[] getExpectedTagNames()
		{		 	return new String[]{
				OscConstants.ELEMENT__RELATIVE_SPEED_CONDITION
					};
		}
	}
	/**
	 ...
	 */
	private class SubElementTraveledDistanceConditionParser implements IElementParser<EntityConditionImpl> {
		...
		{
			super();
			traveledDistanceConditionXmlParser = new TraveledDistanceConditionXmlParser(messageLogger, filename);
		}
		...
		public void parse(IndexedElement indexedElement, ParserContext parserContext,EntityConditionImpl object)
		{
			...
			traveledDistanceConditionXmlParser.parseElement(indexedElement,parserContext, traveledDistanceCondition);
		...
		{
			return
				elementName.equals(OscConstants.ELEMENT__TRAVELED_DISTANCE_CONDITION) ;
		}
		
		@Override
		public String[] getExpectedTagNames()
		{		 	return new String[]{
				OscConstants.ELEMENT__TRAVELED_DISTANCE_CONDITION
					};
		}
	}
	/**
	 ...
	 */
	private class SubElementReachPositionConditionParser implements IElementParser<EntityConditionImpl> {
		...
		{
			super();
			reachPositionConditionXmlParser = new ReachPositionConditionXmlParser(messageLogger, filename);
		}
		...
		public void parse(IndexedElement indexedElement, ParserContext parserContext,EntityConditionImpl object)
		{
			...
			reachPositionConditionXmlParser.parseElement(indexedElement,parserContext, reachPositionCondition);
		...
		{
			return
				elementName.equals(OscConstants.ELEMENT__REACH_POSITION_CONDITION) ;
		}
		
		@Override
		public String[] getExpectedTagNames()
		{		 	return new String[]{
				OscConstants.ELEMENT__REACH_POSITION_CONDITION
					};
		}
	}
	/**
	...
	private class SubElementDistanceConditionParser implements IElementParser<EntityConditionImpl> {
		...
		{
			return
				elementName.equals(OscConstants.ELEMENT__DISTANCE_CONDITION) ;
		}
		
		@Override
		public String[] getExpectedTagNames()
		{		 	return new String[]{
				OscConstants.ELEMENT__DISTANCE_CONDITION
					};
		}
	}
	/**
	 ...
	 */
	private class SubElementRelativeDistanceConditionParser implements IElementParser<EntityConditionImpl> {
		...
		{
			super();
			relativeDistanceConditionXmlParser = new RelativeDistanceConditionXmlParser(messageLogger, filename);
		}
		...
		public void parse(IndexedElement indexedElement, ParserContext parserContext,EntityConditionImpl object)
		{
			...
			relativeDistanceConditionXmlParser.parseElement(indexedElement,parserContext, relativeDistanceCondition);
		...
		{
			return
				elementName.equals(OscConstants.ELEMENT__RELATIVE_DISTANCE_CONDITION) ;
		}
		
		@Override
		public String[] getExpectedTagNames()
		{		 	return new String[]{
				OscConstants.ELEMENT__RELATIVE_DISTANCE_CONDITION
					};
		}
	}
}
