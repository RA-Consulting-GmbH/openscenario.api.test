...
public class ClothoidXmlParser extends XmlComplexTypeParser<ClothoidImpl> {
	...
	@Override
	public void parseElement(IndexedElement indexedElement, ParserContext parserContext,ClothoidImpl object) {
		messageLogger.logMessage(new FileContentMessage("Start Parsing Clothoid", ErrorLevel.DEBUG, new Textmarker(indexedElement.getStartElementLocation().getLine(), indexedElement.getStartElementLocation().getColumn(), filename))); 
		super.parseElement(indexedElement,  parserContext, object);
		messageLogger.logMessage(new FileContentMessage("End Parsing Clothoid", ErrorLevel.DEBUG, new Textmarker(indexedElement.getEndElementLocation().getLine(), indexedElement.getEndElementLocation().getColumn(), filename))); 
	...
	{
		Map<String, IAttributeParser<ClothoidImpl>> result  = new Hashtable<String, IAttributeParser<ClothoidImpl>>();
		result.put(OscConstants.ATTRIBUTE__CURVATURE, new IAttributeParser<ClothoidImpl>() {
			@Override
			public void parse(Position startPosition, Position endPosition, String attributeName, String attributeValue, ClothoidImpl object)
			{
				...
				{
					object.setAttributeParameter(OscConstants.ATTRIBUTE__CURVATURE, stripDollarSign(attributeValue), startMarker); 
				}else
				{
					// Parse value
					// Simple type
		...
		result.put(OscConstants.ATTRIBUTE__CURVATURE_DOT, new IAttributeParser<ClothoidImpl>() {
			@Override
			public void parse(Position startPosition, Position endPosition, String attributeName, String attributeValue, ClothoidImpl object)
			{
				...
				if (isParametrized(attributeValue))
				{
					object.setAttributeParameter(OscConstants.ATTRIBUTE__CURVATURE_DOT, stripDollarSign(attributeValue), startMarker); 
				}else
				{
					// Parse value
					// Simple type
		...
		result.put(OscConstants.ATTRIBUTE__LENGTH, new IAttributeParser<ClothoidImpl>() {
			@Override
			public void parse(Position startPosition, Position endPosition, String attributeName, String attributeValue, ClothoidImpl object)
			{
		...
		result.put(OscConstants.ATTRIBUTE__START_TIME, new IAttributeParser<ClothoidImpl>() {
			@Override
			public void parse(Position startPosition, Position endPosition, String attributeName, String attributeValue, ClothoidImpl object)
			{
				...
				if (isParametrized(attributeValue))
				{
					object.setAttributeParameter(OscConstants.ATTRIBUTE__START_TIME, stripDollarSign(attributeValue), startMarker); 
				}else
				{
					// Parse value
					// Simple type
		...
		result.put(OscConstants.ATTRIBUTE__STOP_TIME, new IAttributeParser<ClothoidImpl>() {
			@Override
			public void parse(Position startPosition, Position endPosition, String attributeName, String attributeValue, ClothoidImpl object)
			{
				...
				if (isParametrized(attributeValue))
				{
					object.setAttributeParameter(OscConstants.ATTRIBUTE__STOP_TIME, stripDollarSign(attributeValue), startMarker); 
				}else
				{
					// Parse value
					// Simple type
	...
	private class SubElementPositionParser implements IElementParser<ClothoidImpl> {
		...
		@Override
		public void parse(IndexedElement indexedElement, ParserContext parserContext,ClothoidImpl object)
		{
