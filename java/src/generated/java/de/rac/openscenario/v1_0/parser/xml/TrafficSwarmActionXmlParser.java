...
import de.rac.openscenario.v1_0.impl.TrafficSwarmActionImpl;
...
public class TrafficSwarmActionXmlParser extends XmlComplexTypeParser<TrafficSwarmActionImpl> {
	...
	@Override
	public void parseElement(IndexedElement indexedElement, ParserContext parserContext,TrafficSwarmActionImpl object) {
		messageLogger.logMessage(new FileContentMessage("Start Parsing TrafficSwarmAction", ErrorLevel.DEBUG, new Textmarker(indexedElement.getStartElementLocation().getLine(), indexedElement.getStartElementLocation().getColumn(), filename))); 
		super.parseElement(indexedElement,  parserContext, object);
		messageLogger.logMessage(new FileContentMessage("End Parsing TrafficSwarmAction", ErrorLevel.DEBUG, new Textmarker(indexedElement.getEndElementLocation().getLine(), indexedElement.getEndElementLocation().getColumn(), filename))); 
	
	}			
	
	@Override
	protected  Map<String, IAttributeParser<TrafficSwarmActionImpl>> getAttributeNameToAttributeParserMap()
	{
		Map<String, IAttributeParser<TrafficSwarmActionImpl>> result  = new Hashtable<String, IAttributeParser<TrafficSwarmActionImpl>>();
		result.put(OscConstants.ATTRIBUTE__SEMI_MAJOR_AXIS, new IAttributeParser<TrafficSwarmActionImpl>() {
			@Override
			public void parse(Position startPosition, Position endPosition, String attributeName, String attributeValue, TrafficSwarmActionImpl object)
			{
				...
				{
					object.setAttributeParameter(OscConstants.ATTRIBUTE__SEMI_MAJOR_AXIS, stripDollarSign(attributeValue), startMarker); 
				}else
				{
					// Parse value
					// Simple type
		...
		result.put(OscConstants.ATTRIBUTE__SEMI_MINOR_AXIS, new IAttributeParser<TrafficSwarmActionImpl>() {
			@Override
			public void parse(Position startPosition, Position endPosition, String attributeName, String attributeValue, TrafficSwarmActionImpl object)
			{
				...
				if (isParametrized(attributeValue))
				{
					object.setAttributeParameter(OscConstants.ATTRIBUTE__SEMI_MINOR_AXIS, stripDollarSign(attributeValue), startMarker); 
				}else
				{
					// Parse value
					// Simple type
		...
		result.put(OscConstants.ATTRIBUTE__INNER_RADIUS, new IAttributeParser<TrafficSwarmActionImpl>() {
			@Override
			public void parse(Position startPosition, Position endPosition, String attributeName, String attributeValue, TrafficSwarmActionImpl object)
			{
				...
				if (isParametrized(attributeValue))
				{
					object.setAttributeParameter(OscConstants.ATTRIBUTE__INNER_RADIUS, stripDollarSign(attributeValue), startMarker); 
				}else
				{
					// Parse value
					// Simple type
		...
		result.put(OscConstants.ATTRIBUTE__OFFSET, new IAttributeParser<TrafficSwarmActionImpl>() {
			@Override
			public void parse(Position startPosition, Position endPosition, String attributeName, String attributeValue, TrafficSwarmActionImpl object)
			{
		...
		result.put(OscConstants.ATTRIBUTE__NUMBER_OF_VEHICLES, new IAttributeParser<TrafficSwarmActionImpl>() {
			@Override
			public void parse(Position startPosition, Position endPosition, String attributeName, String attributeValue, TrafficSwarmActionImpl object)
			{
				...
				if (isParametrized(attributeValue))
				{
					object.setAttributeParameter(OscConstants.ATTRIBUTE__NUMBER_OF_VEHICLES, stripDollarSign(attributeValue), startMarker); 
				}else
				{
					// Parse value
					// Simple type
		...
		result.put(OscConstants.ATTRIBUTE__VELOCITY, new IAttributeParser<TrafficSwarmActionImpl>() {
			@Override
			public void parse(Position startPosition, Position endPosition, String attributeName, String attributeValue, TrafficSwarmActionImpl object)
			{
	...
	private class SubElementParser extends XmlAllParser<TrafficSwarmActionImpl>{
		...
		{
			List<IElementParser<TrafficSwarmActionImpl>> result = new ArrayList<IElementParser<TrafficSwarmActionImpl>>();
	...
	private class SubElementCentralObjectParser implements IElementParser<TrafficSwarmActionImpl> {
		...
		@Override
		public void parse(IndexedElement indexedElement, ParserContext parserContext,TrafficSwarmActionImpl object)
		{
		...
		{
			return
				elementName.equals(OscConstants.ELEMENT__CENTRAL_OBJECT) ;
		}
		
		@Override
		public String[] getExpectedTagNames()
		{		 	return new String[]{
				OscConstants.ELEMENT__CENTRAL_OBJECT
					};
		}
	}
	/**
	 ...
	 */
	private class SubElementTrafficDefinitionParser implements IElementParser<TrafficSwarmActionImpl> {
