 ...
 *
 * <p>From OpenSCENARIO class model specification: This action describes a continuously kept lateral
 * distance of an entity with respect to a reference entity. The distance can be maintained by using
 * a controller, requiring limiting values for lateral acceleration, lateral deceleration and
 * lateral speed. Without this limiting parameters lateral distance is kept rigid. Distance
 * measurement could either be calculated from the distance between the entities' reference points
 * or from the free space between the entities' bounding boxes.
 *
