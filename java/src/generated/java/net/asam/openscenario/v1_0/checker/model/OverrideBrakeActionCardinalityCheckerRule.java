 ...
 * cardinality checker rule class for the type IOverrideBrakeAction according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class OverrideBrakeActionCardinalityCheckerRule
    extends CardinalityCheckerRule<IOverrideBrakeAction> {

  /** Default constructor */
  public OverrideBrakeActionCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IOverrideBrakeAction object) {
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, IOverrideBrakeAction object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
