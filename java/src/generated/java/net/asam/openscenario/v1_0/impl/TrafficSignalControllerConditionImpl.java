...
public class TrafficSignalControllerConditionImpl extends BaseImpl
    implements ITrafficSignalControllerCondition, Cloneable {
   ...
   *     referenced signal controller in a road network.]
   */
   ...
   *
   * @param phase from OpenSCENARIO class model specification: [Name of the phase of the signal
   *     controller to be reached for the condition to become true. The available phases are ,
