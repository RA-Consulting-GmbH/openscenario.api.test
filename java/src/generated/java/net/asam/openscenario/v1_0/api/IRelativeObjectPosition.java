 ...
 *
 * <p>From OpenSCENARIO class model specification: Defines a position derived from coordinates (dx,
 * dy and dz) relative to a reference entity. The coordinate system for the relative coordinates is
 * the reference entity's coordinate system (taking the orientation of the entity into account).
 *
