 ...
 *
 * <p>Value class that implements IOverrideThrottleAction. With setter methods to fill the
 * properties.
 *
 * <ul>
...
public class OverrideThrottleActionImpl extends BaseImpl implements IOverrideThrottleActionWriter {
   ...
   */
  @Override
  public OverrideThrottleActionImpl clone() {
    OverrideThrottleActionImpl clonedObject = new OverrideThrottleActionImpl();
