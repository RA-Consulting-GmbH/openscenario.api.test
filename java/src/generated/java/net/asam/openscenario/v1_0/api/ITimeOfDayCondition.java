 ...
 *
 * <p>From OpenSCENARIO class model specification: The logical expression is considered true if the
 * simulated time and date verifies the specified relation rule (bigger than, smaller than, or equal
 * to) relatively to a given time and date value.
 *
