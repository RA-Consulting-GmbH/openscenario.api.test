 ...
 *
 * <p>From OpenSCENARIO class model specification: Compares the entity's acceleration to a reference
 * value. The logical operator used for comparison is defined by the rule attribute (less, greater,
 * equal).
 *
