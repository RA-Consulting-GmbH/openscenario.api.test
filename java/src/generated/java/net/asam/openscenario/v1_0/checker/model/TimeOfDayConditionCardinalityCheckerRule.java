 ...
 * cardinality checker rule class for the type ITimeOfDayCondition according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class TimeOfDayConditionCardinalityCheckerRule
    extends CardinalityCheckerRule<ITimeOfDayCondition> {

  /** Default constructor */
  public TimeOfDayConditionCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(ITimeOfDayCondition object) {
  ...
  @Override
  public void applyRuleInTreeContext(ITreeMessageLogger messageLogger, ITimeOfDayCondition object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
