 ...
 *
 * <p>From OpenSCENARIO class model specification: Definition of the nature for a given signal, or
 * variable, in terms of absolute or relative.
 *
...
public enum ReferenceContext {
  ...
  public static ReferenceContext getFromLiteral(String literal) {
    if (literal.equals("relative")) {
      return RELATIVE;
    } else if (literal.equals("absolute")) {
      return ABSOLUTE;
    } else {
      return null;
    }
