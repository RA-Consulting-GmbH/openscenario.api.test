 ...
 * cardinality checker rule class for the type IParameterAddValueRule according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class ParameterAddValueRuleCardinalityCheckerRule
    extends CardinalityCheckerRule<IParameterAddValueRule> {

  /** Default constructor */
  public ParameterAddValueRuleCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IParameterAddValueRule object) {
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, IParameterAddValueRule object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
