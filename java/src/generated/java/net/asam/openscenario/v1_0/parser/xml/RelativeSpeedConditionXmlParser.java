...
public class RelativeSpeedConditionXmlParser
  ...
  public void parseElement(
    ...
    messageLogger.logMessage(
        new FileContentMessage(
            "Start Parsing RelativeSpeedCondition",
            ErrorLevel.DEBUG,
            new Textmarker(
    ...
    messageLogger.logMessage(
        new FileContentMessage(
            "End Parsing RelativeSpeedCondition",
            ErrorLevel.DEBUG,
            new Textmarker(
  ...
  protected Map<String, IAttributeParser<RelativeSpeedConditionImpl>>
    ...
    Map<String, IAttributeParser<RelativeSpeedConditionImpl>> result =
        new Hashtable<String, IAttributeParser<RelativeSpeedConditionImpl>>();
    result.put(
  ...
  private class SubElementParser extends XmlSequenceParser<RelativeSpeedConditionImpl> {
    ...
    protected List<IElementParser<RelativeSpeedConditionImpl>> createParserList() {
      List<IElementParser<RelativeSpeedConditionImpl>> result =
          new ArrayList<IElementParser<RelativeSpeedConditionImpl>>();
      return result;
    }
  }
}
