 ...
 *
 * <p>Value class that implements ITrajectoryCatalogLocation. With setter methods to fill the
 * properties.
 *
 * <ul>
 ...
 */
public class TrajectoryCatalogLocationImpl extends BaseImpl
    implements ITrajectoryCatalogLocation, ITrajectoryCatalogLocationWriter {
  protected static Hashtable<String, SimpleType> propertyToType = new Hashtable<>();

  private IDirectory directory;
  /** Default constructor */
  public TrajectoryCatalogLocationImpl() {
    super();
    addAdapter(TrajectoryCatalogLocationImpl.class, this);
    addAdapter(ITrajectoryCatalogLocation.class, this);
    addAdapter(ITrajectoryCatalogLocationWriter.class, this);
  }
   ...
   */
  @Override
  public TrajectoryCatalogLocationImpl clone() {
    TrajectoryCatalogLocationImpl clonedObject = new TrajectoryCatalogLocationImpl();
