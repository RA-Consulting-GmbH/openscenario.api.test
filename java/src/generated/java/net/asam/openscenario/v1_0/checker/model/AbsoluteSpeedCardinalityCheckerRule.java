 ...
 * cardinality checker rule class for the type IAbsoluteSpeed according to OpenSCENARIO standard all
 * properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class AbsoluteSpeedCardinalityCheckerRule extends CardinalityCheckerRule<IAbsoluteSpeed> {

  /** Default constructor */
  public AbsoluteSpeedCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IAbsoluteSpeed object) {
