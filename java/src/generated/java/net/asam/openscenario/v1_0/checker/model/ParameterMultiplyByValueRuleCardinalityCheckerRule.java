 ...
 * cardinality checker rule class for the type IParameterMultiplyByValueRule according to
 * OpenSCENARIO standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class ParameterMultiplyByValueRuleCardinalityCheckerRule
    extends CardinalityCheckerRule<IParameterMultiplyByValueRule> {

  /** Default constructor */
  public ParameterMultiplyByValueRuleCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IParameterMultiplyByValueRule object) {
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, IParameterMultiplyByValueRule object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
