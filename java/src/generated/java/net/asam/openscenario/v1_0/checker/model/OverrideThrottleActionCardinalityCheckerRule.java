 ...
 * cardinality checker rule class for the type IOverrideThrottleAction according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class OverrideThrottleActionCardinalityCheckerRule
    extends CardinalityCheckerRule<IOverrideThrottleAction> {

  /** Default constructor */
  public OverrideThrottleActionCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IOverrideThrottleAction object) {
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, IOverrideThrottleAction object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
