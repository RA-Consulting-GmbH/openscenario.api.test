 ...
 *
 * <p>From OpenSCENARIO class model specification: Rules (operators) used to compare quantitative
...
public enum Rule {
  ...
  public static Rule getFromLiteral(String literal) {
    if (literal.equals("greaterThan")) {
      return GREATER_THAN;
    } else if (literal.equals("lessThan")) {
      return LESS_THAN;
    } else if (literal.equals("equalTo")) {
      return EQUAL_TO;
    } else {
      return null;
    }
