 ...
 * cardinality checker rule class for the type IManeuver according to OpenSCENARIO standard all
 * properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class ManeuverCardinalityCheckerRule extends CardinalityCheckerRule<IManeuver> {

  /** Default constructor */
  public ManeuverCardinalityCheckerRule() {
    super();
  }

  @Override
  public void applyRuleInFileContext(IParserMessageLogger messageLogger, IManeuver object) {
  ...
  private List<CardinalityViolation> getAllViolations(IManeuver object) {
  ...
  @Override
  public void applyRuleInTreeContext(ITreeMessageLogger messageLogger, IManeuver object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
