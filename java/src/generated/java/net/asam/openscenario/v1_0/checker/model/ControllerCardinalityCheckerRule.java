 ...
 * cardinality checker rule class for the type IController according to OpenSCENARIO standard all
 * properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class ControllerCardinalityCheckerRule extends CardinalityCheckerRule<IController> {

  /** Default constructor */
  public ControllerCardinalityCheckerRule() {
    super();
  }

  @Override
  public void applyRuleInFileContext(IParserMessageLogger messageLogger, IController object) {
  ...
  private List<CardinalityViolation> getAllViolations(IController object) {
  ...
  @Override
  public void applyRuleInTreeContext(ITreeMessageLogger messageLogger, IController object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
