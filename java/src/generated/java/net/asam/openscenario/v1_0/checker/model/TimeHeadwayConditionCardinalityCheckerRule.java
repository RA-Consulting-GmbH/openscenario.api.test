 ...
 * cardinality checker rule class for the type ITimeHeadwayCondition according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class TimeHeadwayConditionCardinalityCheckerRule
    extends CardinalityCheckerRule<ITimeHeadwayCondition> {

  /** Default constructor */
  public TimeHeadwayConditionCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(ITimeHeadwayCondition object) {
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, ITimeHeadwayCondition object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
