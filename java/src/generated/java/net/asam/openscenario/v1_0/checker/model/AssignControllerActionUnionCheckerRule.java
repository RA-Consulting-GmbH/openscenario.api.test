 ...
 * union checker rule class for the type IAssignControllerAction according to OpenSCENARIO standard
 * all xor elements are checked
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class AssignControllerActionUnionCheckerRule
    extends UnionCheckerRule<IAssignControllerAction> {

  /** Default constructor */
  public AssignControllerActionUnionCheckerRule() {
    super();
  }
  ...
  private List<String> getNotNullChildren(IAssignControllerAction object) {
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, IAssignControllerAction object) {
    List<String> propertyNamesNotNull = getNotNullChildren(object);
    if (propertyNamesNotNull.size() > 1) {
      messageLogger.logMessage(
