 ...
 * union checker rule class for the type IEntityObject according to OpenSCENARIO standard all xor
 * elements are checked
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class EntityObjectUnionCheckerRule extends UnionCheckerRule<IEntityObject> {

  /** Default constructor */
  public EntityObjectUnionCheckerRule() {
    super();
  }

  @Override
  public void applyRuleInFileContext(IParserMessageLogger messageLogger, IEntityObject object) {
  ...
  private List<String> getNotNullChildren(IEntityObject object) {
    ...
    if (object.getVehicle() != null) {
      propertyNamesNotNull.add(OscConstants.ELEMENT__VEHICLE);
    }

    if (object.getPedestrian() != null) {
      propertyNamesNotNull.add(OscConstants.ELEMENT__PEDESTRIAN);
    }

    if (object.getMiscObject() != null) {
      propertyNamesNotNull.add(OscConstants.ELEMENT__MISC_OBJECT);
    }
  ...
  @Override
  public void applyRuleInTreeContext(ITreeMessageLogger messageLogger, IEntityObject object) {
    List<String> propertyNamesNotNull = getNotNullChildren(object);
    if (propertyNamesNotNull.size() > 1) {
      messageLogger.logMessage(
