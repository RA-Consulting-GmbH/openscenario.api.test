 ...
 *
 * <p>Value class that implements IOverrideBrakeAction. With setter methods to fill the properties.
 *
 * <ul>
 ...
 */
public class OverrideBrakeActionImpl extends BaseImpl
    implements IOverrideBrakeAction, IOverrideBrakeActionWriter {
  protected static Hashtable<String, SimpleType> propertyToType = new Hashtable<>();

  /** Filling the property to type map */
  static {
    propertyToType.put(OscConstants.ATTRIBUTE__VALUE, SimpleType.DOUBLE);
    propertyToType.put(OscConstants.ATTRIBUTE__ACTIVE, SimpleType.BOOLEAN);
  }
  ...
  public OverrideBrakeActionImpl() {
    super();
    addAdapter(OverrideBrakeActionImpl.class, this);
    addAdapter(IOverrideBrakeAction.class, this);
    addAdapter(IOverrideBrakeActionWriter.class, this);
  }
   ...
   *
   * @param value from OpenSCENARIO class model specification: [Brake pedal value. Range: [0..1]. 0
   *     represents 0%, 1 represents 100% of pressing the brake pedal.]
   */
   ...
   */
  @Override
  public OverrideBrakeActionImpl clone() {
    OverrideBrakeActionImpl clonedObject = new OverrideBrakeActionImpl();
