 ...
 * cardinality checker rule class for the type IRelativeSpeedCondition according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class RelativeSpeedConditionCardinalityCheckerRule
    extends CardinalityCheckerRule<IRelativeSpeedCondition> {

  /** Default constructor */
  public RelativeSpeedConditionCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IRelativeSpeedCondition object) {
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, IRelativeSpeedCondition object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
