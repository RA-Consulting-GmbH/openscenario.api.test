 ...
 * union checker rule class for the type IEntityAction according to OpenSCENARIO standard all xor
 * elements are checked
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class EntityActionUnionCheckerRule extends UnionCheckerRule<IEntityAction> {

  /** Default constructor */
  public EntityActionUnionCheckerRule() {
    super();
  }

  @Override
  public void applyRuleInFileContext(IParserMessageLogger messageLogger, IEntityAction object) {
  ...
  private List<String> getNotNullChildren(IEntityAction object) {
    List<String> propertyNamesNotNull = new ArrayList<>();
    if (object.getAddEntityAction() != null) {
      propertyNamesNotNull.add(OscConstants.ELEMENT__ADD_ENTITY_ACTION);
    }

    if (object.getDeleteEntityAction() != null) {
      propertyNamesNotNull.add(OscConstants.ELEMENT__DELETE_ENTITY_ACTION);
    }
  ...
  @Override
  public void applyRuleInTreeContext(ITreeMessageLogger messageLogger, IEntityAction object) {
    List<String> propertyNamesNotNull = getNotNullChildren(object);
    if (propertyNamesNotNull.size() > 1) {
      messageLogger.logMessage(
