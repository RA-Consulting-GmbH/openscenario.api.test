 ...
 *
 * <p>From OpenSCENARIO class model specification: Types of storyboard elements in a scenario.
 *
...
public enum StoryboardElementType {
  ...
  public static StoryboardElementType getFromLiteral(String literal) {
    if (literal.equals("story")) {
      return STORY;
    } else if (literal.equals("act")) {
      return ACT;
    } else if (literal.equals("maneuver")) {
      return MANEUVER;
    } else if (literal.equals("event")) {
      return EVENT;
    } else if (literal.equals("action")) {
      return ACTION;
    } else if (literal.equals("maneuverGroup")) {
