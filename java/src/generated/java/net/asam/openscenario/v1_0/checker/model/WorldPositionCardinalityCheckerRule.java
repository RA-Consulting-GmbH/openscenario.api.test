 ...
 * cardinality checker rule class for the type IWorldPosition according to OpenSCENARIO standard all
 * properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class WorldPositionCardinalityCheckerRule extends CardinalityCheckerRule<IWorldPosition> {

  /** Default constructor */
  public WorldPositionCardinalityCheckerRule() {
    super();
  }

  @Override
  public void applyRuleInFileContext(IParserMessageLogger messageLogger, IWorldPosition object) {
  ...
  private List<CardinalityViolation> getAllViolations(IWorldPosition object) {
  ...
  @Override
  public void applyRuleInTreeContext(ITreeMessageLogger messageLogger, IWorldPosition object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
