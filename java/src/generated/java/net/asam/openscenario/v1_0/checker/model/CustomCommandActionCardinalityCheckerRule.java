 ...
 * cardinality checker rule class for the type ICustomCommandAction according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class CustomCommandActionCardinalityCheckerRule
    extends CardinalityCheckerRule<ICustomCommandAction> {

  /** Default constructor */
  public CustomCommandActionCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(ICustomCommandAction object) {
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, ICustomCommandAction object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
