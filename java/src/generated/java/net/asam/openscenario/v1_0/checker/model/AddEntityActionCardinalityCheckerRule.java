 ...
 * cardinality checker rule class for the type IAddEntityAction according to OpenSCENARIO standard
 * all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class AddEntityActionCardinalityCheckerRule
    extends CardinalityCheckerRule<IAddEntityAction> {

  /** Default constructor */
  public AddEntityActionCardinalityCheckerRule() {
    super();
  }

  @Override
  public void applyRuleInFileContext(IParserMessageLogger messageLogger, IAddEntityAction object) {
  ...
  private List<CardinalityViolation> getAllViolations(IAddEntityAction object) {
  ...
  @Override
  public void applyRuleInTreeContext(ITreeMessageLogger messageLogger, IAddEntityAction object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
