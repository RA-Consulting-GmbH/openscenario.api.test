 ...
 *
 * <p>A Writer for the type 'OverrideThrottleAction' From OpenSCENARIO class model specification:
 * Defines the state of the throttle of a vehicle, when overriding a throttle value in a
 * ControllerAction.
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public interface IOverrideThrottleActionWriter
    extends IOverrideThrottleAction, IOpenScenarioElementWriter {

  // Setters for all attributes

  /**
   * From OpenSCENARIO class model specification: Throttle pedal value. Range: [0..1].0 represents
   * 0%, 1 represents 100% of pressing the throttle pedal.
   *
