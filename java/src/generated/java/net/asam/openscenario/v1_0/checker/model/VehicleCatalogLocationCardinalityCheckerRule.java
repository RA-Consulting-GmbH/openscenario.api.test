 ...
 * cardinality checker rule class for the type IVehicleCatalogLocation according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class VehicleCatalogLocationCardinalityCheckerRule
    extends CardinalityCheckerRule<IVehicleCatalogLocation> {

  /** Default constructor */
  public VehicleCatalogLocationCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IVehicleCatalogLocation object) {
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, IVehicleCatalogLocation object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
