...
public class LongitudinalActionXmlParser extends XmlComplexTypeParser<LongitudinalActionImpl> {
  ...
  private class SubElementSpeedActionParser implements IElementParser<LongitudinalActionImpl> {
    ...
    public boolean doesMatch(String elementName) {
      return elementName.equals(OscConstants.ELEMENT__SPEED_ACTION);
    }

    @Override
    public String[] getExpectedTagNames() {
      return new String[] {OscConstants.ELEMENT__SPEED_ACTION};
    }
  }
  ...
  private class SubElementLongitudinalDistanceActionParser
    ...
    public void parse(
        IndexedElement indexedElement, ParserContext parserContext, LongitudinalActionImpl object) {
      LongitudinalDistanceActionImpl longitudinalDistanceAction =
    ...
    @Override
    public boolean doesMatch(String elementName) {
      return elementName.equals(OscConstants.ELEMENT__LONGITUDINAL_DISTANCE_ACTION);
    }

    @Override
    public String[] getExpectedTagNames() {
      return new String[] {OscConstants.ELEMENT__LONGITUDINAL_DISTANCE_ACTION};
    }
  }
}
