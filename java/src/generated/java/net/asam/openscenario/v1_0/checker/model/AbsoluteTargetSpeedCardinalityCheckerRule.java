 ...
 * cardinality checker rule class for the type IAbsoluteTargetSpeed according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class AbsoluteTargetSpeedCardinalityCheckerRule
    extends CardinalityCheckerRule<IAbsoluteTargetSpeed> {

  /** Default constructor */
  public AbsoluteTargetSpeedCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IAbsoluteTargetSpeed object) {
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, IAbsoluteTargetSpeed object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
