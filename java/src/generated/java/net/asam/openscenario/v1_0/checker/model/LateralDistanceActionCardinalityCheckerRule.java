 ...
 * cardinality checker rule class for the type ILateralDistanceAction according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class LateralDistanceActionCardinalityCheckerRule
    extends CardinalityCheckerRule<ILateralDistanceAction> {

  /** Default constructor */
  public LateralDistanceActionCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(ILateralDistanceAction object) {
