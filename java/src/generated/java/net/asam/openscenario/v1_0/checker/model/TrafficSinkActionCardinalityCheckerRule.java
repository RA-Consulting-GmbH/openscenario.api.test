 ...
 * cardinality checker rule class for the type ITrafficSinkAction according to OpenSCENARIO standard
 * all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class TrafficSinkActionCardinalityCheckerRule
    extends CardinalityCheckerRule<ITrafficSinkAction> {

  /** Default constructor */
  public TrafficSinkActionCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(ITrafficSinkAction object) {
