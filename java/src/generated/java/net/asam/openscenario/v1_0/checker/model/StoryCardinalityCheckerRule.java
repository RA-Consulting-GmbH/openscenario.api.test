 ...
 * cardinality checker rule class for the type IStory according to OpenSCENARIO standard all
 * properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class StoryCardinalityCheckerRule extends CardinalityCheckerRule<IStory> {

  /** Default constructor */
  public StoryCardinalityCheckerRule() {
    super();
  }

  @Override
  public void applyRuleInFileContext(IParserMessageLogger messageLogger, IStory object) {
  ...
  private List<CardinalityViolation> getAllViolations(IStory object) {
  ...
  @Override
  public void applyRuleInTreeContext(ITreeMessageLogger messageLogger, IStory object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
