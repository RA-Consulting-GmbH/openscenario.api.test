 ...
 * cardinality checker rule class for the type ITrafficSignalCondition according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class TrafficSignalConditionCardinalityCheckerRule
    extends CardinalityCheckerRule<ITrafficSignalCondition> {

  /** Default constructor */
  public TrafficSignalConditionCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(ITrafficSignalCondition object) {
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, ITrafficSignalCondition object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
