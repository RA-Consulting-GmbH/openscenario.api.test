 ...
 * union checker rule class for the type IAssignRouteAction according to OpenSCENARIO standard all
 * xor elements are checked
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class AssignRouteActionUnionCheckerRule extends UnionCheckerRule<IAssignRouteAction> {

  /** Default constructor */
  public AssignRouteActionUnionCheckerRule() {
    super();
  }
  ...
  private List<String> getNotNullChildren(IAssignRouteAction object) {
  ...
  @Override
  public void applyRuleInTreeContext(ITreeMessageLogger messageLogger, IAssignRouteAction object) {
    List<String> propertyNamesNotNull = getNotNullChildren(object);
    if (propertyNamesNotNull.size() > 1) {
      messageLogger.logMessage(
