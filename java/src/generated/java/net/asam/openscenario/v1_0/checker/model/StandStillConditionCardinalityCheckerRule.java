 ...
 * cardinality checker rule class for the type IStandStillCondition according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class StandStillConditionCardinalityCheckerRule
    extends CardinalityCheckerRule<IStandStillCondition> {

  /** Default constructor */
  public StandStillConditionCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IStandStillCondition object) {
