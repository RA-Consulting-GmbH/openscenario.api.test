 ...
 * cardinality checker rule class for the type IOpenScenarioCategory according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class OpenScenarioCategoryCardinalityCheckerRule
    extends CardinalityCheckerRule<IOpenScenarioCategory> {

  /** Default constructor */
  public OpenScenarioCategoryCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IOpenScenarioCategory object) {
    ...
    if (object.getScenarioDefinition() == null) {
      violations.add(
          new CardinalityViolation(
              OscConstants.ELEMENT__SCENARIO_DEFINITION, 0, 1, ViolationType.REQUIRED));
    }
    // Check violation
    // Check required
    if (object.getCatalogDefinition() == null) {
      violations.add(
          new CardinalityViolation(
              OscConstants.ELEMENT__CATALOG_DEFINITION, 0, 1, ViolationType.REQUIRED));
    }
    return violations;
  }
