...
public class EntitiesXmlParser extends XmlComplexTypeParser<EntitiesImpl> {
	...
	@Override
	public void parseElement(IndexedElement indexedElement, ParserContext parserContext,EntitiesImpl object) {
		messageLogger.logMessage(new FileContentMessage("Start Parsing Entities", ErrorLevel.DEBUG, new Textmarker(indexedElement.getStartElementLocation().getLine(), indexedElement.getStartElementLocation().getColumn(), filename))); 
		super.parseElement(indexedElement,  parserContext, object);
		messageLogger.logMessage(new FileContentMessage("End Parsing Entities", ErrorLevel.DEBUG, new Textmarker(indexedElement.getEndElementLocation().getLine(), indexedElement.getEndElementLocation().getColumn(), filename))); 
	...
	{
		Map<String, IAttributeParser<EntitiesImpl>> result  = new Hashtable<String, IAttributeParser<EntitiesImpl>>();
		return result;
	}
	...
	private class SubElementScenarioObjectsParser implements IElementParser<EntitiesImpl> {
		...
		@Override
		public void parse(IndexedElement indexedElement, ParserContext parserContext,EntitiesImpl object)
		{
		...
		{
			return
				elementName.equals(OscConstants.ELEMENT__SCENARIO_OBJECT) ;
		}
		
		@Override
		public String[] getExpectedTagNames()
		{		 	return new String[]{
				OscConstants.ELEMENT__SCENARIO_OBJECT
					};
		}
	}
	/**
	...
	private class SubElementEntitySelectionsParser implements IElementParser<EntitiesImpl> {
		...
		{
			return
				elementName.equals(OscConstants.ELEMENT__ENTITY_SELECTION) ;
		}
		
		@Override
		public String[] getExpectedTagNames()
		{		 	return new String[]{
				OscConstants.ELEMENT__ENTITY_SELECTION
					};
		}
	}
}
