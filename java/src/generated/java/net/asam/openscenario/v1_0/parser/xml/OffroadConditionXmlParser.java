...
public class OffroadConditionXmlParser extends XmlComplexTypeParser<OffroadConditionImpl> {
  ...
  public void parseElement(
      IndexedElement indexedElement, ParserContext parserContext, OffroadConditionImpl object) {
    messageLogger.logMessage(
        new FileContentMessage(
            "Start Parsing OffroadCondition",
            ErrorLevel.DEBUG,
            new Textmarker(
  ...
  @Override
  protected Map<String, IAttributeParser<OffroadConditionImpl>>
      getAttributeNameToAttributeParserMap() {
    Map<String, IAttributeParser<OffroadConditionImpl>> result =
        new Hashtable<String, IAttributeParser<OffroadConditionImpl>>();
    result.put(
        OscConstants.ATTRIBUTE__DURATION,
        new IAttributeParser<OffroadConditionImpl>() {
          @Override
          public void parse(
  ...
  private class SubElementParser extends XmlSequenceParser<OffroadConditionImpl> {
    ...
    protected List<IElementParser<OffroadConditionImpl>> createParserList() {
      List<IElementParser<OffroadConditionImpl>> result =
          new ArrayList<IElementParser<OffroadConditionImpl>>();
      return result;
    }
  }
}
