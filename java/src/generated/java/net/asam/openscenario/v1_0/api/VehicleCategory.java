 ...
 *
 * <p>From OpenSCENARIO class model specification: Categories for entity objects of type vehicle.
 *
...
public enum VehicleCategory {
  ...
  public static VehicleCategory getFromLiteral(String literal) {
    if (literal.equals("car")) {
      return CAR;
    } else if (literal.equals("van")) {
      return VAN;
    } else if (literal.equals("truck")) {
      return TRUCK;
    } else if (literal.equals("trailer")) {
      return TRAILER;
    } else if (literal.equals("semitrailer")) {
      return SEMITRAILER;
    } else if (literal.equals("bus")) {
      return BUS;
    } else if (literal.equals("motorbike")) {
      return MOTORBIKE;
    } else if (literal.equals("bicycle")) {
      return BICYCLE;
    } else if (literal.equals("train")) {
      return TRAIN;
    } else if (literal.equals("tram")) {
      return TRAM;
    } else {
      return null;
    }
