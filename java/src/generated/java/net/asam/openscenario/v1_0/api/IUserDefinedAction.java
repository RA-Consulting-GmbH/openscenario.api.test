 ...
 *
 * <p>From OpenSCENARIO class model specification: Used to either issue a command to the simulation
 * environment or start an external script. Allows the user to activate custom actions in their
 * simulation tool.
 *
