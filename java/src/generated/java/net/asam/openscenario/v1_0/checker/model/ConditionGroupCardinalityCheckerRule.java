 ...
 * cardinality checker rule class for the type IConditionGroup according to OpenSCENARIO standard
 * all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class ConditionGroupCardinalityCheckerRule extends CardinalityCheckerRule<IConditionGroup> {

  /** Default constructor */
  public ConditionGroupCardinalityCheckerRule() {
    super();
  }

  @Override
  public void applyRuleInFileContext(IParserMessageLogger messageLogger, IConditionGroup object) {
  ...
  @Override
  public void applyRuleInTreeContext(ITreeMessageLogger messageLogger, IConditionGroup object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
