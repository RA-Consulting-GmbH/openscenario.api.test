 ...
 * cardinality checker rule class for the type IAction according to OpenSCENARIO standard all
 * properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class ActionCardinalityCheckerRule extends CardinalityCheckerRule<IAction> {

  /** Default constructor */
  public ActionCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IAction object) {
