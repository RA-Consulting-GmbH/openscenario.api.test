 ...
 *
 * <p>From OpenSCENARIO class model specification: This condition acts as a wrapper for external
 * custom conditions which are implemented in the user software. This condition is considered true
 * if the given value verifies the specified relation rule (bigger than, smaller than, or equal to)
 * relatively to the provided reference.
 *
