 ...
 *
 * <p>Value class that implements IManeuverCatalogLocation. With setter methods to fill the
 * properties.
 *
 * <ul>
 ...
 */
public class ManeuverCatalogLocationImpl extends BaseImpl
    implements IManeuverCatalogLocation, IManeuverCatalogLocationWriter {
  protected static Hashtable<String, SimpleType> propertyToType = new Hashtable<>();

  private IDirectory directory;
  /** Default constructor */
  public ManeuverCatalogLocationImpl() {
    super();
    addAdapter(ManeuverCatalogLocationImpl.class, this);
    addAdapter(IManeuverCatalogLocation.class, this);
    addAdapter(IManeuverCatalogLocationWriter.class, this);
  }
   ...
   */
  @Override
  public ManeuverCatalogLocationImpl clone() {
    ManeuverCatalogLocationImpl clonedObject = new ManeuverCatalogLocationImpl();
