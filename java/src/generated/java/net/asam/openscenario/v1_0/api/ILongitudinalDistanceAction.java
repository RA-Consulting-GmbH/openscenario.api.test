 ...
 *
 * <p>From OpenSCENARIO class model specification: This action activates a controller for the
 * longitudinal behavior of an entity in a way that a given distance or time gap to the reference
 * entity is maintained. The dynamic behavior of the controller may be limited by parameters.
 * Choosing a non-limited dynamic behavior represents a rigid time or distance connection between
 * actor and object.
 *
