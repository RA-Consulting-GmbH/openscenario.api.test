 ...
 *
 * <p>Value class that implements IEndOfRoadCondition. With setter methods to fill the properties.
 *
 * <ul>
 ...
 */
public class EndOfRoadConditionImpl extends BaseImpl
    implements IEndOfRoadCondition, IEndOfRoadConditionWriter {
  ...
  /** Default constructor */
  public EndOfRoadConditionImpl() {
    super();
    addAdapter(EndOfRoadConditionImpl.class, this);
    addAdapter(IEndOfRoadCondition.class, this);
    addAdapter(IEndOfRoadConditionWriter.class, this);
  }
   ...
   *
   * @param duration from OpenSCENARIO class model specification: [Amount of time at end of road.
   *     Unit: s; Range: [0..inf[.]
   */
