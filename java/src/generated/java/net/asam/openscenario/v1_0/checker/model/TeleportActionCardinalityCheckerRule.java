 ...
 * cardinality checker rule class for the type ITeleportAction according to OpenSCENARIO standard
 * all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class TeleportActionCardinalityCheckerRule extends CardinalityCheckerRule<ITeleportAction> {

  /** Default constructor */
  public TeleportActionCardinalityCheckerRule() {
    super();
  }

  @Override
  public void applyRuleInFileContext(IParserMessageLogger messageLogger, ITeleportAction object) {
  ...
  private List<CardinalityViolation> getAllViolations(ITeleportAction object) {
  ...
  @Override
  public void applyRuleInTreeContext(ITreeMessageLogger messageLogger, ITeleportAction object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
