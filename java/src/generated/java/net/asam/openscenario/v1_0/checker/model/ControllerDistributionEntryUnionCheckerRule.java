 ...
 * union checker rule class for the type IControllerDistributionEntry according to OpenSCENARIO
 * standard all xor elements are checked
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class ControllerDistributionEntryUnionCheckerRule
    extends UnionCheckerRule<IControllerDistributionEntry> {

  /** Default constructor */
  public ControllerDistributionEntryUnionCheckerRule() {
    super();
  }
  ...
  private List<String> getNotNullChildren(IControllerDistributionEntry object) {
