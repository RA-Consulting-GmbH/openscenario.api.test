 ...
 *
 * <p>A Writer for the type 'SpeedCondition' From OpenSCENARIO class model specification: Compares a
 * triggering entity's/entities' speed to a target speed. The logical operator for the comparison is
 * given by the rule attribute.
 *
