 ...
 * cardinality checker rule class for the type ITrafficSignalStateAction according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class TrafficSignalStateActionCardinalityCheckerRule
    extends CardinalityCheckerRule<ITrafficSignalStateAction> {

  /** Default constructor */
  public TrafficSignalStateActionCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(ITrafficSignalStateAction object) {
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, ITrafficSignalStateAction object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
