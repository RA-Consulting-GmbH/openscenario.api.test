 ...
 *
 * <p>From OpenSCENARIO class model specification: Condition based on the headway time between a
 * triggering entity/entities and a reference entity. The logical operator used for comparison is
 * defined by the rule attribute.
 *
