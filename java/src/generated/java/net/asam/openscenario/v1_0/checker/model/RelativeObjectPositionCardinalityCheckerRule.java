 ...
 * cardinality checker rule class for the type IRelativeObjectPosition according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class RelativeObjectPositionCardinalityCheckerRule
    extends CardinalityCheckerRule<IRelativeObjectPosition> {

  /** Default constructor */
  public RelativeObjectPositionCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IRelativeObjectPosition object) {
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, IRelativeObjectPosition object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
