 ...
 * cardinality checker rule class for the type IAcquirePositionAction according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class AcquirePositionActionCardinalityCheckerRule
    extends CardinalityCheckerRule<IAcquirePositionAction> {

  /** Default constructor */
  public AcquirePositionActionCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IAcquirePositionAction object) {
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, IAcquirePositionAction object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
