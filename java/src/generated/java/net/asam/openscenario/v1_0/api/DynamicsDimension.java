 ...
 *
 * <p>From OpenSCENARIO class model specification: Defines how a target value will be acquired (with
 * a constant rate, in a defined distance, within a defined time).
 *
...
public enum DynamicsDimension {
  ...
  public static DynamicsDimension getFromLiteral(String literal) {
    if (literal.equals("rate")) {
      return RATE;
    } else if (literal.equals("time")) {
      return TIME;
    } else if (literal.equals("distance")) {
      return DISTANCE;
    } else {
      return null;
    }
