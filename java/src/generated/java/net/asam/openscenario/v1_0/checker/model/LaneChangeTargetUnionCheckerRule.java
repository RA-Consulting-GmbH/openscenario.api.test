 ...
 * union checker rule class for the type ILaneChangeTarget according to OpenSCENARIO standard all
 * xor elements are checked
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class LaneChangeTargetUnionCheckerRule extends UnionCheckerRule<ILaneChangeTarget> {

  /** Default constructor */
  public LaneChangeTargetUnionCheckerRule() {
    super();
  }

  @Override
  public void applyRuleInFileContext(IParserMessageLogger messageLogger, ILaneChangeTarget object) {
  ...
  private List<String> getNotNullChildren(ILaneChangeTarget object) {
    List<String> propertyNamesNotNull = new ArrayList<>();
    if (object.getRelativeTargetLane() != null) {
      propertyNamesNotNull.add(OscConstants.ELEMENT__RELATIVE_TARGET_LANE);
    }

    if (object.getAbsoluteTargetLane() != null) {
      propertyNamesNotNull.add(OscConstants.ELEMENT__ABSOLUTE_TARGET_LANE);
    }
  ...
  @Override
  public void applyRuleInTreeContext(ITreeMessageLogger messageLogger, ILaneChangeTarget object) {
    List<String> propertyNamesNotNull = getNotNullChildren(object);
    if (propertyNamesNotNull.size() > 1) {
      messageLogger.logMessage(
