 ...
 * cardinality checker rule class for the type IControllerDistribution according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class ControllerDistributionCardinalityCheckerRule
    extends CardinalityCheckerRule<IControllerDistribution> {

  /** Default constructor */
  public ControllerDistributionCardinalityCheckerRule() {
    super();
  }
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, IControllerDistribution object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
