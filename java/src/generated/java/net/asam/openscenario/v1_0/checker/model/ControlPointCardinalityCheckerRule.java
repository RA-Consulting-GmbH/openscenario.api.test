 ...
 * cardinality checker rule class for the type IControlPoint according to OpenSCENARIO standard all
 * properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class ControlPointCardinalityCheckerRule extends CardinalityCheckerRule<IControlPoint> {

  /** Default constructor */
  public ControlPointCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IControlPoint object) {
