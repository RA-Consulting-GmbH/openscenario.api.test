...
public class RelativeWorldPositionXmlParser
  ...
  public void parseElement(
    ...
    messageLogger.logMessage(
        new FileContentMessage(
            "Start Parsing RelativeWorldPosition",
            ErrorLevel.DEBUG,
            new Textmarker(
    ...
    messageLogger.logMessage(
        new FileContentMessage(
            "End Parsing RelativeWorldPosition",
            ErrorLevel.DEBUG,
            new Textmarker(
  ...
  protected Map<String, IAttributeParser<RelativeWorldPositionImpl>>
    ...
    Map<String, IAttributeParser<RelativeWorldPositionImpl>> result =
        new Hashtable<String, IAttributeParser<RelativeWorldPositionImpl>>();
    result.put(
  ...
  private class SubElementParser extends XmlAllParser<RelativeWorldPositionImpl> {
    ...
    protected List<IElementParser<RelativeWorldPositionImpl>> createParserList() {
      List<IElementParser<RelativeWorldPositionImpl>> result =
          new ArrayList<IElementParser<RelativeWorldPositionImpl>>();
