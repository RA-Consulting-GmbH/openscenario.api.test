 ...
 * cardinality checker rule class for the type ISimulationTimeCondition according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class SimulationTimeConditionCardinalityCheckerRule
    extends CardinalityCheckerRule<ISimulationTimeCondition> {

  /** Default constructor */
  public SimulationTimeConditionCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(ISimulationTimeCondition object) {
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, ISimulationTimeCondition object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
