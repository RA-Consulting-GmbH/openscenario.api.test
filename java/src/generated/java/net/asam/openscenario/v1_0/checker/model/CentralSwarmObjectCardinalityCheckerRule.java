 ...
 * cardinality checker rule class for the type ICentralSwarmObject according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class CentralSwarmObjectCardinalityCheckerRule
    extends CardinalityCheckerRule<ICentralSwarmObject> {

  /** Default constructor */
  public CentralSwarmObjectCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(ICentralSwarmObject object) {
  ...
  @Override
  public void applyRuleInTreeContext(ITreeMessageLogger messageLogger, ICentralSwarmObject object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
