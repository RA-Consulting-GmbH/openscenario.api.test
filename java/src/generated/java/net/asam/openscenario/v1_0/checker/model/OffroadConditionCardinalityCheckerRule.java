 ...
 * cardinality checker rule class for the type IOffroadCondition according to OpenSCENARIO standard
 * all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class OffroadConditionCardinalityCheckerRule
    extends CardinalityCheckerRule<IOffroadCondition> {

  /** Default constructor */
  public OffroadConditionCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IOffroadCondition object) {
