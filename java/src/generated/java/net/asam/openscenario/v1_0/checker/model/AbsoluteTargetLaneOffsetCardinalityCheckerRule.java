 ...
 * cardinality checker rule class for the type IAbsoluteTargetLaneOffset according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class AbsoluteTargetLaneOffsetCardinalityCheckerRule
    extends CardinalityCheckerRule<IAbsoluteTargetLaneOffset> {

  /** Default constructor */
  public AbsoluteTargetLaneOffsetCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IAbsoluteTargetLaneOffset object) {
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, IAbsoluteTargetLaneOffset object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
