 ...
 *
 * <p>From OpenSCENARIO class model specification: Represents the geometrical center of the bounding
 * box expressed in coordinates that refer to the coordinate system of the entity (e.g. the vehicle
 * coordinate system).
 *
