 ...
 * cardinality checker rule class for the type IRelativeTargetLaneOffset according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class RelativeTargetLaneOffsetCardinalityCheckerRule
    extends CardinalityCheckerRule<IRelativeTargetLaneOffset> {

  /** Default constructor */
  public RelativeTargetLaneOffsetCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IRelativeTargetLaneOffset object) {
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, IRelativeTargetLaneOffset object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
