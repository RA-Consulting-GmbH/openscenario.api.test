 ...
 * cardinality checker rule class for the type IPhase according to OpenSCENARIO standard all
 * properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class PhaseCardinalityCheckerRule extends CardinalityCheckerRule<IPhase> {

  /** Default constructor */
  public PhaseCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IPhase object) {
