 ...
 * cardinality checker rule class for the type ILaneOffsetActionDynamics according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class LaneOffsetActionDynamicsCardinalityCheckerRule
    extends CardinalityCheckerRule<ILaneOffsetActionDynamics> {

  /** Default constructor */
  public LaneOffsetActionDynamicsCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(ILaneOffsetActionDynamics object) {
