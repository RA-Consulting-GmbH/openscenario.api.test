 ...
 * cardinality checker rule class for the type IAccelerationCondition according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class AccelerationConditionCardinalityCheckerRule
    extends CardinalityCheckerRule<IAccelerationCondition> {

  /** Default constructor */
  public AccelerationConditionCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IAccelerationCondition object) {
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, IAccelerationCondition object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
