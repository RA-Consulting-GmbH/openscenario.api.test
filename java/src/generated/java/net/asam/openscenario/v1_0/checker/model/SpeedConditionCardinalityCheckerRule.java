 ...
 * cardinality checker rule class for the type ISpeedCondition according to OpenSCENARIO standard
 * all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class SpeedConditionCardinalityCheckerRule extends CardinalityCheckerRule<ISpeedCondition> {

  /** Default constructor */
  public SpeedConditionCardinalityCheckerRule() {
    super();
  }

  @Override
  public void applyRuleInFileContext(IParserMessageLogger messageLogger, ISpeedCondition object) {
  ...
  private List<CardinalityViolation> getAllViolations(ISpeedCondition object) {
  ...
  @Override
  public void applyRuleInTreeContext(ITreeMessageLogger messageLogger, ISpeedCondition object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
