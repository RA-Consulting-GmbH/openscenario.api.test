 ...
 *
 * <p>Value class that implements IVehicleCatalogLocation. With setter methods to fill the
 * properties.
 *
 * <ul>
 ...
 */
public class VehicleCatalogLocationImpl extends BaseImpl implements IVehicleCatalogLocationWriter {
  protected static Hashtable<String, SimpleType> propertyToType = new Hashtable<>();

  private IDirectoryWriter directory;

  /** Default constructor */
  public VehicleCatalogLocationImpl() {
    super();
   ...
   */
  @Override
  public VehicleCatalogLocationImpl clone() {
    VehicleCatalogLocationImpl clonedObject = new VehicleCatalogLocationImpl();
