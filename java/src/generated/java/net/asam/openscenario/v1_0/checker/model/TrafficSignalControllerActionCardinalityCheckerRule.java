 ...
 * cardinality checker rule class for the type ITrafficSignalControllerAction according to
 * OpenSCENARIO standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class TrafficSignalControllerActionCardinalityCheckerRule
    extends CardinalityCheckerRule<ITrafficSignalControllerAction> {

  /** Default constructor */
  public TrafficSignalControllerActionCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(ITrafficSignalControllerAction object) {
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, ITrafficSignalControllerAction object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
