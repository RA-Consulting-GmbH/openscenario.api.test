 ...
 * cardinality checker rule class for the type IPositionOfCurrentEntity according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class PositionOfCurrentEntityCardinalityCheckerRule
    extends CardinalityCheckerRule<IPositionOfCurrentEntity> {

  /** Default constructor */
  public PositionOfCurrentEntityCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IPositionOfCurrentEntity object) {
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, IPositionOfCurrentEntity object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
