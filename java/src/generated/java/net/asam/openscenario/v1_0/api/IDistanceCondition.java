 ...
 *
 * <p>From OpenSCENARIO class model specification: The current distance between an entity and a
 * reference entity is compared to a given distance (less, greater, equal). Several additional
 * parameters like free space etc. can be defined.
 *
