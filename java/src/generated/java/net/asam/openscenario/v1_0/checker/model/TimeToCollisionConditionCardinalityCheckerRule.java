 ...
 * cardinality checker rule class for the type ITimeToCollisionCondition according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class TimeToCollisionConditionCardinalityCheckerRule
    extends CardinalityCheckerRule<ITimeToCollisionCondition> {

  /** Default constructor */
  public TimeToCollisionConditionCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(ITimeToCollisionCondition object) {
    ...
    // Check violation
    // Check required
    if (object.getTimeToCollisionConditionTarget() == null) {
      violations.add(
          new CardinalityViolation(
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, ITimeToCollisionCondition object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
