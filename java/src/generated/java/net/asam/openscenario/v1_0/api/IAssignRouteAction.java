 ...
 *
 * <p>From OpenSCENARIO class model specification: Controls an entity to follow a route using
 * waypoints on the road network. The corresponding route can be instantiated from a catalog type,
 * or defined within this declaration. This action does not override any action that controls either
