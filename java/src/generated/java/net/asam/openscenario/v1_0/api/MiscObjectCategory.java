 ...
 *
 * <p>From OpenSCENARIO class model specification: Categories for entity objects which are not
...
public enum MiscObjectCategory {
  ...
  public static MiscObjectCategory getFromLiteral(String literal) {
    if (literal.equals("none")) {
      return NONE;
    } else if (literal.equals("obstacle")) {
      return OBSTACLE;
    } else if (literal.equals("pole")) {
      return POLE;
    } else if (literal.equals("tree")) {
      return TREE;
    } else if (literal.equals("vegetation")) {
      return VEGETATION;
    } else if (literal.equals("barrier")) {
      return BARRIER;
    } else if (literal.equals("building")) {
      return BUILDING;
    } else if (literal.equals("parkingSpace")) {
      return PARKING_SPACE;
    } else if (literal.equals("patch")) {
      return PATCH;
    } else if (literal.equals("railing")) {
      return RAILING;
    } else if (literal.equals("trafficIsland")) {
      return TRAFFIC_ISLAND;
    } else if (literal.equals("crosswalk")) {
      return CROSSWALK;
    } else if (literal.equals("streetLamp")) {
      return STREET_LAMP;
    } else if (literal.equals("gantry")) {
      return GANTRY;
    } else if (literal.equals("soundBarrier")) {
      return SOUND_BARRIER;
    } else if (literal.equals("wind")) {
      return WIND;
    } else if (literal.equals("roadMark")) {
      return ROAD_MARK;
    } else {
      return null;
    }
