 ...
 *
 * <p>From OpenSCENARIO class model specification: The currently predicted time to collision of a
 * triggering entity/entities and either a reference entity’s position or an explicit position is
 * compared to a given time value. The logical operator for comparison is defined by the rule
 * attribute.
 *
