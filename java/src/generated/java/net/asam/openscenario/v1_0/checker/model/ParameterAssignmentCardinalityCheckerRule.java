 ...
 * cardinality checker rule class for the type IParameterAssignment according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class ParameterAssignmentCardinalityCheckerRule
    extends CardinalityCheckerRule<IParameterAssignment> {

  /** Default constructor */
  public ParameterAssignmentCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IParameterAssignment object) {
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, IParameterAssignment object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
