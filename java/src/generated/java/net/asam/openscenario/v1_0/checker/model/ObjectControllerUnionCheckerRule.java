 ...
 * union checker rule class for the type IObjectController according to OpenSCENARIO standard all
 * xor elements are checked
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class ObjectControllerUnionCheckerRule extends UnionCheckerRule<IObjectController> {

  /** Default constructor */
  public ObjectControllerUnionCheckerRule() {
    super();
  }

  @Override
  public void applyRuleInFileContext(IParserMessageLogger messageLogger, IObjectController object) {
  ...
  private List<String> getNotNullChildren(IObjectController object) {
    ...
    if (object.getController() != null) {
      propertyNamesNotNull.add(OscConstants.ELEMENT__CONTROLLER);
    }
  ...
  @Override
  public void applyRuleInTreeContext(ITreeMessageLogger messageLogger, IObjectController object) {
    List<String> propertyNamesNotNull = getNotNullChildren(object);
    if (propertyNamesNotNull.size() > 1) {
      messageLogger.logMessage(
