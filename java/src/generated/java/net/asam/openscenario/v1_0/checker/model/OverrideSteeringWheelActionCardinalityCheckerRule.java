 ...
 * cardinality checker rule class for the type IOverrideSteeringWheelAction according to
 * OpenSCENARIO standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class OverrideSteeringWheelActionCardinalityCheckerRule
    extends CardinalityCheckerRule<IOverrideSteeringWheelAction> {

  /** Default constructor */
  public OverrideSteeringWheelActionCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IOverrideSteeringWheelAction object) {
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, IOverrideSteeringWheelAction object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
