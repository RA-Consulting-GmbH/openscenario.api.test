 ...
 * cardinality checker rule class for the type IOverrideClutchAction according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class OverrideClutchActionCardinalityCheckerRule
    extends CardinalityCheckerRule<IOverrideClutchAction> {

  /** Default constructor */
  public OverrideClutchActionCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IOverrideClutchAction object) {
