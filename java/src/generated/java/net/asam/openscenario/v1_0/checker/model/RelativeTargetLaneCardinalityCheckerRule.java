 ...
 * cardinality checker rule class for the type IRelativeTargetLane according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class RelativeTargetLaneCardinalityCheckerRule
    extends CardinalityCheckerRule<IRelativeTargetLane> {

  /** Default constructor */
  public RelativeTargetLaneCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IRelativeTargetLane object) {
  ...
  @Override
  public void applyRuleInTreeContext(ITreeMessageLogger messageLogger, IRelativeTargetLane object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
