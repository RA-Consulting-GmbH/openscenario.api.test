 ...
 * union checker rule class for the type IParameterAction according to OpenSCENARIO standard all xor
 * elements are checked
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class ParameterActionUnionCheckerRule extends UnionCheckerRule<IParameterAction> {

  /** Default constructor */
  public ParameterActionUnionCheckerRule() {
    super();
  }

  @Override
  public void applyRuleInFileContext(IParserMessageLogger messageLogger, IParameterAction object) {
  ...
  private List<String> getNotNullChildren(IParameterAction object) {
    List<String> propertyNamesNotNull = new ArrayList<>();
    if (object.getSetAction() != null) {
      propertyNamesNotNull.add(OscConstants.ELEMENT__SET_ACTION);
    }

    if (object.getModifyAction() != null) {
      propertyNamesNotNull.add(OscConstants.ELEMENT__MODIFY_ACTION);
    }
  ...
  @Override
  public void applyRuleInTreeContext(ITreeMessageLogger messageLogger, IParameterAction object) {
    List<String> propertyNamesNotNull = getNotNullChildren(object);
    if (propertyNamesNotNull.size() > 1) {
      messageLogger.logMessage(
