 ...
 * cardinality checker rule class for the type IKnot according to OpenSCENARIO standard all
 * properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class KnotCardinalityCheckerRule extends CardinalityCheckerRule<IKnot> {

  /** Default constructor */
  public KnotCardinalityCheckerRule() {
    super();
  }

  @Override
  public void applyRuleInFileContext(IParserMessageLogger messageLogger, IKnot object) {
  ...
  private List<CardinalityViolation> getAllViolations(IKnot object) {
  ...
  @Override
  public void applyRuleInTreeContext(ITreeMessageLogger messageLogger, IKnot object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
