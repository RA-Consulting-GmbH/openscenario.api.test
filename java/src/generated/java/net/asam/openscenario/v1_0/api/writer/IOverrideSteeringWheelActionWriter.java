 ...
 *
 * <p>A Writer for the type 'OverrideSteeringWheelAction' From OpenSCENARIO class model
 * specification: Defines the state of the steering wheel of a vehicle, when overriding a steering
 * wheel angle in a ControllerAction.
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public interface IOverrideSteeringWheelActionWriter
    extends IOverrideSteeringWheelAction, IOpenScenarioElementWriter {

  // Setters for all attributes

  /**
   * From OpenSCENARIO class model specification: Steering wheel angle. Unit: rad.
   *
