 ...
 * cardinality checker rule class for the type IControllerDistributionEntry according to
 * OpenSCENARIO standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class ControllerDistributionEntryCardinalityCheckerRule
    extends CardinalityCheckerRule<IControllerDistributionEntry> {

  /** Default constructor */
  public ControllerDistributionEntryCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IControllerDistributionEntry object) {
