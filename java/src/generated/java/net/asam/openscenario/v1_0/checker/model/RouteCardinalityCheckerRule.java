 ...
 * cardinality checker rule class for the type IRoute according to OpenSCENARIO standard all
 * properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class RouteCardinalityCheckerRule extends CardinalityCheckerRule<IRoute> {

  /** Default constructor */
  public RouteCardinalityCheckerRule() {
    super();
  }

  @Override
  public void applyRuleInFileContext(IParserMessageLogger messageLogger, IRoute object) {
  ...
  private List<CardinalityViolation> getAllViolations(IRoute object) {
  ...
  @Override
  public void applyRuleInTreeContext(ITreeMessageLogger messageLogger, IRoute object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
