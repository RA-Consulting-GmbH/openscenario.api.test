 ...
 * cardinality checker rule class for the type ITrajectoryCatalogLocation according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class TrajectoryCatalogLocationCardinalityCheckerRule
    extends CardinalityCheckerRule<ITrajectoryCatalogLocation> {

  /** Default constructor */
  public TrajectoryCatalogLocationCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(ITrajectoryCatalogLocation object) {
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, ITrajectoryCatalogLocation object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
