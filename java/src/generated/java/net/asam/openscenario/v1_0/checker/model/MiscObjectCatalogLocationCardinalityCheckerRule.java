 ...
 * cardinality checker rule class for the type IMiscObjectCatalogLocation according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class MiscObjectCatalogLocationCardinalityCheckerRule
    extends CardinalityCheckerRule<IMiscObjectCatalogLocation> {

  /** Default constructor */
  public MiscObjectCatalogLocationCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IMiscObjectCatalogLocation object) {
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, IMiscObjectCatalogLocation object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
