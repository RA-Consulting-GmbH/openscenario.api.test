 ...
 *
 * <p>A Writer for the type 'AbsoluteTargetLane' From OpenSCENARIO class model specification:
 * Defines the number (ID) of the target lane.
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public interface IAbsoluteTargetLaneWriter extends IAbsoluteTargetLane, IOpenScenarioElementWriter {
