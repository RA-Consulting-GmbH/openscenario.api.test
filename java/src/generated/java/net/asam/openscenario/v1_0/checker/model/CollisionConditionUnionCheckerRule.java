 ...
 * union checker rule class for the type ICollisionCondition according to OpenSCENARIO standard all
 * xor elements are checked
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class CollisionConditionUnionCheckerRule extends UnionCheckerRule<ICollisionCondition> {

  /** Default constructor */
  public CollisionConditionUnionCheckerRule() {
    super();
  }
  ...
  private List<String> getNotNullChildren(ICollisionCondition object) {
  ...
  @Override
  public void applyRuleInTreeContext(ITreeMessageLogger messageLogger, ICollisionCondition object) {
    List<String> propertyNamesNotNull = getNotNullChildren(object);
    if (propertyNamesNotNull.size() > 1) {
      messageLogger.logMessage(
