 ...
 * cardinality checker rule class for the type IPrivate according to OpenSCENARIO standard all
 * properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class PrivateCardinalityCheckerRule extends CardinalityCheckerRule<IPrivate> {

  /** Default constructor */
  public PrivateCardinalityCheckerRule() {
    super();
  }

  @Override
  public void applyRuleInFileContext(IParserMessageLogger messageLogger, IPrivate object) {
  ...
  private List<CardinalityViolation> getAllViolations(IPrivate object) {
  ...
  @Override
  public void applyRuleInTreeContext(ITreeMessageLogger messageLogger, IPrivate object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
