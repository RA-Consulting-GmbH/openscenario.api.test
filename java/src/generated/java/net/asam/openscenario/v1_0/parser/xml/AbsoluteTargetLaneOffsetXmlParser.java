...
public class AbsoluteTargetLaneOffsetXmlParser
  ...
  public void parseElement(
    ...
    messageLogger.logMessage(
        new FileContentMessage(
            "Start Parsing AbsoluteTargetLaneOffset",
            ErrorLevel.DEBUG,
            new Textmarker(
    ...
    messageLogger.logMessage(
        new FileContentMessage(
            "End Parsing AbsoluteTargetLaneOffset",
            ErrorLevel.DEBUG,
            new Textmarker(
  ...
  protected Map<String, IAttributeParser<AbsoluteTargetLaneOffsetImpl>>
    ...
    Map<String, IAttributeParser<AbsoluteTargetLaneOffsetImpl>> result =
        new Hashtable<String, IAttributeParser<AbsoluteTargetLaneOffsetImpl>>();
    result.put(
  ...
  private class SubElementParser extends XmlSequenceParser<AbsoluteTargetLaneOffsetImpl> {
    ...
    protected List<IElementParser<AbsoluteTargetLaneOffsetImpl>> createParserList() {
      List<IElementParser<AbsoluteTargetLaneOffsetImpl>> result =
          new ArrayList<IElementParser<AbsoluteTargetLaneOffsetImpl>>();
      return result;
    }
  }
}
