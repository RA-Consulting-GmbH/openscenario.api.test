 ...
 *
 * <p>Value class that implements IReachPositionCondition. With setter methods to fill the
 * properties.
 *
 * <ul>
...
public class ReachPositionConditionImpl extends BaseImpl implements IReachPositionConditionWriter {
  ...
  static {
    propertyToType.put(OscConstants.ATTRIBUTE__TOLERANCE, SimpleType.DOUBLE);
  }
