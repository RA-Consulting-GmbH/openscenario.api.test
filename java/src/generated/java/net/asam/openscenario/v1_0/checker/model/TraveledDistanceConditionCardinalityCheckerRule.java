 ...
 * cardinality checker rule class for the type ITraveledDistanceCondition according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class TraveledDistanceConditionCardinalityCheckerRule
    extends CardinalityCheckerRule<ITraveledDistanceCondition> {

  /** Default constructor */
  public TraveledDistanceConditionCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(ITraveledDistanceCondition object) {
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, ITraveledDistanceCondition object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
