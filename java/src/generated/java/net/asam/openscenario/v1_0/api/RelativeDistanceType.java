 ...
 *
 * <p>From OpenSCENARIO class model specification: Alternative ways in which to calculate the
 * distance in a RelativeDistanceCondition.
 *
...
public enum RelativeDistanceType {
  ...
  public static RelativeDistanceType getFromLiteral(String literal) {
    if (literal.equals("longitudinal")) {
      return LONGITUDINAL;
    } else if (literal.equals("lateral")) {
      return LATERAL;
    } else if (literal.equals("cartesianDistance")) {
