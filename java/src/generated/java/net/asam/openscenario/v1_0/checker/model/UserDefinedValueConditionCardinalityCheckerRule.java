 ...
 * cardinality checker rule class for the type IUserDefinedValueCondition according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class UserDefinedValueConditionCardinalityCheckerRule
    extends CardinalityCheckerRule<IUserDefinedValueCondition> {

  /** Default constructor */
  public UserDefinedValueConditionCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IUserDefinedValueCondition object) {
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, IUserDefinedValueCondition object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
