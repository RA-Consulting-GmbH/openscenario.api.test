 ...
 *
 * <p>A Writer for the type 'RelativeSpeedCondition' From OpenSCENARIO class model specification:
 * The current relative speed of a triggering entity/entities to a reference entity is compared to a
 * given value. The logical operator used for the evaluation is defined by the rule attribute.
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public interface IRelativeSpeedConditionWriter
    extends IRelativeSpeedCondition, IOpenScenarioElementWriter {
