 ...
 *
 * <p>From OpenSCENARIO class model specification: Synchronizes an entity's arrival at a destination
 * with a master entity. Both entities are provided with their own reference position which shall be
 * reached at the same time. Final speed can be specified. Note that the reference positions can be
