...
public class AccelerationConditionXmlParser
  ...
  protected Map<String, IAttributeParser<AccelerationConditionImpl>>
    ...
    Map<String, IAttributeParser<AccelerationConditionImpl>> result = new Hashtable<>();
    result.put(
          ...
          public void parse(
            ...
            Textmarker startMarker =
                new Textmarker(
                    ...
                    AccelerationConditionXmlParser.this.filename);
          ...
          public void parse(
            ...
            if (isParametrized(attributeValue)) {
              ...
              if (result != null) {
                ...
                AccelerationConditionXmlParser.this.messageLogger.logMessage(
  ...
  private class SubElementParser extends XmlSequenceParser<AccelerationConditionImpl> {
    ...
    protected List<IElementParser<AccelerationConditionImpl>> createParserList() {
      List<IElementParser<AccelerationConditionImpl>> result = new ArrayList<>();
      return result;
    }
  }
}
