 ...
 */
public class AccelerationConditionXmlParser
    extends XmlComplexTypeParser<AccelerationConditionImpl> {
  ...
  public void parseElement(
      ...
      AccelerationConditionImpl object) {
    messageLogger.logMessage(
        new FileContentMessage(
            "Start Parsing AccelerationCondition",
            ErrorLevel.DEBUG,
            new Textmarker(
    ...
    messageLogger.logMessage(
        new FileContentMessage(
            "End Parsing AccelerationCondition",
            ErrorLevel.DEBUG,
            new Textmarker(
  ...
  @Override
  protected Map<String, IAttributeParser<AccelerationConditionImpl>>
      getAttributeNameToAttributeParserMap() {
    Map<String, IAttributeParser<AccelerationConditionImpl>> result =
        new Hashtable<String, IAttributeParser<AccelerationConditionImpl>>();
    result.put(
        OscConstants.ATTRIBUTE__VALUE,
        new IAttributeParser<AccelerationConditionImpl>() {
          @Override
          public void parse(
  ...
  private class SubElementParser extends XmlSequenceParser<AccelerationConditionImpl> {
    ...
    protected List<IElementParser<AccelerationConditionImpl>> createParserList() {
      List<IElementParser<AccelerationConditionImpl>> result =
          new ArrayList<IElementParser<AccelerationConditionImpl>>();
      return result;
    }
  }
}
