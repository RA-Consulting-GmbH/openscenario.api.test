 ...
 *
 * <p>From OpenSCENARIO class model specification: A container for maneuver groups. Can be executed
 * several times depending on the user provided settings. New executions are only allowed to start
 * when all contained maneuver groups are in the complete state.
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public interface IAct extends IStoryboardElement {
  /**
