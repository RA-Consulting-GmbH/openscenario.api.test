 ...
 * union checker rule class for the type IEnvironmentAction according to OpenSCENARIO standard all
 * xor elements are checked
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class EnvironmentActionUnionCheckerRule extends UnionCheckerRule<IEnvironmentAction> {

  /** Default constructor */
  public EnvironmentActionUnionCheckerRule() {
    super();
  }
  ...
  private List<String> getNotNullChildren(IEnvironmentAction object) {
    List<String> propertyNamesNotNull = new ArrayList<>();
    if (object.getEnvironment() != null) {
      propertyNamesNotNull.add(OscConstants.ELEMENT__ENVIRONMENT);
    }
  ...
  @Override
  public void applyRuleInTreeContext(ITreeMessageLogger messageLogger, IEnvironmentAction object) {
    List<String> propertyNamesNotNull = getNotNullChildren(object);
    if (propertyNamesNotNull.size() > 1) {
      messageLogger.logMessage(
