 ...
 * cardinality checker rule class for the type ILongitudinalDistanceAction according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class LongitudinalDistanceActionCardinalityCheckerRule
    extends CardinalityCheckerRule<ILongitudinalDistanceAction> {

  /** Default constructor */
  public LongitudinalDistanceActionCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(ILongitudinalDistanceAction object) {
