 ...
 * cardinality checker rule class for the type IEntityAction according to OpenSCENARIO standard all
 * properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class EntityActionCardinalityCheckerRule extends CardinalityCheckerRule<IEntityAction> {

  /** Default constructor */
  public EntityActionCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IEntityAction object) {
