 ...
 *
 * <p>A Writer for the type 'VehicleCatalogLocation' From OpenSCENARIO class model specification:
 * The directory where to look up vehicle catalogs.
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public interface IVehicleCatalogLocationWriter
    extends IVehicleCatalogLocation, IOpenScenarioElementWriter {
