 ...
 *
 * <p>Value class that implements ILaneOffsetActionDynamics. With setter methods to fill the
 * properties.
 *
 * <ul>
...
public class LaneOffsetActionDynamicsImpl extends BaseImpl
  ...
  static {
    propertyToType.put(OscConstants.ATTRIBUTE__MAX_LATERAL_ACC, SimpleType.DOUBLE);
