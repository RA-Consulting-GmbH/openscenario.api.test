...
public class EndOfRoadConditionXmlParser extends XmlComplexTypeParser<EndOfRoadConditionImpl> {
  ...
  protected Map<String, IAttributeParser<EndOfRoadConditionImpl>>
    ...
    Map<String, IAttributeParser<EndOfRoadConditionImpl>> result = new Hashtable<>();
    result.put(
          ...
          public void parse(
            ...
            Textmarker startMarker =
                new Textmarker(
                    ...
                    EndOfRoadConditionXmlParser.this.filename);
  ...
  private class SubElementParser extends XmlSequenceParser<EndOfRoadConditionImpl> {
    ...
    protected List<IElementParser<EndOfRoadConditionImpl>> createParserList() {
      List<IElementParser<EndOfRoadConditionImpl>> result = new ArrayList<>();
      return result;
    }
  }
}
