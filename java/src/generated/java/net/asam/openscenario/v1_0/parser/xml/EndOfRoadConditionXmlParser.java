...
public class EndOfRoadConditionXmlParser extends XmlComplexTypeParser<EndOfRoadConditionImpl> {
  ...
  public void parseElement(
      IndexedElement indexedElement, ParserContext parserContext, EndOfRoadConditionImpl object) {
    messageLogger.logMessage(
        new FileContentMessage(
            "Start Parsing EndOfRoadCondition",
            ErrorLevel.DEBUG,
            new Textmarker(
    ...
    messageLogger.logMessage(
        new FileContentMessage(
            "End Parsing EndOfRoadCondition",
            ErrorLevel.DEBUG,
            new Textmarker(
  ...
  @Override
  protected Map<String, IAttributeParser<EndOfRoadConditionImpl>>
      getAttributeNameToAttributeParserMap() {
    Map<String, IAttributeParser<EndOfRoadConditionImpl>> result =
        new Hashtable<String, IAttributeParser<EndOfRoadConditionImpl>>();
    result.put(
        OscConstants.ATTRIBUTE__DURATION,
        new IAttributeParser<EndOfRoadConditionImpl>() {
          @Override
          public void parse(
  ...
  private class SubElementParser extends XmlSequenceParser<EndOfRoadConditionImpl> {
    ...
    protected List<IElementParser<EndOfRoadConditionImpl>> createParserList() {
      List<IElementParser<EndOfRoadConditionImpl>> result =
          new ArrayList<IElementParser<EndOfRoadConditionImpl>>();
      return result;
    }
  }
}
