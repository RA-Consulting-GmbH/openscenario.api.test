 ...
 * cardinality checker rule class for the type IParameterAction according to OpenSCENARIO standard
 * all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class ParameterActionCardinalityCheckerRule
    extends CardinalityCheckerRule<IParameterAction> {

  /** Default constructor */
  public ParameterActionCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IParameterAction object) {
