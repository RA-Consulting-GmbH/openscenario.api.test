...
public class OverrideThrottleActionXmlParser
  ...
  protected Map<String, IAttributeParser<OverrideThrottleActionImpl>>
    ...
    Map<String, IAttributeParser<OverrideThrottleActionImpl>> result = new Hashtable<>();
    result.put(
          ...
          public void parse(
            ...
            Textmarker startMarker =
                new Textmarker(
                    ...
                    OverrideThrottleActionXmlParser.this.filename);
  ...
  private class SubElementParser extends XmlSequenceParser<OverrideThrottleActionImpl> {
    ...
    protected List<IElementParser<OverrideThrottleActionImpl>> createParserList() {
      List<IElementParser<OverrideThrottleActionImpl>> result = new ArrayList<>();
      return result;
    }
  }
}
