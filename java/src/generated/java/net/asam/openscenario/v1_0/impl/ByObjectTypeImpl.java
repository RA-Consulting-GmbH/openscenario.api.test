 ...
 *
 * <p>Value class that implements IByObjectType. With setter methods to fill the properties.
 *
 * <ul>
...
public class ByObjectTypeImpl extends BaseImpl implements IByObjectTypeWriter {
  ...
  static {
    propertyToType.put(OscConstants.ATTRIBUTE__TYPE, SimpleType.ENUM_TYPE);
  }
