 ...
 * cardinality checker rule class for the type IRelativeTargetSpeed according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class RelativeTargetSpeedCardinalityCheckerRule
    extends CardinalityCheckerRule<IRelativeTargetSpeed> {

  /** Default constructor */
  public RelativeTargetSpeedCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IRelativeTargetSpeed object) {
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, IRelativeTargetSpeed object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
