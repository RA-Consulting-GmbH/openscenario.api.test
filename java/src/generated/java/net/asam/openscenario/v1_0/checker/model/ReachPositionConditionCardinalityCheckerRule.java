 ...
 * cardinality checker rule class for the type IReachPositionCondition according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class ReachPositionConditionCardinalityCheckerRule
    extends CardinalityCheckerRule<IReachPositionCondition> {

  /** Default constructor */
  public ReachPositionConditionCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IReachPositionCondition object) {
    ...
    if (object.getTolerance() == null) {
      violations.add(
          new CardinalityViolation(
              OscConstants.ATTRIBUTE__TOLERANCE, 0, 1, ViolationType.REQUIRED));
    }
    // Check violation
    // Check required
