 ...
 *
 * <p>Value class that implements IAddEntityAction. With setter methods to fill the properties.
 *
 * <ul>
 ...
 */
public class AddEntityActionImpl extends BaseImpl implements IAddEntityAction, Cloneable {
   ...
   *
   * @param position from OpenSCENARIO class model specification: [Adds an entity at the specified
   *     position.]
   */
   ...
   */
  public AddEntityActionImpl clone() {
    AddEntityActionImpl clonedObject = new AddEntityActionImpl();
