 ...
 * cardinality checker rule class for the type ISun according to OpenSCENARIO standard all
 * properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class SunCardinalityCheckerRule extends CardinalityCheckerRule<ISun> {

  /** Default constructor */
  public SunCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(ISun object) {
    ...
    if (object.getAzimuth() == null) {
      violations.add(
          new CardinalityViolation(OscConstants.ATTRIBUTE__AZIMUTH, 0, 1, ViolationType.REQUIRED));
    }
    // Check violation
    // Check required
    if (object.getElevation() == null) {
      violations.add(
          new CardinalityViolation(
              OscConstants.ATTRIBUTE__ELEVATION, 0, 1, ViolationType.REQUIRED));
    }
    return violations;
  }
