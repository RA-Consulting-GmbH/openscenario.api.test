 ...
 * cardinality checker rule class for the type IAct according to OpenSCENARIO standard all
 * properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class ActCardinalityCheckerRule extends CardinalityCheckerRule<IAct> {

  /** Default constructor */
  public ActCardinalityCheckerRule() {
    super();
  }

  @Override
  public void applyRuleInFileContext(IParserMessageLogger messageLogger, IAct object) {
  ...
  private List<CardinalityViolation> getAllViolations(IAct object) {
  ...
  @Override
  public void applyRuleInTreeContext(ITreeMessageLogger messageLogger, IAct object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
