 ...
 * cardinality checker rule class for the type IAbsoluteTargetLane according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class AbsoluteTargetLaneCardinalityCheckerRule
    extends CardinalityCheckerRule<IAbsoluteTargetLane> {

  /** Default constructor */
  public AbsoluteTargetLaneCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IAbsoluteTargetLane object) {
  ...
  @Override
  public void applyRuleInTreeContext(ITreeMessageLogger messageLogger, IAbsoluteTargetLane object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
