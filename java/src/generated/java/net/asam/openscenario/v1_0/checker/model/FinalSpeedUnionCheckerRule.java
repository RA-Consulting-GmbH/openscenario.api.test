 ...
 * union checker rule class for the type IFinalSpeed according to OpenSCENARIO standard all xor
 * elements are checked
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class FinalSpeedUnionCheckerRule extends UnionCheckerRule<IFinalSpeed> {

  /** Default constructor */
  public FinalSpeedUnionCheckerRule() {
    super();
  }

  @Override
  public void applyRuleInFileContext(IParserMessageLogger messageLogger, IFinalSpeed object) {
  ...
  private List<String> getNotNullChildren(IFinalSpeed object) {
    List<String> propertyNamesNotNull = new ArrayList<>();
    if (object.getAbsoluteSpeed() != null) {
      propertyNamesNotNull.add(OscConstants.ELEMENT__ABSOLUTE_SPEED);
    }

    if (object.getRelativeSpeedToMaster() != null) {
      propertyNamesNotNull.add(OscConstants.ELEMENT__RELATIVE_SPEED_TO_MASTER);
    }
  ...
  @Override
  public void applyRuleInTreeContext(ITreeMessageLogger messageLogger, IFinalSpeed object) {
    List<String> propertyNamesNotNull = getNotNullChildren(object);
    if (propertyNamesNotNull.size() > 1) {
      messageLogger.logMessage(
