 ...
 *
 * <p>From OpenSCENARIO class model specification: Position defined in terms of road ID, distance
 * (s) along that road segment and offset from reference lane (t) at that point. Orientation is
 * optional.
 *
