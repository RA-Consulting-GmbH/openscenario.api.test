 ...
 * cardinality checker rule class for the type IEntityRef according to OpenSCENARIO standard all
 * properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class EntityRefCardinalityCheckerRule extends CardinalityCheckerRule<IEntityRef> {

  /** Default constructor */
  public EntityRefCardinalityCheckerRule() {
    super();
  }

  @Override
  public void applyRuleInFileContext(IParserMessageLogger messageLogger, IEntityRef object) {
  ...
  private List<CardinalityViolation> getAllViolations(IEntityRef object) {
  ...
  @Override
  public void applyRuleInTreeContext(ITreeMessageLogger messageLogger, IEntityRef object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
