...
*/
public class LongitudinalDistanceActionImpl extends BaseImpl implements ILongitudinalDistanceAction, Cloneable{
	...
	*/
	...
	public  void resolveParameterInternal(IParserMessageLogger logger,String attributeKey, String parameterLiteralValue)
	{
		...
		{
			// Simple type
			timeGap = ParserHelper.parseDouble(logger,parameterLiteralValue,getTextmarker(attributeKey));
			removeResolvedParameter(attributeKey);
  ...
  public Double getDoubleProperty(String key) throws KeyNotSupportedException
  {
	...
	if (key.equals(OscConstants.ATTRIBUTE__TIME_GAP))
	{
		return getTimeGap();
	}else 
	{
