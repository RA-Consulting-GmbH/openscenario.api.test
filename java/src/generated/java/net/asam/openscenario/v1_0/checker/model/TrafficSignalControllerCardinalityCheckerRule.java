 ...
 * cardinality checker rule class for the type ITrafficSignalController according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class TrafficSignalControllerCardinalityCheckerRule
    extends CardinalityCheckerRule<ITrafficSignalController> {

  /** Default constructor */
  public TrafficSignalControllerCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(ITrafficSignalController object) {
