 ...
 *
 * <p>From OpenSCENARIO class model specification: Controls an entity to follow a trajectory using
 * vertices, timings (optionally) and a corresponding interpolation strategy. The trajectory can be
 * instantiated from a catalog type, or defined within this declaration.
 *
