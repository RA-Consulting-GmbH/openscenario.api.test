 ...
 * union checker rule class for the type ICondition according to OpenSCENARIO standard all xor
 * elements are checked
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class ConditionUnionCheckerRule extends UnionCheckerRule<ICondition> {

  /** Default constructor */
  public ConditionUnionCheckerRule() {
    super();
  }
  ...
  private List<String> getNotNullChildren(ICondition object) {
    List<String> propertyNamesNotNull = new ArrayList<>();
    if (object.getByEntityCondition() != null) {
      propertyNamesNotNull.add(OscConstants.ELEMENT__BY_ENTITY_CONDITION);
    }

    if (object.getByValueCondition() != null) {
      propertyNamesNotNull.add(OscConstants.ELEMENT__BY_VALUE_CONDITION);
    }
