 ...
 * union checker rule class for the type ISelectedEntities according to OpenSCENARIO standard all
 * xor elements are checked
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class SelectedEntitiesUnionCheckerRule extends UnionCheckerRule<ISelectedEntities> {

  /** Default constructor */
  public SelectedEntitiesUnionCheckerRule() {
    super();
  }

  @Override
  public void applyRuleInFileContext(IParserMessageLogger messageLogger, ISelectedEntities object) {
  ...
  @Override
  public void applyRuleInTreeContext(ITreeMessageLogger messageLogger, ISelectedEntities object) {
    List<String> propertyNamesNotNull = getNotNullChildren(object);
    if (propertyNamesNotNull.size() > 1) {
      messageLogger.logMessage(
