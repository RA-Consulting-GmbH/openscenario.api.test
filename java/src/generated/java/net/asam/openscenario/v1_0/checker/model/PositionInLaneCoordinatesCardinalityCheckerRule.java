 ...
 * cardinality checker rule class for the type IPositionInLaneCoordinates according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class PositionInLaneCoordinatesCardinalityCheckerRule
    extends CardinalityCheckerRule<IPositionInLaneCoordinates> {

  /** Default constructor */
  public PositionInLaneCoordinatesCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IPositionInLaneCoordinates object) {
