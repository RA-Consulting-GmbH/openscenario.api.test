 ...
 * range checker rule class for the type INurbs according to OpenSCENARIO standard
 *
...
public class NurbsRangeCheckerRule extends RangeCheckerRule<INurbs> {
  ...
  private void apply(
      IParserMessageLogger fileMessageLogger, ITreeMessageLogger treeMessageLogger, INurbs object) {
