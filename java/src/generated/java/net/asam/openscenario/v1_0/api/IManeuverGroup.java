 ...
 *
 * <p>From OpenSCENARIO class model specification: Grouping element connecting a set of actors to a
 * set maneuvers. Multiple maneuver groups can run independently in parallel. Maneuvers can be
 * defined or instantiated from a maneuver type in a catalog.
 *
