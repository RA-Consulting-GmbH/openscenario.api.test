 ...
 * cardinality checker rule class for the type IManeuverCatalogLocation according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class ManeuverCatalogLocationCardinalityCheckerRule
    extends CardinalityCheckerRule<IManeuverCatalogLocation> {

  /** Default constructor */
  public ManeuverCatalogLocationCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IManeuverCatalogLocation object) {
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, IManeuverCatalogLocation object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
