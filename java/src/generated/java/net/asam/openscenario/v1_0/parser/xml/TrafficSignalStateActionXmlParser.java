...
public class TrafficSignalStateActionXmlParser
  ...
  public void parseElement(
    ...
    messageLogger.logMessage(
        new FileContentMessage(
            "Start Parsing TrafficSignalStateAction",
            ErrorLevel.DEBUG,
            new Textmarker(
    ...
    messageLogger.logMessage(
        new FileContentMessage(
            "End Parsing TrafficSignalStateAction",
            ErrorLevel.DEBUG,
            new Textmarker(
  ...
  protected Map<String, IAttributeParser<TrafficSignalStateActionImpl>>
    ...
    Map<String, IAttributeParser<TrafficSignalStateActionImpl>> result =
        new Hashtable<String, IAttributeParser<TrafficSignalStateActionImpl>>();
    result.put(
  ...
  private class SubElementParser extends XmlSequenceParser<TrafficSignalStateActionImpl> {
    ...
    protected List<IElementParser<TrafficSignalStateActionImpl>> createParserList() {
      List<IElementParser<TrafficSignalStateActionImpl>> result =
          new ArrayList<IElementParser<TrafficSignalStateActionImpl>>();
      return result;
    }
  }
}
