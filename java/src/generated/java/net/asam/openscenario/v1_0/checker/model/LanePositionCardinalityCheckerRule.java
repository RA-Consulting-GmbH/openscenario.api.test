 ...
 * cardinality checker rule class for the type ILanePosition according to OpenSCENARIO standard all
 * properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class LanePositionCardinalityCheckerRule extends CardinalityCheckerRule<ILanePosition> {

  /** Default constructor */
  public LanePositionCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(ILanePosition object) {
    ...
    if (object.getLaneId() == null) {
      violations.add(
          new CardinalityViolation(OscConstants.ATTRIBUTE__LANE_ID, 0, 1, ViolationType.REQUIRED));
    }
    // Check violation
    // Check required
    if (object.getS() == null) {
