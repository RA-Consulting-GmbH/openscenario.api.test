 ...
 * cardinality checker rule class for the type IProperty according to OpenSCENARIO standard all
 * properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class PropertyCardinalityCheckerRule extends CardinalityCheckerRule<IProperty> {

  /** Default constructor */
  public PropertyCardinalityCheckerRule() {
    super();
  }

  @Override
  public void applyRuleInFileContext(IParserMessageLogger messageLogger, IProperty object) {
  ...
  private List<CardinalityViolation> getAllViolations(IProperty object) {
  ...
  @Override
  public void applyRuleInTreeContext(ITreeMessageLogger messageLogger, IProperty object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
