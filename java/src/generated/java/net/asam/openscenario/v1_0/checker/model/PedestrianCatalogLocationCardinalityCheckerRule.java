 ...
 * cardinality checker rule class for the type IPedestrianCatalogLocation according to OpenSCENARIO
 * standard all properties and children are checked if they are not optinal
 *
 * @author RA Consulting OpenSCENARIO generation facility
 */
public class PedestrianCatalogLocationCardinalityCheckerRule
    extends CardinalityCheckerRule<IPedestrianCatalogLocation> {

  /** Default constructor */
  public PedestrianCatalogLocationCardinalityCheckerRule() {
    super();
  }
  ...
  private List<CardinalityViolation> getAllViolations(IPedestrianCatalogLocation object) {
  ...
  public void applyRuleInTreeContext(
      ITreeMessageLogger messageLogger, IPedestrianCatalogLocation object) {
    List<CardinalityViolation> violations = getAllViolations(object);
    for (CardinalityViolation violation : violations) {
      String message = getMessage(violation);
