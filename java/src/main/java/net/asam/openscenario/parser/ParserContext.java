...
/**
 * A Parser Context that allows a parser to store dynamic information during the parsing process.
 * A parser context is handed through the hierarchical parser concept and is especially used for parsing
 * XSD groups.
 * 
