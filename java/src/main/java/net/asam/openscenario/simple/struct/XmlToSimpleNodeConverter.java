...
/**
 * Connects a dom node and textural positions to a IndexedElement The dom nodes are located in a
 * document. The textual informations are located in a indexed list.
 *
