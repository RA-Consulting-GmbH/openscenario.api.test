...
std::shared_ptr<ExprType> TestSpecificationReader::getExpectedDatatype(json testObject)
{
...
std::shared_ptr<std::vector<std::shared_ptr<TestSpecification>>> TestSpecificationReader::readFromJson(std::string jsonString){
