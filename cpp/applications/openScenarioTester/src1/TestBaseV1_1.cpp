...
namespace NET_ASAM_OPENSCENARIO
{
    namespace v1_1
	{
		...
		{
			auto loaderFactory = NET_ASAM_OPENSCENARIO::v1_1::XmlScenarioLoaderFactory(filename);
			...
			if (ptr != nullptr)
				return std::static_pointer_cast<NET_ASAM_OPENSCENARIO::v1_1::OpenScenarioImpl>(ptr->GetAdapter(typeid(NET_ASAM_OPENSCENARIO::v1_1::OpenScenarioImpl).name()));
			return nullptr;
		}
