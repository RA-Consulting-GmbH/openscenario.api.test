    ...
    namespace v1_3
	{
		...
		bool TestDeprecatedValidation::TestValidation()
		{
			try
			{
				...
				messages.push_back(NET_ASAM_OPENSCENARIO::FileContentMessage("Attribute 'value' is deprecated and must not be used with element 'BrakePercent' or 'BrakeForce'.", NET_ASAM_OPENSCENARIO::ERROR, NET_ASAM_OPENSCENARIO::Textmarker(178, 18, kFilename)));
				...
				messages.push_back(NET_ASAM_OPENSCENARIO::FileContentMessage("Attribute 'velocity' is deprecated and must not be used with attribute 'speed'.", NET_ASAM_OPENSCENARIO::ERROR, NET_ASAM_OPENSCENARIO::Textmarker(256, 18, kFilename)));
				messages.push_back(NET_ASAM_OPENSCENARIO::FileContentMessage("Attribute 'velocity' is deprecated and must not be used with element 'InitialSpeedRange'.", NET_ASAM_OPENSCENARIO::ERROR, NET_ASAM_OPENSCENARIO::Textmarker(277, 18, kFilename)));
				...
				// From 1.1
				messages.push_back(NET_ASAM_OPENSCENARIO::FileContentMessage("Attribute 'curvatureDot' is deprecated and must not be used with attribute 'isSetCurvaturePrime'.", NET_ASAM_OPENSCENARIO::ERROR, NET_ASAM_OPENSCENARIO::Textmarker(301, 26, kFilename)));
				messages.push_back(NET_ASAM_OPENSCENARIO::FileContentMessage("Attribute 'alongRoute' is deprecated and must not be used with attribute 'coordinateSystem'.", NET_ASAM_OPENSCENARIO::ERROR, NET_ASAM_OPENSCENARIO::Textmarker(326, 25, kFilename)));
				messages.push_back(NET_ASAM_OPENSCENARIO::FileContentMessage("Attribute 'alongRoute' is deprecated and must not be used with attribute 'relativeDistanceType'.", NET_ASAM_OPENSCENARIO::ERROR, NET_ASAM_OPENSCENARIO::Textmarker(326, 25, kFilename)));
