...
#include <TestParameterValidationV1_3.h>
#include <TestVariableValidationV1_3.h>
#include <TestDeprecatedValidationV1_3.h>
#include "TestAlksV1_3.h"
#include "TestDeprecatedV1_3.h"
#include "TestExamplesV1_3.h"
#include <TestExamplesOscV1_3.h>
#include "TestRangeCheckerV1_3.h"
#include "TestFilesV1_3.h"
#include "TestImportsV1_3.h"
#include "TestReaderV1_3.h"
#include "TestSimpleDemosV1_3.h"
#include "TestVersionCheckerV1_3.h"
#include "TestFlexInterfaceV1_3.h"
#include "TestInjectedParametersV1_3.h"
#include "TestWriterApiV1_3.h"
#include "TestCardinalityV1_3.h"
#endif
...
#ifdef SUPPORT_OSC_1_3
bool TestV1_3(std::string basePath)
{
	NET_ASAM_OPENSCENARIO::v1_3::TestExamples testExamples(basePath);
	NET_ASAM_OPENSCENARIO::v1_3::TestRangeChecker testRangeChecker(basePath);
	NET_ASAM_OPENSCENARIO::v1_3::TestFiles testFiles(basePath);
	NET_ASAM_OPENSCENARIO::v1_3::TestImports testImports(basePath);
	NET_ASAM_OPENSCENARIO::v1_3::TestReader testReader(basePath);
	NET_ASAM_OPENSCENARIO::v1_3::TestSimpleDemos testSimpleDemos(basePath);
	NET_ASAM_OPENSCENARIO::v1_3::TestVersionChecker testVersionChecker(basePath);
	NET_ASAM_OPENSCENARIO::v1_3::TestFlexInterface testFlexInterface(basePath);
	NET_ASAM_OPENSCENARIO::v1_3::TestInjectedParameters testInjectedParameters(basePath);
	NET_ASAM_OPENSCENARIO::v1_3::TestWriterApi testWriterApi(basePath);
	NET_ASAM_OPENSCENARIO::v1_3::TestDeprecated testDeprecated(basePath);
	NET_ASAM_OPENSCENARIO::v1_3::TestAlks testAlks(basePath);
	NET_ASAM_OPENSCENARIO::v1_3::TestParameterValidation testParametervalidation(basePath);
	NET_ASAM_OPENSCENARIO::v1_3::TestVariableValidation testVariableValidation(basePath);
	NET_ASAM_OPENSCENARIO::v1_3::TestDeprecatedValidation testDeprecatedValidation(basePath);
	NET_ASAM_OPENSCENARIO::v1_3::TestExamplesOsc testExamplesOsc(basePath);
	NET_ASAM_OPENSCENARIO::v1_3::TestCardinality testCardinality(basePath);
