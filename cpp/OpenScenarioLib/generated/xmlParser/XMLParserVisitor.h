...
public:
   ...
   */
    ...
    virtual antlrcpp::Any visitDoctypedecl(XMLParser::DoctypedeclContext *context) = 0;
    ...
    virtual antlrcpp::Any visitAttributeList(XMLParser::AttributeListContext *context) = 0;
