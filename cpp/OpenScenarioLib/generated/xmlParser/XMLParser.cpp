...
antlrcpp::Any XMLParser::DoctypedeclContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<XMLParserVisitor*>(visitor))
    return parserVisitor->visitDoctypedecl(this);
  else
    return visitor->visitChildren(this);
}
...
antlrcpp::Any XMLParser::AttributeListContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<XMLParserVisitor*>(visitor))
