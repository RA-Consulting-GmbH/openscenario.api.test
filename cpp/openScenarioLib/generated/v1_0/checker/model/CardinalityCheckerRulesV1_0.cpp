...
#include "CardinalityCheckerRulesV1_0.h"
...
namespace NET_ASAM_OPENSCENARIO
{
    namespace v1_0
    {
        ...
        void ControllerActionCardinalityCheckerRule::ApplyRuleInFileContext(std::shared_ptr<IParserMessageLogger> messageLogger, std::shared_ptr<IControllerAction> object)
        {
            auto  violations = GetAllViolations(object);
        ...
        void ControllerActionCardinalityCheckerRule::ApplyRuleInTreeContext(std::shared_ptr<ITreeMessageLogger> messageLogger, std::shared_ptr<IControllerAction> object)
        {
            auto violations = GetAllViolations(object);
        ...
        std::string OverrideControllerValueActionCardinalityCheckerRule::GetMsg(CardinalityViolation& violation)
        {
            std::string message;
            if (violation.violationType ==  VIOLATION_TYPE::REQUIRED)
            {
        ...
        std::vector<CardinalityViolation> OverrideControllerValueActionCardinalityCheckerRule::GetAllViolations(std::shared_ptr<IOverrideControllerValueAction> object)
        {
            std::vector<CardinalityViolation> violations;
            // Check violation
            // Check required
         ...
         OverrideControllerValueActionCardinalityCheckerRule::OverrideControllerValueActionCardinalityCheckerRule() = default;

        void OverrideControllerValueActionCardinalityCheckerRule::ApplyRuleInFileContext(std::shared_ptr<IParserMessageLogger> messageLogger, std::shared_ptr<IOverrideControllerValueAction> object)
        {
            auto  violations = GetAllViolations(object);
        ...
        void OverrideControllerValueActionCardinalityCheckerRule::ApplyRuleInTreeContext(std::shared_ptr<ITreeMessageLogger> messageLogger, std::shared_ptr<IOverrideControllerValueAction> object)
        {
            auto violations = GetAllViolations(object);
        ...
        std::string WeatherCardinalityCheckerRule::GetMsg(CardinalityViolation& violation)
        {
            std::string message;
            if (violation.violationType ==  VIOLATION_TYPE::REQUIRED)
            {
        ...
        std::vector<CardinalityViolation> WeatherCardinalityCheckerRule::GetAllViolations(std::shared_ptr<IWeather> object)
        {
            std::vector<CardinalityViolation> violations;
            // Check violation
            // Check required
         ...
         WeatherCardinalityCheckerRule::WeatherCardinalityCheckerRule() = default;

        void WeatherCardinalityCheckerRule::ApplyRuleInFileContext(std::shared_ptr<IParserMessageLogger> messageLogger, std::shared_ptr<IWeather> object)
        {
            auto  violations = GetAllViolations(object);
        ...
        void WeatherCardinalityCheckerRule::ApplyRuleInTreeContext(std::shared_ptr<ITreeMessageLogger> messageLogger, std::shared_ptr<IWeather> object)
        {
            auto violations = GetAllViolations(object);
