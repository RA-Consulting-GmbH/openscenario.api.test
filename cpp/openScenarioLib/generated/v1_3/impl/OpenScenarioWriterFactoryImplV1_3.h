    ...
    namespace v1_3
    {
        ...
        */
        ...
        public:
            ...
            std::shared_ptr<IAngleConditionWriter> CreateAngleConditionWriter() override;
            ...
            std::shared_ptr<IClothoidSplineWriter> CreateClothoidSplineWriter() override;

            std::shared_ptr<IClothoidSplineSegmentWriter> CreateClothoidSplineSegmentWriter() override;
            ...
            std::shared_ptr<IConnectTrailerActionWriter> CreateConnectTrailerActionWriter() override;
            ...
            std::shared_ptr<IDisconnectTrailerActionWriter> CreateDisconnectTrailerActionWriter() override;
            ...
            std::shared_ptr<IEntityDistributionWriter> CreateEntityDistributionWriter() override;

            std::shared_ptr<IEntityDistributionEntryWriter> CreateEntityDistributionEntryWriter() override;
            ...
            std::shared_ptr<ILaneWriter> CreateLaneWriter() override;
            ...
            std::shared_ptr<ILogNormalDistributionWriter> CreateLogNormalDistributionWriter() override;
            ...
            std::shared_ptr<IMonitorDeclarationWriter> CreateMonitorDeclarationWriter() override;
            ...
            std::shared_ptr<IPolygonWriter> CreatePolygonWriter() override;
            ...
            std::shared_ptr<IRandomRouteActionWriter> CreateRandomRouteActionWriter() override;
            ...
            std::shared_ptr<IRelativeAngleConditionWriter> CreateRelativeAngleConditionWriter() override;
            ...
            std::shared_ptr<IRoadCursorWriter> CreateRoadCursorWriter() override;
            ...
            std::shared_ptr<IRoadRangeWriter> CreateRoadRangeWriter() override;
            ...
            std::shared_ptr<IScenarioObjectTemplateWriter> CreateScenarioObjectTemplateWriter() override;
            ...
            std::shared_ptr<ISetMonitorActionWriter> CreateSetMonitorActionWriter() override;
            ...
            std::shared_ptr<ITrafficAreaWriter> CreateTrafficAreaWriter() override;

            std::shared_ptr<ITrafficAreaActionWriter> CreateTrafficAreaActionWriter() override;

            std::shared_ptr<ITrafficDefinitionWriter> CreateTrafficDefinitionWriter() override;

            std::shared_ptr<ITrafficDistributionWriter> CreateTrafficDistributionWriter() override;

            std::shared_ptr<ITrafficDistributionEntryWriter> CreateTrafficDistributionEntryWriter() override;
            ...
            std::shared_ptr<ITrailerWriter> CreateTrailerWriter() override;

            std::shared_ptr<ITrailerActionWriter> CreateTrailerActionWriter() override;

            std::shared_ptr<ITrailerCouplerWriter> CreateTrailerCouplerWriter() override;

            std::shared_ptr<ITrailerHitchWriter> CreateTrailerHitchWriter() override;
