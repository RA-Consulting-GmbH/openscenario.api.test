...
#include "IOpenScenarioWriterFactoryV1_3.h"
    ...
    namespace v1_3
    {
        ...
        */
        ...
        public:
            ...
            OPENSCENARIOLIB_EXP std::shared_ptr<IAngleConditionWriter> CreateAngleConditionWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IAnimationActionWriter> CreateAnimationActionWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IAnimationFileWriter> CreateAnimationFileWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IAnimationStateWriter> CreateAnimationStateWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IAnimationTypeWriter> CreateAnimationTypeWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IAppearanceActionWriter> CreateAppearanceActionWriter() override;
            ...
            OPENSCENARIOLIB_EXP std::shared_ptr<IAutomaticGearWriter> CreateAutomaticGearWriter() override;
            ...
            OPENSCENARIOLIB_EXP std::shared_ptr<IBrakeWriter> CreateBrakeWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IBrakeInputWriter> CreateBrakeInputWriter() override;
            ...
            OPENSCENARIOLIB_EXP std::shared_ptr<IClothoidSplineWriter> CreateClothoidSplineWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IClothoidSplineSegmentWriter> CreateClothoidSplineSegmentWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<ICollisionConditionWriter> CreateCollisionConditionWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IColorWriter> CreateColorWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IColorCmykWriter> CreateColorCmykWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IColorRgbWriter> CreateColorRgbWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IComponentAnimationWriter> CreateComponentAnimationWriter() override;
            ...
            OPENSCENARIOLIB_EXP std::shared_ptr<IConnectTrailerActionWriter> CreateConnectTrailerActionWriter() override;
            ...
            OPENSCENARIOLIB_EXP std::shared_ptr<ICustomContentWriter> CreateCustomContentWriter() override;
            ...
            OPENSCENARIOLIB_EXP std::shared_ptr<IDirectionOfTravelDistributionWriter> CreateDirectionOfTravelDistributionWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IDirectoryWriter> CreateDirectoryWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IDisconnectTrailerActionWriter> CreateDisconnectTrailerActionWriter() override;
            ...
            OPENSCENARIOLIB_EXP std::shared_ptr<IDomeImageWriter> CreateDomeImageWriter() override;
            ...
            OPENSCENARIOLIB_EXP std::shared_ptr<IEntityDistributionWriter> CreateEntityDistributionWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IEntityDistributionEntryWriter> CreateEntityDistributionEntryWriter() override;
            ...
            OPENSCENARIOLIB_EXP std::shared_ptr<IGearWriter> CreateGearWriter() override;
            ...
            OPENSCENARIOLIB_EXP std::shared_ptr<ILaneWriter> CreateLaneWriter() override;
            ...
            OPENSCENARIOLIB_EXP std::shared_ptr<ILightStateWriter> CreateLightStateWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<ILightStateActionWriter> CreateLightStateActionWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<ILightTypeWriter> CreateLightTypeWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<ILogNormalDistributionWriter> CreateLogNormalDistributionWriter() override;
            ...
            OPENSCENARIOLIB_EXP std::shared_ptr<IManualGearWriter> CreateManualGearWriter() override;
            ...
            OPENSCENARIOLIB_EXP std::shared_ptr<IMonitorDeclarationWriter> CreateMonitorDeclarationWriter() override;
            ...
            OPENSCENARIOLIB_EXP std::shared_ptr<IPedestrianAnimationWriter> CreatePedestrianAnimationWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IPedestrianCatalogLocationWriter> CreatePedestrianCatalogLocationWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IPedestrianGestureWriter> CreatePedestrianGestureWriter() override;
            ...
            OPENSCENARIOLIB_EXP std::shared_ptr<IPolygonWriter> CreatePolygonWriter() override;
            ...
            OPENSCENARIOLIB_EXP std::shared_ptr<IRandomRouteActionWriter> CreateRandomRouteActionWriter() override;
            ...
            OPENSCENARIOLIB_EXP std::shared_ptr<IRelativeAngleConditionWriter> CreateRelativeAngleConditionWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IRelativeClearanceConditionWriter> CreateRelativeClearanceConditionWriter() override;
            ...
            OPENSCENARIOLIB_EXP std::shared_ptr<IRelativeLaneRangeWriter> CreateRelativeLaneRangeWriter() override;
            ...
            OPENSCENARIOLIB_EXP std::shared_ptr<IRoadCursorWriter> CreateRoadCursorWriter() override;
            ...
            OPENSCENARIOLIB_EXP std::shared_ptr<IRoadRangeWriter> CreateRoadRangeWriter() override;
            ...
            OPENSCENARIOLIB_EXP std::shared_ptr<IScenarioObjectTemplateWriter> CreateScenarioObjectTemplateWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<ISelectedEntitiesWriter> CreateSelectedEntitiesWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<ISensorReferenceWriter> CreateSensorReferenceWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<ISensorReferenceSetWriter> CreateSensorReferenceSetWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<ISetMonitorActionWriter> CreateSetMonitorActionWriter() override;
            ...
            OPENSCENARIOLIB_EXP std::shared_ptr<ISpeedProfileActionWriter> CreateSpeedProfileActionWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<ISpeedProfileEntryWriter> CreateSpeedProfileEntryWriter() override;
            ...
            OPENSCENARIOLIB_EXP std::shared_ptr<ITrafficAreaWriter> CreateTrafficAreaWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<ITrafficAreaActionWriter> CreateTrafficAreaActionWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<ITrafficDefinitionWriter> CreateTrafficDefinitionWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<ITrafficDistributionWriter> CreateTrafficDistributionWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<ITrafficDistributionEntryWriter> CreateTrafficDistributionEntryWriter() override;
            ...
            OPENSCENARIOLIB_EXP std::shared_ptr<ITrafficSignalGroupStateWriter> CreateTrafficSignalGroupStateWriter() override;
            ...
            OPENSCENARIOLIB_EXP std::shared_ptr<ITrailerWriter> CreateTrailerWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<ITrailerActionWriter> CreateTrailerActionWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<ITrailerCouplerWriter> CreateTrailerCouplerWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<ITrailerHitchWriter> CreateTrailerHitchWriter() override;
            ...
            OPENSCENARIOLIB_EXP std::shared_ptr<IUserDefinedAnimationWriter> CreateUserDefinedAnimationWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IUserDefinedComponentWriter> CreateUserDefinedComponentWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IUserDefinedDistributionWriter> CreateUserDefinedDistributionWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IUserDefinedLightWriter> CreateUserDefinedLightWriter() override;
            ...
            OPENSCENARIOLIB_EXP std::shared_ptr<IVariableActionWriter> CreateVariableActionWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IVariableAddValueRuleWriter> CreateVariableAddValueRuleWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IVariableConditionWriter> CreateVariableConditionWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IVariableDeclarationWriter> CreateVariableDeclarationWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IVariableModifyActionWriter> CreateVariableModifyActionWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IVariableModifyRuleWriter> CreateVariableModifyRuleWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IVariableMultiplyByValueRuleWriter> CreateVariableMultiplyByValueRuleWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IVariableSetActionWriter> CreateVariableSetActionWriter() override;
            ...
            OPENSCENARIOLIB_EXP std::shared_ptr<IVehicleComponentWriter> CreateVehicleComponentWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IVehicleLightWriter> CreateVehicleLightWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IVehicleRoleDistributionWriter> CreateVehicleRoleDistributionWriter() override;

            OPENSCENARIOLIB_EXP std::shared_ptr<IVehicleRoleDistributionEntryWriter> CreateVehicleRoleDistributionEntryWriter() override;
