...
namespace NET_ASAM_OPENSCENARIO
{
    namespace v1_3
    {
        ...
        */
        ...
        std::shared_ptr<IAngleConditionWriter> OpenScenarioWriterFactoryImpl::CreateAngleConditionWriter()
        {
            return std::make_shared<AngleConditionImpl>();
        }

        std::shared_ptr<IAnimationActionWriter> OpenScenarioWriterFactoryImpl::CreateAnimationActionWriter()
        {
            return std::make_shared<AnimationActionImpl>();
        }

        std::shared_ptr<IAnimationFileWriter> OpenScenarioWriterFactoryImpl::CreateAnimationFileWriter()
        {
            return std::make_shared<AnimationFileImpl>();
        }

        std::shared_ptr<IAnimationStateWriter> OpenScenarioWriterFactoryImpl::CreateAnimationStateWriter()
        {
            return std::make_shared<AnimationStateImpl>();
        }

        std::shared_ptr<IAnimationTypeWriter> OpenScenarioWriterFactoryImpl::CreateAnimationTypeWriter()
        {
            return std::make_shared<AnimationTypeImpl>();
        }

        std::shared_ptr<IAppearanceActionWriter> OpenScenarioWriterFactoryImpl::CreateAppearanceActionWriter()
        {
            return std::make_shared<AppearanceActionImpl>();
        }
        ...
        std::shared_ptr<IAutomaticGearWriter> OpenScenarioWriterFactoryImpl::CreateAutomaticGearWriter()
        {
            return std::make_shared<AutomaticGearImpl>();
        }
        ...
        std::shared_ptr<IBrakeWriter> OpenScenarioWriterFactoryImpl::CreateBrakeWriter()
        {
            return std::make_shared<BrakeImpl>();
        }

        std::shared_ptr<IBrakeInputWriter> OpenScenarioWriterFactoryImpl::CreateBrakeInputWriter()
        {
            return std::make_shared<BrakeInputImpl>();
        }
        ...
        std::shared_ptr<IClothoidSplineWriter> OpenScenarioWriterFactoryImpl::CreateClothoidSplineWriter()
        {
            return std::make_shared<ClothoidSplineImpl>();
        }

        std::shared_ptr<IClothoidSplineSegmentWriter> OpenScenarioWriterFactoryImpl::CreateClothoidSplineSegmentWriter()
        {
            return std::make_shared<ClothoidSplineSegmentImpl>();
        }
        ...
        std::shared_ptr<IColorWriter> OpenScenarioWriterFactoryImpl::CreateColorWriter()
        {
            return std::make_shared<ColorImpl>();
        }

        std::shared_ptr<IColorCmykWriter> OpenScenarioWriterFactoryImpl::CreateColorCmykWriter()
        {
            return std::make_shared<ColorCmykImpl>();
        }

        std::shared_ptr<IColorRgbWriter> OpenScenarioWriterFactoryImpl::CreateColorRgbWriter()
        {
            return std::make_shared<ColorRgbImpl>();
        }

        std::shared_ptr<IComponentAnimationWriter> OpenScenarioWriterFactoryImpl::CreateComponentAnimationWriter()
        {
            return std::make_shared<ComponentAnimationImpl>();
        }
        ...
        std::shared_ptr<IConnectTrailerActionWriter> OpenScenarioWriterFactoryImpl::CreateConnectTrailerActionWriter()
        {
            return std::make_shared<ConnectTrailerActionImpl>();
        }
        ...
        std::shared_ptr<ICustomContentWriter> OpenScenarioWriterFactoryImpl::CreateCustomContentWriter()
        {
            return std::make_shared<CustomContentImpl>();
        }
        ...
        std::shared_ptr<IDeterministicWriter> OpenScenarioWriterFactoryImpl::CreateDeterministicWriter()
        {
            return std::make_shared<DeterministicImpl>();
        }

        std::shared_ptr<IDeterministicMultiParameterDistributionWriter> OpenScenarioWriterFactoryImpl::CreateDeterministicMultiParameterDistributionWriter()
        {
            return std::make_shared<DeterministicMultiParameterDistributionImpl>();
        }

        std::shared_ptr<IDeterministicMultiParameterDistributionTypeWriter> OpenScenarioWriterFactoryImpl::CreateDeterministicMultiParameterDistributionTypeWriter()
        {
            return std::make_shared<DeterministicMultiParameterDistributionTypeImpl>();
        }

        std::shared_ptr<IDeterministicParameterDistributionWriter> OpenScenarioWriterFactoryImpl::CreateDeterministicParameterDistributionWriter()
        {
            return std::make_shared<DeterministicParameterDistributionImpl>();
        }

        std::shared_ptr<IDeterministicSingleParameterDistributionWriter> OpenScenarioWriterFactoryImpl::CreateDeterministicSingleParameterDistributionWriter()
        {
            return std::make_shared<DeterministicSingleParameterDistributionImpl>();
        }

        std::shared_ptr<IDeterministicSingleParameterDistributionTypeWriter> OpenScenarioWriterFactoryImpl::CreateDeterministicSingleParameterDistributionTypeWriter()
        {
            return std::make_shared<DeterministicSingleParameterDistributionTypeImpl>();
        }
        ...
        std::shared_ptr<IDirectionOfTravelDistributionWriter> OpenScenarioWriterFactoryImpl::CreateDirectionOfTravelDistributionWriter()
        {
            return std::make_shared<DirectionOfTravelDistributionImpl>();
        }
        ...
        std::shared_ptr<IDisconnectTrailerActionWriter> OpenScenarioWriterFactoryImpl::CreateDisconnectTrailerActionWriter()
        {
            return std::make_shared<DisconnectTrailerActionImpl>();
        }
        ...
        std::shared_ptr<IDistributionDefinitionWriter> OpenScenarioWriterFactoryImpl::CreateDistributionDefinitionWriter()
        {
            return std::make_shared<DistributionDefinitionImpl>();
        }

        std::shared_ptr<IDistributionRangeWriter> OpenScenarioWriterFactoryImpl::CreateDistributionRangeWriter()
        {
            return std::make_shared<DistributionRangeImpl>();
        }

        std::shared_ptr<IDistributionSetWriter> OpenScenarioWriterFactoryImpl::CreateDistributionSetWriter()
        {
            return std::make_shared<DistributionSetImpl>();
        }

        std::shared_ptr<IDistributionSetElementWriter> OpenScenarioWriterFactoryImpl::CreateDistributionSetElementWriter()
        {
            return std::make_shared<DistributionSetElementImpl>();
        }

        std::shared_ptr<IDomeImageWriter> OpenScenarioWriterFactoryImpl::CreateDomeImageWriter()
        {
            return std::make_shared<DomeImageImpl>();
        }
        ...
        std::shared_ptr<IEntityDistributionWriter> OpenScenarioWriterFactoryImpl::CreateEntityDistributionWriter()
        {
            return std::make_shared<EntityDistributionImpl>();
        }

        std::shared_ptr<IEntityDistributionEntryWriter> OpenScenarioWriterFactoryImpl::CreateEntityDistributionEntryWriter()
        {
            return std::make_shared<EntityDistributionEntryImpl>();
        }
        ...
        std::shared_ptr<IExternalObjectReferenceWriter> OpenScenarioWriterFactoryImpl::CreateExternalObjectReferenceWriter()
        {
            return std::make_shared<ExternalObjectReferenceImpl>();
        }
        ...
        std::shared_ptr<IGearWriter> OpenScenarioWriterFactoryImpl::CreateGearWriter()
        {
            return std::make_shared<GearImpl>();
        }

        std::shared_ptr<IGeoPositionWriter> OpenScenarioWriterFactoryImpl::CreateGeoPositionWriter()
        {
            return std::make_shared<GeoPositionImpl>();
        }
        ...
        std::shared_ptr<IHistogramWriter> OpenScenarioWriterFactoryImpl::CreateHistogramWriter()
        {
            return std::make_shared<HistogramImpl>();
        }

        std::shared_ptr<IHistogramBinWriter> OpenScenarioWriterFactoryImpl::CreateHistogramBinWriter()
        {
            return std::make_shared<HistogramBinImpl>();
        }
        ...
        std::shared_ptr<ILaneWriter> OpenScenarioWriterFactoryImpl::CreateLaneWriter()
        {
            return std::make_shared<LaneImpl>();
        }
        ...
        std::shared_ptr<ILicenseWriter> OpenScenarioWriterFactoryImpl::CreateLicenseWriter()
        {
            return std::make_shared<LicenseImpl>();
        }

        std::shared_ptr<ILightStateWriter> OpenScenarioWriterFactoryImpl::CreateLightStateWriter()
        {
            return std::make_shared<LightStateImpl>();
        }

        std::shared_ptr<ILightStateActionWriter> OpenScenarioWriterFactoryImpl::CreateLightStateActionWriter()
        {
            return std::make_shared<LightStateActionImpl>();
        }

        std::shared_ptr<ILightTypeWriter> OpenScenarioWriterFactoryImpl::CreateLightTypeWriter()
        {
            return std::make_shared<LightTypeImpl>();
        }

        std::shared_ptr<ILogNormalDistributionWriter> OpenScenarioWriterFactoryImpl::CreateLogNormalDistributionWriter()
        {
            return std::make_shared<LogNormalDistributionImpl>();
        }
        ...
        std::shared_ptr<IManualGearWriter> OpenScenarioWriterFactoryImpl::CreateManualGearWriter()
        {
            return std::make_shared<ManualGearImpl>();
        }
        ...
        std::shared_ptr<IMonitorDeclarationWriter> OpenScenarioWriterFactoryImpl::CreateMonitorDeclarationWriter()
        {
            return std::make_shared<MonitorDeclarationImpl>();
        }
        ...
        std::shared_ptr<INormalDistributionWriter> OpenScenarioWriterFactoryImpl::CreateNormalDistributionWriter()
        {
            return std::make_shared<NormalDistributionImpl>();
        }
        ...
        std::shared_ptr<IParameterValueDistributionWriter> OpenScenarioWriterFactoryImpl::CreateParameterValueDistributionWriter()
        {
            return std::make_shared<ParameterValueDistributionImpl>();
        }

        std::shared_ptr<IParameterValueDistributionDefinitionWriter> OpenScenarioWriterFactoryImpl::CreateParameterValueDistributionDefinitionWriter()
        {
            return std::make_shared<ParameterValueDistributionDefinitionImpl>();
        }

        std::shared_ptr<IParameterValueSetWriter> OpenScenarioWriterFactoryImpl::CreateParameterValueSetWriter()
        {
            return std::make_shared<ParameterValueSetImpl>();
        }
        ...
        std::shared_ptr<IPedestrianAnimationWriter> OpenScenarioWriterFactoryImpl::CreatePedestrianAnimationWriter()
        {
            return std::make_shared<PedestrianAnimationImpl>();
        }
        ...
        std::shared_ptr<IPedestrianGestureWriter> OpenScenarioWriterFactoryImpl::CreatePedestrianGestureWriter()
        {
            return std::make_shared<PedestrianGestureImpl>();
        }
        ...
        std::shared_ptr<IPoissonDistributionWriter> OpenScenarioWriterFactoryImpl::CreatePoissonDistributionWriter()
        {
            return std::make_shared<PoissonDistributionImpl>();
        }

        std::shared_ptr<IPolygonWriter> OpenScenarioWriterFactoryImpl::CreatePolygonWriter()
        {
            return std::make_shared<PolygonImpl>();
        }
        ...
        std::shared_ptr<IProbabilityDistributionSetWriter> OpenScenarioWriterFactoryImpl::CreateProbabilityDistributionSetWriter()
        {
            return std::make_shared<ProbabilityDistributionSetImpl>();
        }

        std::shared_ptr<IProbabilityDistributionSetElementWriter> OpenScenarioWriterFactoryImpl::CreateProbabilityDistributionSetElementWriter()
        {
            return std::make_shared<ProbabilityDistributionSetElementImpl>();
        }
        ...
        std::shared_ptr<IRandomRouteActionWriter> OpenScenarioWriterFactoryImpl::CreateRandomRouteActionWriter()
        {
            return std::make_shared<RandomRouteActionImpl>();
        }

        std::shared_ptr<IRangeWriter> OpenScenarioWriterFactoryImpl::CreateRangeWriter()
        {
            return std::make_shared<RangeImpl>();
        }
        ...
        std::shared_ptr<IRelativeAngleConditionWriter> OpenScenarioWriterFactoryImpl::CreateRelativeAngleConditionWriter()
        {
            return std::make_shared<RelativeAngleConditionImpl>();
        }

        std::shared_ptr<IRelativeClearanceConditionWriter> OpenScenarioWriterFactoryImpl::CreateRelativeClearanceConditionWriter()
        {
            return std::make_shared<RelativeClearanceConditionImpl>();
        }
        ...
        std::shared_ptr<IRelativeLaneRangeWriter> OpenScenarioWriterFactoryImpl::CreateRelativeLaneRangeWriter()
        {
            return std::make_shared<RelativeLaneRangeImpl>();
        }
        ...
        std::shared_ptr<IRoadCursorWriter> OpenScenarioWriterFactoryImpl::CreateRoadCursorWriter()
        {
            return std::make_shared<RoadCursorImpl>();
        }
        ...
        std::shared_ptr<IRoadRangeWriter> OpenScenarioWriterFactoryImpl::CreateRoadRangeWriter()
        {
            return std::make_shared<RoadRangeImpl>();
        }
        ...
        std::shared_ptr<IScenarioObjectTemplateWriter> OpenScenarioWriterFactoryImpl::CreateScenarioObjectTemplateWriter()
        {
            return std::make_shared<ScenarioObjectTemplateImpl>();
        }
        ...
        std::shared_ptr<ISensorReferenceWriter> OpenScenarioWriterFactoryImpl::CreateSensorReferenceWriter()
        {
            return std::make_shared<SensorReferenceImpl>();
        }

        std::shared_ptr<ISensorReferenceSetWriter> OpenScenarioWriterFactoryImpl::CreateSensorReferenceSetWriter()
        {
            return std::make_shared<SensorReferenceSetImpl>();
        }

        std::shared_ptr<ISetMonitorActionWriter> OpenScenarioWriterFactoryImpl::CreateSetMonitorActionWriter()
        {
            return std::make_shared<SetMonitorActionImpl>();
        }
        ...
        std::shared_ptr<ISpeedProfileActionWriter> OpenScenarioWriterFactoryImpl::CreateSpeedProfileActionWriter()
        {
            return std::make_shared<SpeedProfileActionImpl>();
        }

        std::shared_ptr<ISpeedProfileEntryWriter> OpenScenarioWriterFactoryImpl::CreateSpeedProfileEntryWriter()
        {
            return std::make_shared<SpeedProfileEntryImpl>();
        }
        ...
        std::shared_ptr<ISteadyStateWriter> OpenScenarioWriterFactoryImpl::CreateSteadyStateWriter()
        {
            return std::make_shared<SteadyStateImpl>();
        }

        std::shared_ptr<IStochasticWriter> OpenScenarioWriterFactoryImpl::CreateStochasticWriter()
        {
            return std::make_shared<StochasticImpl>();
        }

        std::shared_ptr<IStochasticDistributionWriter> OpenScenarioWriterFactoryImpl::CreateStochasticDistributionWriter()
        {
            return std::make_shared<StochasticDistributionImpl>();
        }

        std::shared_ptr<IStochasticDistributionTypeWriter> OpenScenarioWriterFactoryImpl::CreateStochasticDistributionTypeWriter()
        {
            return std::make_shared<StochasticDistributionTypeImpl>();
        }
        ...
        std::shared_ptr<ITargetDistanceSteadyStateWriter> OpenScenarioWriterFactoryImpl::CreateTargetDistanceSteadyStateWriter()
        {
            return std::make_shared<TargetDistanceSteadyStateImpl>();
        }

        std::shared_ptr<ITargetTimeSteadyStateWriter> OpenScenarioWriterFactoryImpl::CreateTargetTimeSteadyStateWriter()
        {
            return std::make_shared<TargetTimeSteadyStateImpl>();
        }
        ...
        std::shared_ptr<ITrafficAreaWriter> OpenScenarioWriterFactoryImpl::CreateTrafficAreaWriter()
        {
            return std::make_shared<TrafficAreaImpl>();
        }

        std::shared_ptr<ITrafficAreaActionWriter> OpenScenarioWriterFactoryImpl::CreateTrafficAreaActionWriter()
        {
            return std::make_shared<TrafficAreaActionImpl>();
        }
        ...
        std::shared_ptr<ITrafficDistributionWriter> OpenScenarioWriterFactoryImpl::CreateTrafficDistributionWriter()
        {
            return std::make_shared<TrafficDistributionImpl>();
        }

        std::shared_ptr<ITrafficDistributionEntryWriter> OpenScenarioWriterFactoryImpl::CreateTrafficDistributionEntryWriter()
        {
            return std::make_shared<TrafficDistributionEntryImpl>();
        }
        ...
        std::shared_ptr<ITrafficSignalGroupStateWriter> OpenScenarioWriterFactoryImpl::CreateTrafficSignalGroupStateWriter()
        {
            return std::make_shared<TrafficSignalGroupStateImpl>();
        }
        ...
        std::shared_ptr<ITrafficStopActionWriter> OpenScenarioWriterFactoryImpl::CreateTrafficStopActionWriter()
        {
            return std::make_shared<TrafficStopActionImpl>();
        }
        ...
        std::shared_ptr<ITrailerWriter> OpenScenarioWriterFactoryImpl::CreateTrailerWriter()
        {
            return std::make_shared<TrailerImpl>();
        }

        std::shared_ptr<ITrailerActionWriter> OpenScenarioWriterFactoryImpl::CreateTrailerActionWriter()
        {
            return std::make_shared<TrailerActionImpl>();
        }

        std::shared_ptr<ITrailerCouplerWriter> OpenScenarioWriterFactoryImpl::CreateTrailerCouplerWriter()
        {
            return std::make_shared<TrailerCouplerImpl>();
        }

        std::shared_ptr<ITrailerHitchWriter> OpenScenarioWriterFactoryImpl::CreateTrailerHitchWriter()
        {
            return std::make_shared<TrailerHitchImpl>();
        }
        ...
        std::shared_ptr<ITrajectoryPositionWriter> OpenScenarioWriterFactoryImpl::CreateTrajectoryPositionWriter()
        {
            return std::make_shared<TrajectoryPositionImpl>();
        }

        std::shared_ptr<ITrajectoryRefWriter> OpenScenarioWriterFactoryImpl::CreateTrajectoryRefWriter()
        {
            return std::make_shared<TrajectoryRefImpl>();
        }
        ...
        std::shared_ptr<IUniformDistributionWriter> OpenScenarioWriterFactoryImpl::CreateUniformDistributionWriter()
        {
            return std::make_shared<UniformDistributionImpl>();
        }

        std::shared_ptr<IUsedAreaWriter> OpenScenarioWriterFactoryImpl::CreateUsedAreaWriter()
        {
            return std::make_shared<UsedAreaImpl>();
        }
        ...
        std::shared_ptr<IUserDefinedAnimationWriter> OpenScenarioWriterFactoryImpl::CreateUserDefinedAnimationWriter()
        {
            return std::make_shared<UserDefinedAnimationImpl>();
        }

        std::shared_ptr<IUserDefinedComponentWriter> OpenScenarioWriterFactoryImpl::CreateUserDefinedComponentWriter()
        {
            return std::make_shared<UserDefinedComponentImpl>();
        }

        std::shared_ptr<IUserDefinedDistributionWriter> OpenScenarioWriterFactoryImpl::CreateUserDefinedDistributionWriter()
        {
            return std::make_shared<UserDefinedDistributionImpl>();
        }

        std::shared_ptr<IUserDefinedLightWriter> OpenScenarioWriterFactoryImpl::CreateUserDefinedLightWriter()
        {
            return std::make_shared<UserDefinedLightImpl>();
        }
        ...
        std::shared_ptr<IValueConstraintWriter> OpenScenarioWriterFactoryImpl::CreateValueConstraintWriter()
        {
            return std::make_shared<ValueConstraintImpl>();
        }

        std::shared_ptr<IValueConstraintGroupWriter> OpenScenarioWriterFactoryImpl::CreateValueConstraintGroupWriter()
        {
            return std::make_shared<ValueConstraintGroupImpl>();
        }

        std::shared_ptr<IValueSetDistributionWriter> OpenScenarioWriterFactoryImpl::CreateValueSetDistributionWriter()
        {
            return std::make_shared<ValueSetDistributionImpl>();
        }

        std::shared_ptr<IVariableActionWriter> OpenScenarioWriterFactoryImpl::CreateVariableActionWriter()
        {
            return std::make_shared<VariableActionImpl>();
        }

        std::shared_ptr<IVariableAddValueRuleWriter> OpenScenarioWriterFactoryImpl::CreateVariableAddValueRuleWriter()
        {
            return std::make_shared<VariableAddValueRuleImpl>();
        }

        std::shared_ptr<IVariableConditionWriter> OpenScenarioWriterFactoryImpl::CreateVariableConditionWriter()
        {
            return std::make_shared<VariableConditionImpl>();
        }

        std::shared_ptr<IVariableDeclarationWriter> OpenScenarioWriterFactoryImpl::CreateVariableDeclarationWriter()
        {
            return std::make_shared<VariableDeclarationImpl>();
        }

        std::shared_ptr<IVariableModifyActionWriter> OpenScenarioWriterFactoryImpl::CreateVariableModifyActionWriter()
        {
            return std::make_shared<VariableModifyActionImpl>();
        }

        std::shared_ptr<IVariableModifyRuleWriter> OpenScenarioWriterFactoryImpl::CreateVariableModifyRuleWriter()
        {
            return std::make_shared<VariableModifyRuleImpl>();
        }

        std::shared_ptr<IVariableMultiplyByValueRuleWriter> OpenScenarioWriterFactoryImpl::CreateVariableMultiplyByValueRuleWriter()
        {
            return std::make_shared<VariableMultiplyByValueRuleImpl>();
        }

        std::shared_ptr<IVariableSetActionWriter> OpenScenarioWriterFactoryImpl::CreateVariableSetActionWriter()
        {
            return std::make_shared<VariableSetActionImpl>();
        }
        ...
        std::shared_ptr<IVehicleComponentWriter> OpenScenarioWriterFactoryImpl::CreateVehicleComponentWriter()
        {
            return std::make_shared<VehicleComponentImpl>();
        }

        std::shared_ptr<IVehicleLightWriter> OpenScenarioWriterFactoryImpl::CreateVehicleLightWriter()
        {
            return std::make_shared<VehicleLightImpl>();
        }

        std::shared_ptr<IVehicleRoleDistributionWriter> OpenScenarioWriterFactoryImpl::CreateVehicleRoleDistributionWriter()
        {
            return std::make_shared<VehicleRoleDistributionImpl>();
        }

        std::shared_ptr<IVehicleRoleDistributionEntryWriter> OpenScenarioWriterFactoryImpl::CreateVehicleRoleDistributionEntryWriter()
        {
            return std::make_shared<VehicleRoleDistributionEntryImpl>();
        }
        ...
        std::shared_ptr<IWindWriter> OpenScenarioWriterFactoryImpl::CreateWindWriter()
        {
            return std::make_shared<WindImpl>();
        }
