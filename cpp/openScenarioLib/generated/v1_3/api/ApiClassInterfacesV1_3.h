...
namespace NET_ASAM_OPENSCENARIO
{
    namespace v1_3
    {
        ...
        class IClothoid;
        class IClothoidSpline;
        class IClothoidSplineSegment;
        ...
        class IDirectory;
        class IDisconnectTrailerAction;
        ...
        class IEntityDistribution;
        class IEntityDistributionEntry;
        class IEntityObject;
        class IEntityRef;
        ...
        class IProperties;
        class IProperty;
        class IRandomRouteAction;
        class IRange;
        class IReachPositionCondition;
        class IRelativeAngleCondition;
        ...
        class ITrafficArea;
        class ITrafficAreaAction;
        class ITrafficDefinition;
        class ITrafficDistribution;
        class ITrafficDistributionEntry;
        ...
        class ITrailer;
        class ITrailerAction;
        class ITrailerCoupler;
        class ITrailerHitch;
        class ITrajectory;
...
Note: Although it is allowed to omit the
        ...
        */
        ...
        public:
            ...
            */
            virtual std::shared_ptr<INamedReference<IObjectController>> GetObjectControllerRef() const
            {
                return std::make_shared<INamedReference<IObjectController>>();
            }
            ...
            */
            ...
            /**
            * Retrieves whether property objectControllerRef is set
            * @return true when the property is set
            */
            virtual bool IsSetObjectControllerRef() const = 0;
...
The angle can be measured in the global world coordinate system or in s-t coordinates like road, lane
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class IAngleCondition : public virtual IOpenScenarioModelElement
        {
        public:
            virtual ~IAngleCondition() = default;
            ...
            */
            virtual AngleType GetAngleType() const
            {
                return AngleType();
            }
            ...
            */
            ...
            /**
            * Retrieves whether property angle is set
            * @return true when the property is set
            */
            virtual bool IsSetAngle() const = 0;
            /**
            * Retrieves whether property angleTolerance is set
            * @return true when the property is set
            */
            virtual bool IsSetAngleTolerance() const = 0;
            /**
            * Retrieves whether property angleType is set
            * @return true when the property is set
            */
            virtual bool IsSetAngleType() const = 0;
            /**
        ...
        */
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class IClothoidSpline : public virtual IOpenScenarioModelElement
        {
        public:
            virtual ~IClothoidSpline() = default;
            ...
            */
            virtual std::vector<std::shared_ptr<IClothoidSplineSegment>> GetSegments() const
            {
                return std::vector<std::shared_ptr<IClothoidSplineSegment>>();
            }
            ...
            * @return the size of the list
            */
            virtual int GetSegmentsSize() const { return 0; }
            ...
            * @return the element at index
            */
            virtual std::shared_ptr<IClothoidSplineSegment> GetSegmentsAtIndex(const unsigned int index) const
            {
                return nullptr;
            }

            /**
            * Retrieves whether property timeEnd is set
            * @return true when the property is set
            */
            virtual bool IsSetTimeEnd() const = 0;
            /**
            * Retrieves whether property segments is set
            * @return true when the property is set
            */
            virtual bool IsSetSegments() const = 0;
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class IClothoidSplineSegment : public virtual IOpenScenarioModelElement
        {
        public:
            virtual ~IClothoidSplineSegment() = default;
            ...
            */
            virtual double GetCurvatureEnd() const
            {
                return 0;
            }
            ...
            */
            virtual double GetCurvatureStart() const
            {
                return 0;
            }
            ...
            */
            virtual double GetHOffset() const
            {
                return 0;
            }
            ...
            */
            virtual std::shared_ptr<IPosition> GetPositionStart() const
            {
                return nullptr;
            }
            ...
            /**
            * Retrieves whether property curvatureEnd is set
            * @return true when the property is set
            */
            virtual bool IsSetCurvatureEnd() const = 0;
            /**
            * Retrieves whether property curvatureStart is set
            * @return true when the property is set
            */
            virtual bool IsSetCurvatureStart() const = 0;
            /**
            * Retrieves whether property hOffset is set
            * @return true when the property is set
            */
            virtual bool IsSetHOffset() const = 0;
            /**
            * Retrieves whether property length is set
            * @return true when the property is set
            */
            virtual bool IsSetLength() const = 0;
            /**
            * Retrieves whether property timeStart is set
            * @return true when the property is set
            */
            virtual bool IsSetTimeStart() const = 0;
            /**
            * Retrieves whether property positionStart is set
            * @return true when the property is set
            */
            virtual bool IsSetPositionStart() const = 0;
        ...
        */
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class IConnectTrailerAction : public virtual IOpenScenarioModelElement
        {
        public:
            virtual ~IConnectTrailerAction() = default;
            ...
            */
            virtual std::shared_ptr<INamedReference<IEntity>> GetTrailerRef() const
            {
                return std::make_shared<INamedReference<IEntity>>();
            }
            ...
            /**
            * Retrieves whether property trailerRef is set
            * @return true when the property is set
            */
            virtual bool IsSetTrailerRef() const = 0;
        ...
        */
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class IDisconnectTrailerAction : public virtual IOpenScenarioModelElement
        {
        public:
            virtual ~IDisconnectTrailerAction() = default;
...
An entity can only exist in one copy. Adding an already active entity will have no effect, neither
        ...
        */
        ...
        public:
            ...
            */
            virtual std::shared_ptr<IAngleCondition> GetAngleCondition() const
            {
                return nullptr;
            }
            ...
            */
            virtual std::shared_ptr<IRelativeAngleCondition> GetRelativeAngleCondition() const
            {
                return nullptr;
            }
            ...
            */
            ...
            /**
            * Retrieves whether property angleCondition is set
            * @return true when the property is set
            */
            virtual bool IsSetAngleCondition() const = 0;
            /**
            * Retrieves whether property relativeAngleCondition is set
            * @return true when the property is set
            */
            virtual bool IsSetRelativeAngleCondition() const = 0;
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class IEntityDistribution : public virtual IOpenScenarioModelElement
        {
        public:
            virtual ~IEntityDistribution() = default;
            ...
            */
            virtual std::vector<std::shared_ptr<IEntityDistributionEntry>> GetEntityDistributionEntry() const
            {
                return std::vector<std::shared_ptr<IEntityDistributionEntry>>();
            }
            ...
            * @return the size of the list
            */
            virtual int GetEntityDistributionEntrySize() const { return 0; }
            ...
            * @return the element at index
            */
            virtual std::shared_ptr<IEntityDistributionEntry> GetEntityDistributionEntryAtIndex(const unsigned int index) const
            {
                return nullptr;
            }

            /**
            * Retrieves whether property entityDistributionEntry is set
            * @return true when the property is set
            */
            virtual bool IsSetEntityDistributionEntry() const = 0;
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class IEntityDistributionEntry : public virtual IOpenScenarioModelElement
        {
        public:
            virtual ~IEntityDistributionEntry() = default;
            ...
            */
            virtual std::shared_ptr<IScenarioObjectTemplate> GetScenarioObjectTemplate() const
            {
                return nullptr;
            }
            ...
            */
            virtual bool IsSetWeight() const = 0;
            /**
            * Retrieves whether property scenarioObjectTemplate is set
            * @return true when the property is set
            */
            virtual bool IsSetScenarioObjectTemplate() const = 0;
...
The transformation
        ...
        */
        ...
        public:
            ...
            */
            virtual int GetVerticalRoadSelection() const
            {
                return 0;
            }
...
Missing Orientation property is interpreted as the relative reference context with
            ...
            */
            ...
            /**
            * Retrieves whether property verticalRoadSelection is set
            * @return true when the property is set
            */
            virtual bool IsSetVerticalRoadSelection() const = 0;
            /**
        ...
        */
        ...
        public:
            ...
            */
            virtual std::shared_ptr<ISetMonitorAction> GetSetMonitorAction() const
            {
                return nullptr;
            }
            ...
            */
            ...
            /**
            * Retrieves whether property setMonitorAction is set
            * @return true when the property is set
            */
            virtual bool IsSetSetMonitorAction() const = 0;
            /**
        ...
        */
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class ILane : public virtual IOpenScenarioModelElement
        {
        public:
            ...
            */
            ...
            /**
            * Retrieves whether property id is set
            * @return true when the property is set
            */
            virtual bool IsSetId() const = 0;
...
Missing Orientation
        ...
        */
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class ILogNormalDistribution : public virtual IOpenScenarioModelElement
        {
        public:
            virtual ~ILogNormalDistribution() = default;
...
The target position may be either on the same road segment where the reference
        ...
        */
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class IMonitorDeclaration : public virtual IOpenScenarioModelElement
        {
        public:
            virtual ~IMonitorDeclaration() = default;
...
The
        ...
        */
        ...
        public:
            ...
            */
            virtual std::shared_ptr<ITrafficSignalGroupState> GetTrafficSignalGroupState() const
            {
                return nullptr;
            }
            ...
            */
            ...
            /**
            * Retrieves whether property trafficSignalGroupState is set
            * @return true when the property is set
            */
            virtual bool IsSetTrafficSignalGroupState() const = 0;
        ...
        */
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class IPolygon : public virtual IOpenScenarioModelElement
        {
        public:
        ...
        */
        ...
        public:
            ...
            */
            virtual std::shared_ptr<ITrailerAction> GetTrailerAction() const
            {
                return nullptr;
            }
            ...
            */
            ...
            /**
            * Retrieves whether property trailerAction is set
            * @return true when the property is set
            */
            virtual bool IsSetTrailerAction() const = 0;
        ...
        */
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class IRandomRouteAction : public virtual IOpenScenarioModelElement
        {
        public:
            virtual ~IRandomRouteAction() = default;
...
Note that for the s-t coordinate systems the orientation is measured at the local s-coordinate of each
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class IRelativeAngleCondition : public virtual IOpenScenarioModelElement
        {
        public:
            virtual ~IRelativeAngleCondition() = default;
...
Missing Orientation property is interpreted as the relative
        ...
        */
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class IRoadCursor : public virtual IOpenScenarioModelElement
        {
        public:
            virtual ~IRoadCursor() = default;
            ...
            */
            virtual std::vector<std::shared_ptr<ILane>> GetLane() const
            {
                return std::vector<std::shared_ptr<ILane>>();
            }
            ...
            * @return the size of the list
            */
            virtual int GetLaneSize() const { return 0; }
            ...
            * @return the element at index
            */
            virtual std::shared_ptr<ILane> GetLaneAtIndex(const unsigned int index) const
            {
                return nullptr;
            }
            ...
            */
            virtual bool IsSetS() const = 0;
            /**
            * Retrieves whether property lane is set
            * @return true when the property is set
            */
            virtual bool IsSetLane() const = 0;
...
Missing Orientation
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class IRoadRange : public virtual IOpenScenarioModelElement
        {
        public:
            virtual ~IRoadRange() = default;
            ...
            */
            virtual std::vector<std::shared_ptr<IRoadCursor>> GetRoadCursor() const
            {
                return std::vector<std::shared_ptr<IRoadCursor>>();
            }
            ...
            * @return the size of the list
            */
            virtual int GetRoadCursorSize() const { return 0; }
            ...
            * @return the element at index
            */
            virtual std::shared_ptr<IRoadCursor> GetRoadCursorAtIndex(const unsigned int index) const
            {
                return nullptr;
            }
            ...
            */
            virtual bool IsSetLength() const = 0;
            /**
            * Retrieves whether property roadCursor is set
            * @return true when the property is set
            */
            virtual bool IsSetRoadCursor() const = 0;
...
Further, it can be enforced that an entity selects its routing at each
        ...
        */
        ...
        public:
            ...
            */
            virtual std::shared_ptr<IRandomRouteAction> GetRandomRouteAction() const
            {
                return nullptr;
            }
            ...
            */
            ...
            /**
            * Retrieves whether property randomRouteAction is set
            * @return true when the property is set
            */
            virtual bool IsSetRandomRouteAction() const = 0;
        ...
        */
        ...
        public:
            ...
            */
            virtual std::vector<std::shared_ptr<IMonitorDeclaration>> GetMonitorDeclarations() const
            {
                return std::vector<std::shared_ptr<IMonitorDeclaration>>();
            }
            ...
            * @return the size of the list
            */
            virtual int GetMonitorDeclarationsSize() const { return 0; }
            ...
            * @return the element at index
            */
            virtual std::shared_ptr<IMonitorDeclaration> GetMonitorDeclarationsAtIndex(const unsigned int index) const
            {
                return nullptr;
            }
            ...
            */
            ...
            /**
            * Retrieves whether property monitorDeclarations is set
            * @return true when the property is set
            */
            virtual bool IsSetMonitorDeclarations() const = 0;
            /**
        ...
        */
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class IScenarioObjectTemplate : public virtual IOpenScenarioModelElement, public IEntity
        {
        public:
            virtual ~IScenarioObjectTemplate() = default;
            ...
            */
            virtual std::shared_ptr<IEntityObject> GetEntitiyObject() const
            {
                return nullptr;
            }
            ...
            */
            ...
            /**
            * Retrieves whether property entitiyObject is set
            * @return true when the property is set
            */
            virtual bool IsSetEntitiyObject() const = 0;
            /**
            * Retrieves whether property objectController is set
            * @return true when the property is set
            */
        ...
        */
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class ISetMonitorAction : public virtual IOpenScenarioModelElement
        {
        public:
            virtual ~ISetMonitorAction() = default;
            ...
            */
            virtual std::shared_ptr<INamedReference<IMonitorDeclaration>> GetMonitorRef() const
            {
                return std::make_shared<INamedReference<IMonitorDeclaration>>();
            }
            ...
            */
            ...
            /**
            * Retrieves whether property monitorRef is set
            * @return true when the property is set
            */
            virtual bool IsSetMonitorRef() const = 0;
            /**
            * Retrieves whether property value is set
            * @return true when the property is set
            */
        ...
        */
        ...
        public:
            ...
            */
            virtual std::shared_ptr<IClothoidSpline> GetClothoidSpline() const
            {
                return nullptr;
            }
            ...
            */
            ...
            /**
            * Retrieves whether property clothoidSpline is set
            * @return true when the property is set
            */
            virtual bool IsSetClothoidSpline() const = 0;
            /**
        ...
        */
        ...
        public:
            ...
            */
            virtual std::shared_ptr<ILogNormalDistribution> GetLogNormalDistribution() const
            {
                return nullptr;
            }
            ...
            */
            ...
            /**
            * Retrieves whether property logNormalDistribution is set
            * @return true when the property is set
            */
            virtual bool IsSetLogNormalDistribution() const = 0;
            /**
        ...
        */
        ...
        public:
            ...
            */
            virtual std::shared_ptr<ITrafficAreaAction> GetTrafficAreaAction() const
            {
                return nullptr;
            }
            ...
            */
            ...
            /**
            * Retrieves whether property trafficAreaAction is set
            * @return true when the property is set
            */
            virtual bool IsSetTrafficAreaAction() const = 0;
            /**
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class ITrafficArea : public virtual IOpenScenarioModelElement
        {
        public:
            virtual ~ITrafficArea() = default;
            ...
            */
            virtual std::shared_ptr<IPolygon> GetPolygon() const
            {
                return nullptr;
            }
            ...
            */
            virtual std::vector<std::shared_ptr<IRoadRange>> GetRoadRange() const
            {
                return std::vector<std::shared_ptr<IRoadRange>>();
            }
            ...
            * @return the size of the list
            */
            virtual int GetRoadRangeSize() const { return 0; }
            ...
            * @return the element at index
            */
            virtual std::shared_ptr<IRoadRange> GetRoadRangeAtIndex(const unsigned int index) const
            {
                return nullptr;
            }

            /**
            * Retrieves whether property polygon is set
            * @return true when the property is set
            */
            virtual bool IsSetPolygon() const = 0;
            /**
            * Retrieves whether property roadRange is set
            * @return true when the property is set
            */
            virtual bool IsSetRoadRange() const = 0;
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class ITrafficAreaAction : public virtual IOpenScenarioModelElement
        {
        public:
            virtual ~ITrafficAreaAction() = default;
            ...
            */
            virtual std::shared_ptr<ITrafficDistribution> GetTrafficDistribution() const
            {
                return nullptr;
            }
            ...
            */
            virtual std::shared_ptr<ITrafficArea> GetTrafficArea() const
            {
                return nullptr;
            }
            ...
            */
            virtual bool IsSetContinuous() const = 0;
            /**
            * Retrieves whether property numberOfEntities is set
            * @return true when the property is set
            */
            virtual bool IsSetNumberOfEntities() const = 0;
            /**
            * Retrieves whether property trafficDistribution is set
            * @return true when the property is set
            */
            virtual bool IsSetTrafficDistribution() const = 0;
            /**
            * Retrieves whether property trafficArea is set
            * @return true when the property is set
            */
            virtual bool IsSetTrafficArea() const = 0;
        ...
        */
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class ITrafficDistribution : public virtual IOpenScenarioModelElement
        {
        public:
            virtual ~ITrafficDistribution() = default;
            ...
            */
            virtual std::vector<std::shared_ptr<ITrafficDistributionEntry>> GetTrafficDistributionEntry() const
            {
                return std::vector<std::shared_ptr<ITrafficDistributionEntry>>();
            }
            ...
            * @return the size of the list
            */
            virtual int GetTrafficDistributionEntrySize() const { return 0; }
            ...
            * @return the element at index
            */
            virtual std::shared_ptr<ITrafficDistributionEntry> GetTrafficDistributionEntryAtIndex(const unsigned int index) const
            {
                return nullptr;
            }

            /**
            * Retrieves whether property trafficDistributionEntry is set
            * @return true when the property is set
            */
            virtual bool IsSetTrafficDistributionEntry() const = 0;
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class ITrafficDistributionEntry : public virtual IOpenScenarioModelElement
        {
        public:
            virtual ~ITrafficDistributionEntry() = default;
            ...
            */
            virtual std::shared_ptr<IEntityDistribution> GetEntityDistribution() const
            {
                return nullptr;
            }
            ...
            */
            virtual bool IsSetWeight() const = 0;
            /**
            * Retrieves whether property entityDistribution is set
            * @return true when the property is set
            */
            virtual bool IsSetEntityDistribution() const = 0;
            /**
            * Retrieves whether property properties is set
            * @return true when the property is set
            */
        ...
        */
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class ITrailer : public virtual IOpenScenarioModelElement
        {
        public:
            virtual ~ITrailer() = default;
            ...
            */
            virtual std::shared_ptr<IScenarioObject> GetTrailer() const
            {
                return nullptr;
            }
             ...
             * @return value of model property trailerRef
            */
            virtual std::shared_ptr<IEntityRef> GetTrailerRef() const
            {
                return nullptr;
            }
            ...
            /**
            * Retrieves whether property trailer is set
            * @return true when the property is set
            */
            virtual bool IsSetTrailer() const = 0;
            /**
            * Retrieves whether property trailerRef is set
            * @return true when the property is set
            */
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class ITrailerAction : public virtual IOpenScenarioModelElement
        {
        public:
            virtual ~ITrailerAction() = default;
            ...
            */
            virtual std::shared_ptr<IConnectTrailerAction> GetConnectTrailerAction() const
            {
                return nullptr;
            }
            ...
            */
            virtual std::shared_ptr<IDisconnectTrailerAction> GetDisconnectTrailerAction() const
            {
                return nullptr;
            }
            ...
            /**
            * Retrieves whether property connectTrailerAction is set
            * @return true when the property is set
            */
            virtual bool IsSetConnectTrailerAction() const = 0;
            /**
            * Retrieves whether property disconnectTrailerAction is set
            * @return true when the property is set
            */
            virtual bool IsSetDisconnectTrailerAction() const = 0;
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class ITrailerCoupler : public virtual IOpenScenarioModelElement
        {
        public:
            virtual ~ITrailerCoupler() = default;
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class ITrailerHitch : public virtual IOpenScenarioModelElement
        {
        public:
            virtual ~ITrailerHitch() = default;
...
Multiple constraint groups are
        ...
        */
        ...
        public:
            ...
            */
            virtual std::shared_ptr<ITrailerHitch> GetTrailerHitch() const
            {
                return nullptr;
            }
            ...
            */
            virtual std::shared_ptr<ITrailerCoupler> GetTrailerCoupler() const
            {
                return nullptr;
            }
             ...
             * @return value of model property trailer
            */
            virtual std::shared_ptr<ITrailer> GetTrailer() const
            {
                return nullptr;
            }
            ...
            */
            virtual bool IsSetProperties() const = 0;
            /**
            * Retrieves whether property trailerHitch is set
            * @return true when the property is set
            */
            virtual bool IsSetTrailerHitch() const = 0;
            /**
            * Retrieves whether property trailerCoupler is set
            * @return true when the property is set
            */
            virtual bool IsSetTrailerCoupler() const = 0;
            /**
            * Retrieves whether property trailer is set
            * @return true when the property is set
            */
