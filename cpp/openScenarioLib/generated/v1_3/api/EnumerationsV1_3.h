...
namespace NET_ASAM_OPENSCENARIO
{
    namespace v1_3
    {
         ...
         * <ul>
         * <li>Select the heading angle.
         * <li>Select the pitch angle.
         * <li>Select the roll angle.
         * </ul>
         * 
        ...
        */
        ...
        private:
            std::string _literal;
            AngleTypeEnum _angleTypeEnum;
            static std::map<std::string, AngleTypeEnum> _stringToEnum;

        public:
            const std::vector<std::string> kAngleTypeEnumString 
            {
                "UNKNOWN",
                "heading",
                "pitch",
             ...
             * Default Constructor
             */
            OPENSCENARIOLIB_EXP AngleType();

            OPENSCENARIOLIB_EXP AngleType(AngleTypeEnum& angleType);

            OPENSCENARIOLIB_EXP AngleType(const AngleTypeEnum angleType);

			OPENSCENARIOLIB_EXP static bool IsDeprecated(const AngleTypeEnum angleType);
			
			OPENSCENARIOLIB_EXP static std::string GetDeprecatedVersion(const AngleTypeEnum angleType);

			OPENSCENARIOLIB_EXP static std::string GetDeprecatedComment(const AngleTypeEnum angleType);

            /**
             * Constructor using the literal
             * @param literal_ as defined in OpenSCENARIO
             */
            OPENSCENARIOLIB_EXP AngleType(std::string& literal_);
            ...
            OPENSCENARIOLIB_EXP AngleType& operator= (const AngleTypeEnum &rhs);

            OPENSCENARIOLIB_EXP AngleType& operator= (const AngleType &rhs );

            OPENSCENARIOLIB_EXP bool operator== (const AngleTypeEnum &rhs) const;
            /**
             * The enumeration value from the literal
             * @param literal_ as defined in OpenSCENARIO
             * @return the enumeration value
             */
            OPENSCENARIOLIB_EXP static AngleTypeEnum GetFromLiteral(const std::string literal_);
        ...
        */
         ...
         * <li>Trajectory-based s,t coordinate system (s-axis is the trajectory-arc, which the entity follows).
         * <li>Cartesian XYZ world coordinate system.
         * </ul>
         * 
         * @author RA Consulting OpenSCENARIO generation facility
        */
