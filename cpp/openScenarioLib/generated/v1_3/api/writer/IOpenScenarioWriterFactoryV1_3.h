    ...
    namespace v1_3
    {
        ...
        */
        ...
        public:
            ...
            virtual std::shared_ptr<IAngleConditionWriter> CreateAngleConditionWriter() = 0;
            ...
            virtual std::shared_ptr<IClothoidSplineWriter> CreateClothoidSplineWriter() = 0;
            virtual std::shared_ptr<IClothoidSplineSegmentWriter> CreateClothoidSplineSegmentWriter() = 0;
            ...
            virtual std::shared_ptr<IConnectTrailerActionWriter> CreateConnectTrailerActionWriter() = 0;
            ...
            virtual std::shared_ptr<IDisconnectTrailerActionWriter> CreateDisconnectTrailerActionWriter() = 0;
            ...
            virtual std::shared_ptr<IEntityDistributionWriter> CreateEntityDistributionWriter() = 0;
            virtual std::shared_ptr<IEntityDistributionEntryWriter> CreateEntityDistributionEntryWriter() = 0;
            ...
            virtual std::shared_ptr<ILaneWriter> CreateLaneWriter() = 0;
            ...
            virtual std::shared_ptr<ILogNormalDistributionWriter> CreateLogNormalDistributionWriter() = 0;
            ...
            virtual std::shared_ptr<IMonitorDeclarationWriter> CreateMonitorDeclarationWriter() = 0;
            ...
            virtual std::shared_ptr<IPolygonWriter> CreatePolygonWriter() = 0;
            ...
            virtual std::shared_ptr<IRandomRouteActionWriter> CreateRandomRouteActionWriter() = 0;
            ...
            virtual std::shared_ptr<IRelativeAngleConditionWriter> CreateRelativeAngleConditionWriter() = 0;
            ...
            virtual std::shared_ptr<IRoadCursorWriter> CreateRoadCursorWriter() = 0;
            ...
            virtual std::shared_ptr<IRoadRangeWriter> CreateRoadRangeWriter() = 0;
            ...
            virtual std::shared_ptr<IScenarioObjectTemplateWriter> CreateScenarioObjectTemplateWriter() = 0;
            ...
            virtual std::shared_ptr<ISetMonitorActionWriter> CreateSetMonitorActionWriter() = 0;
            ...
            virtual std::shared_ptr<ITrafficAreaWriter> CreateTrafficAreaWriter() = 0;
            virtual std::shared_ptr<ITrafficAreaActionWriter> CreateTrafficAreaActionWriter() = 0;
            virtual std::shared_ptr<ITrafficDefinitionWriter> CreateTrafficDefinitionWriter() = 0;
            virtual std::shared_ptr<ITrafficDistributionWriter> CreateTrafficDistributionWriter() = 0;
            virtual std::shared_ptr<ITrafficDistributionEntryWriter> CreateTrafficDistributionEntryWriter() = 0;
            ...
            virtual std::shared_ptr<ITrailerWriter> CreateTrailerWriter() = 0;
            virtual std::shared_ptr<ITrailerActionWriter> CreateTrailerActionWriter() = 0;
            virtual std::shared_ptr<ITrailerCouplerWriter> CreateTrailerCouplerWriter() = 0;
            virtual std::shared_ptr<ITrailerHitchWriter> CreateTrailerHitchWriter() = 0;
