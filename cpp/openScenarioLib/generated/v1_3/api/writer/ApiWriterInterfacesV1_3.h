...
namespace NET_ASAM_OPENSCENARIO
{
    namespace v1_3
    {
        ...
        */
         ...
         * From OpenSCENARIO class model specification:
         * Instances of the types ScenarioObject, ScenarioObjectTemplate, EntitySelection and SpawnedObject are considered to be
         * instances of type Entity. Or less formal: scenario objects and entity selections are both entities. An entity is either
         * a scenario object or an entity selection.
         * 
         * @author RA Consulting OpenSCENARIO generation facility
        */
         ...
         * This is a automatic generated file according to the OpenSCENARIO specification version 1.3
         * <p>
         * A Writer for the type 'MotionControlAction'
         * From OpenSCENARIO class model specification:
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class IMotionControlActionWriter: public virtual IOpenScenarioModelElement
        {
        public:
            IMotionControlActionWriter() = default;
            virtual ~IMotionControlActionWriter() = default;
        };
