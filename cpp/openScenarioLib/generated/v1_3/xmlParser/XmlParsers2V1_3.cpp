    ...
    namespace v1_3
    {
        ...
        */
        ...
        std::vector<std::shared_ptr<IElementParser>> EntityConditionXmlParser::SubElementParser::CreateParserList()
        {
            ...
            result.push_back(std::make_shared<SubElementAngleConditionParser>(_messageLogger, _filename, _parserOptions));
            result.push_back(std::make_shared<SubElementRelativeAngleConditionParser>(_messageLogger, _filename, _parserOptions));
            return result;
        }
        ...
        EntityConditionXmlParser::SubElementAngleConditionParser::SubElementAngleConditionParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions)
        {
            _angleConditionXmlParser = std::make_shared<AngleConditionXmlParser>(messageLogger, filename, parserOptions);
        }

        void EntityConditionXmlParser::SubElementAngleConditionParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<BaseImpl> object)
        {
            auto angleCondition = std::make_shared<AngleConditionImpl>();
            auto typedObject = std::static_pointer_cast<EntityConditionImpl>(object);                    
            // Setting the parent
            angleCondition->SetParent(object);
            _angleConditionXmlParser->ParseElement(indexedElement, parserContext, angleCondition);

            typedObject->SetAngleCondition(angleCondition);
            
            
        }
        
        int EntityConditionXmlParser::SubElementAngleConditionParser::GetMinOccur() 
        {
            return 1;
        }

        int EntityConditionXmlParser::SubElementAngleConditionParser::GetMaxOccur() 
        {
            return 1;
        }

        bool EntityConditionXmlParser::SubElementAngleConditionParser::DoesMatch(std::string& elementName)
        {
            return
                elementName == OSC_CONSTANTS::ELEMENT__ANGLE_CONDITION ;
        }

        std::vector<std::string> EntityConditionXmlParser::SubElementAngleConditionParser::GetExpectedTagNames()
        {
            return {
                OSC_CONSTANTS::ELEMENT__ANGLE_CONDITION
                    };
        }
        EntityConditionXmlParser::SubElementRelativeAngleConditionParser::SubElementRelativeAngleConditionParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions)
        {
            _relativeAngleConditionXmlParser = std::make_shared<RelativeAngleConditionXmlParser>(messageLogger, filename, parserOptions);
        }

        void EntityConditionXmlParser::SubElementRelativeAngleConditionParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<BaseImpl> object)
        {
            auto relativeAngleCondition = std::make_shared<RelativeAngleConditionImpl>();
            auto typedObject = std::static_pointer_cast<EntityConditionImpl>(object);                    
            // Setting the parent
            relativeAngleCondition->SetParent(object);
            _relativeAngleConditionXmlParser->ParseElement(indexedElement, parserContext, relativeAngleCondition);

            typedObject->SetRelativeAngleCondition(relativeAngleCondition);
            
            
        }
        
        int EntityConditionXmlParser::SubElementRelativeAngleConditionParser::GetMinOccur() 
        {
            return 1;
        }

        int EntityConditionXmlParser::SubElementRelativeAngleConditionParser::GetMaxOccur() 
        {
            return 1;
        }

        bool EntityConditionXmlParser::SubElementRelativeAngleConditionParser::DoesMatch(std::string& elementName)
        {
            return
                elementName == OSC_CONSTANTS::ELEMENT__RELATIVE_ANGLE_CONDITION ;
        }

        std::vector<std::string> EntityConditionXmlParser::SubElementRelativeAngleConditionParser::GetExpectedTagNames()
        {
            return {
                OSC_CONSTANTS::ELEMENT__RELATIVE_ANGLE_CONDITION
                    };
        }
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
            EntityDistributionXmlParser::SubElementParser::SubElementParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions): XmlSequenceParser(messageLogger, filename, parserOptions) {}

        std::map<std::string, std::shared_ptr<IAttributeParser>> EntityDistributionXmlParser::GetAttributeNameToAttributeParserMap()
        {
            std::map<std::string, std::shared_ptr<IAttributeParser>> result;
        ...
        std::vector<std::shared_ptr<IElementParser>> EntityDistributionXmlParser::SubElementParser::CreateParserList()
        {
            std::vector<std::shared_ptr<IElementParser>> result;
            result.push_back(std::make_shared<SubElementEntityDistributionEntryParser>(_messageLogger, _filename, _parserOptions));
            return result;
        }

        EntityDistributionXmlParser::SubElementEntityDistributionEntryParser::SubElementEntityDistributionEntryParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions)
        {
            _entityDistributionEntryXmlParser = std::make_shared<EntityDistributionEntryXmlParser>(messageLogger, filename, parserOptions);
        }

        void EntityDistributionXmlParser::SubElementEntityDistributionEntryParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<BaseImpl> object)
        {
            auto entityDistributionEntry = std::make_shared<EntityDistributionEntryImpl>();
            auto typedObject = std::static_pointer_cast<EntityDistributionImpl>(object);                    
            // Setting the parent
            entityDistributionEntry->SetParent(object);
            _entityDistributionEntryXmlParser->ParseElement(indexedElement, parserContext, entityDistributionEntry);
            auto entityDistributionEntryList = typedObject->GetWriterEntityDistributionEntry();
            entityDistributionEntryList.push_back(entityDistributionEntry);
            typedObject->SetEntityDistributionEntry(entityDistributionEntryList);
            
            
        }
        
        int EntityDistributionXmlParser::SubElementEntityDistributionEntryParser::GetMinOccur() 
        {
            return 1;
        }

        int EntityDistributionXmlParser::SubElementEntityDistributionEntryParser::GetMaxOccur() 
        {
            return -1;
        }

        bool EntityDistributionXmlParser::SubElementEntityDistributionEntryParser::DoesMatch(std::string& elementName)
        {
            return
                elementName == OSC_CONSTANTS::ELEMENT__ENTITY_DISTRIBUTION_ENTRY ;
        }

        std::vector<std::string> EntityDistributionXmlParser::SubElementEntityDistributionEntryParser::GetExpectedTagNames()
        {
            return {
                OSC_CONSTANTS::ELEMENT__ENTITY_DISTRIBUTION_ENTRY
                    };
        }
  
        EntityDistributionXmlParser::EntityDistributionXmlParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions): 
        XmlComplexTypeParser(messageLogger, filename, parserOptions)
        {
            _subElementParser = std::make_shared<SubElementParser>(messageLogger, filename, parserOptions);
        }
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
            EntityDistributionEntryXmlParser::SubElementParser::SubElementParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions): XmlSequenceParser(messageLogger, filename, parserOptions) {}

        std::map<std::string, std::shared_ptr<IAttributeParser>> EntityDistributionEntryXmlParser::GetAttributeNameToAttributeParserMap()
        {
            std::map<std::string, std::shared_ptr<IAttributeParser>> result;
            ...
            public:
                ...
                void Parse(Position& startPosition, Position& endPosition, Position& startValuePosition, std::string& attributeName, std::string& attributeValue, std::shared_ptr<BaseImpl> object) override
                {
                    ...
                    Textmarker endMarker(endPosition.GetLine(), endPosition.GetColumn(), _filename);
                    Textmarker startValueMarker(startValuePosition.GetLine(), startValuePosition.GetColumn(), _filename);
					auto typedObject = std::static_pointer_cast<EntityDistributionEntryImpl>(object);
                    if (IsParametrized(attributeValue))
                    {
        ...
        std::vector<std::shared_ptr<IElementParser>> EntityDistributionEntryXmlParser::SubElementParser::CreateParserList()
        {
            std::vector<std::shared_ptr<IElementParser>> result;
            result.push_back(std::make_shared<SubElementScenarioObjectTemplateParser>(_messageLogger, _filename, _parserOptions));
            return result;
        }

        EntityDistributionEntryXmlParser::SubElementScenarioObjectTemplateParser::SubElementScenarioObjectTemplateParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions)
        {
            _scenarioObjectTemplateXmlParser = std::make_shared<ScenarioObjectTemplateXmlParser>(messageLogger, filename, parserOptions);
        }

        void EntityDistributionEntryXmlParser::SubElementScenarioObjectTemplateParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<BaseImpl> object)
        {
            auto scenarioObjectTemplate = std::make_shared<ScenarioObjectTemplateImpl>();
            auto typedObject = std::static_pointer_cast<EntityDistributionEntryImpl>(object);                    
            // Setting the parent
            scenarioObjectTemplate->SetParent(object);
            _scenarioObjectTemplateXmlParser->ParseElement(indexedElement, parserContext, scenarioObjectTemplate);

            typedObject->SetScenarioObjectTemplate(scenarioObjectTemplate);
            
            
        }
        
        int EntityDistributionEntryXmlParser::SubElementScenarioObjectTemplateParser::GetMinOccur() 
        {
            return 1;
        }

        int EntityDistributionEntryXmlParser::SubElementScenarioObjectTemplateParser::GetMaxOccur() 
        {
            return 1;
        }

        bool EntityDistributionEntryXmlParser::SubElementScenarioObjectTemplateParser::DoesMatch(std::string& elementName)
        {
            return
                elementName == OSC_CONSTANTS::ELEMENT__SCENARIO_OBJECT_TEMPLATE ;
        }

        std::vector<std::string> EntityDistributionEntryXmlParser::SubElementScenarioObjectTemplateParser::GetExpectedTagNames()
        {
            return {
                OSC_CONSTANTS::ELEMENT__SCENARIO_OBJECT_TEMPLATE
                    };
        }
  
        EntityDistributionEntryXmlParser::EntityDistributionEntryXmlParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions): 
        XmlComplexTypeParser(messageLogger, filename, parserOptions)
        {
            _subElementParser = std::make_shared<SubElementParser>(messageLogger, filename, parserOptions);
        }
        ...
        */
        ...
        std::map<std::string, std::shared_ptr<IAttributeParser>> GeoPositionXmlParser::GetAttributeNameToAttributeParserMap()
        {
            ...
            class AttributeVerticalRoadSelection: public IAttributeParser, public XmlParserBase
            {
            public:
                AttributeVerticalRoadSelection(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions):XmlParserBase(messageLogger, filename, parserOptions) {}
                ...
                void Parse(Position& startPosition, Position& endPosition, Position& startValuePosition, std::string& attributeName, std::string& attributeValue, std::shared_ptr<BaseImpl> object) override
                {
                    ...
                    if (IsParametrized(attributeValue))
                    {
                        typedObject->SetAttributeParameter(OSC_CONSTANTS::ATTRIBUTE__VERTICAL_ROAD_SELECTION, attributeValue, startValueMarker); 
                    }
					else if (IsExpression(attributeValue))
                    {
                    ...
                    else
                    {
                        ...
                        // Parse value
                        // Simple type
                        typedObject->SetVerticalRoadSelection(ParseInt(attributeValue, startMarker));
                    }
                    typedObject->PutPropertyStartMarker(OSC_CONSTANTS::ATTRIBUTE__VERTICAL_ROAD_SELECTION, std::make_shared<Textmarker>(startMarker));
                    typedObject->PutPropertyEndMarker(OSC_CONSTANTS::ATTRIBUTE__VERTICAL_ROAD_SELECTION, std::make_shared<Textmarker>(endMarker));
            ...
            result.emplace(std::make_pair(OSC_CONSTANTS::ATTRIBUTE__VERTICAL_ROAD_SELECTION, std::make_shared<AttributeVerticalRoadSelection>(_messageLogger, _filename, _parserOptions)));
            return result;
        }
        ...
        */
        ...
        std::vector<std::shared_ptr<IElementParser>> GlobalActionXmlParser::SubElementParser::CreateParserList()
        {
            ...
            result.push_back(std::make_shared<SubElementSetMonitorActionParser>(_messageLogger, _filename, _parserOptions));
        ...
        GlobalActionXmlParser::SubElementSetMonitorActionParser::SubElementSetMonitorActionParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions)
        {
            _setMonitorActionXmlParser = std::make_shared<SetMonitorActionXmlParser>(messageLogger, filename, parserOptions);
        }

        void GlobalActionXmlParser::SubElementSetMonitorActionParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<BaseImpl> object)
        {
            auto setMonitorAction = std::make_shared<SetMonitorActionImpl>();
            auto typedObject = std::static_pointer_cast<GlobalActionImpl>(object);                    
            // Setting the parent
            setMonitorAction->SetParent(object);
            _setMonitorActionXmlParser->ParseElement(indexedElement, parserContext, setMonitorAction);

            typedObject->SetSetMonitorAction(setMonitorAction);
            
            
        }
        
        int GlobalActionXmlParser::SubElementSetMonitorActionParser::GetMinOccur() 
        {
            return 1;
        }

        int GlobalActionXmlParser::SubElementSetMonitorActionParser::GetMaxOccur() 
        {
            return 1;
        }

        bool GlobalActionXmlParser::SubElementSetMonitorActionParser::DoesMatch(std::string& elementName)
        {
            return
                elementName == OSC_CONSTANTS::ELEMENT__SET_MONITOR_ACTION ;
        }

        std::vector<std::string> GlobalActionXmlParser::SubElementSetMonitorActionParser::GetExpectedTagNames()
        {
            return {
                OSC_CONSTANTS::ELEMENT__SET_MONITOR_ACTION
                    };
        }
        ...
        */
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
            LaneXmlParser::SubElementParser::SubElementParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions): XmlAllParser(messageLogger, filename, parserOptions) {}


        std::map<std::string, std::shared_ptr<IAttributeParser>> LaneXmlParser::GetAttributeNameToAttributeParserMap()
        {
            std::map<std::string, std::shared_ptr<IAttributeParser>> result;

            class AttributeId: public IAttributeParser, public XmlParserBase
            {
            public:
                AttributeId(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions):XmlParserBase(messageLogger, filename, parserOptions) {}
                ...
                void Parse(Position& startPosition, Position& endPosition, Position& startValuePosition, std::string& attributeName, std::string& attributeValue, std::shared_ptr<BaseImpl> object) override
                {
                    ...
                    Textmarker endMarker(endPosition.GetLine(), endPosition.GetColumn(), _filename);
                    Textmarker startValueMarker(startValuePosition.GetLine(), startValuePosition.GetColumn(), _filename);
					auto typedObject = std::static_pointer_cast<LaneImpl>(object);
                    if (IsParametrized(attributeValue))
                    {
                        typedObject->SetAttributeParameter(OSC_CONSTANTS::ATTRIBUTE__ID, attributeValue, startValueMarker); 
                    }
					else if (IsExpression(attributeValue))
                    {
                    	// Expressions allowed for datatype int
                    ...
                    else
                    {
                        ...
                        // Parse value
                        // Simple type
                        typedObject->SetId(ParseInt(attributeValue, startMarker));
                    }
                    typedObject->PutPropertyStartMarker(OSC_CONSTANTS::ATTRIBUTE__ID, std::make_shared<Textmarker>(startMarker));
                    typedObject->PutPropertyEndMarker(OSC_CONSTANTS::ATTRIBUTE__ID, std::make_shared<Textmarker>(endMarker));
            ...
            result.emplace(std::make_pair(OSC_CONSTANTS::ATTRIBUTE__ID, std::make_shared<AttributeId>(_messageLogger, _filename, _parserOptions)));
            return result;
        }

        std::vector<std::shared_ptr<IElementParser>> LaneXmlParser::SubElementParser::CreateParserList()
        {
            std::vector<std::shared_ptr<IElementParser>> result;
            return result;
        }
        ...
        LaneXmlParser::LaneXmlParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions): 
        XmlComplexTypeParser(messageLogger, filename, parserOptions)
        {
            _subElementParser = std::make_shared<SubElementParser>(messageLogger, filename, parserOptions);
        }
        ...
        */
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
            LightTypeXmlParser::SubElementParser::SubElementParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions): XmlChoiceParser(messageLogger, filename, parserOptions) {}
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
            LogNormalDistributionXmlParser::SubElementParser::SubElementParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions): XmlSequenceParser(messageLogger, filename, parserOptions) {}

        std::map<std::string, std::shared_ptr<IAttributeParser>> LogNormalDistributionXmlParser::GetAttributeNameToAttributeParserMap()
        {
            std::map<std::string, std::shared_ptr<IAttributeParser>> result;
            ...
            public:
                ...
                void Parse(Position& startPosition, Position& endPosition, Position& startValuePosition, std::string& attributeName, std::string& attributeValue, std::shared_ptr<BaseImpl> object) override
                {
                    ...
                    Textmarker endMarker(endPosition.GetLine(), endPosition.GetColumn(), _filename);
                    Textmarker startValueMarker(startValuePosition.GetLine(), startValuePosition.GetColumn(), _filename);
					auto typedObject = std::static_pointer_cast<LogNormalDistributionImpl>(object);
                    if (IsParametrized(attributeValue))
                    {
        ...
        std::vector<std::shared_ptr<IElementParser>> LogNormalDistributionXmlParser::SubElementParser::CreateParserList()
        {
            std::vector<std::shared_ptr<IElementParser>> result;
            result.push_back(std::make_shared<SubElementRangeParser>(_messageLogger, _filename, _parserOptions));
            return result;
        ...
        LogNormalDistributionXmlParser::SubElementRangeParser::SubElementRangeParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions)
        {
            _rangeXmlParser = std::make_shared<RangeXmlParser>(messageLogger, filename, parserOptions);
        }

        void LogNormalDistributionXmlParser::SubElementRangeParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<BaseImpl> object)
        {
            auto range = std::make_shared<RangeImpl>();
            auto typedObject = std::static_pointer_cast<LogNormalDistributionImpl>(object);                    
            // Setting the parent
        ...
        int LogNormalDistributionXmlParser::SubElementRangeParser::GetMinOccur() 
        {
            return 0;
        }

        int LogNormalDistributionXmlParser::SubElementRangeParser::GetMaxOccur() 
        {
            return 1;
        }

        bool LogNormalDistributionXmlParser::SubElementRangeParser::DoesMatch(std::string& elementName)
        {
            return
                elementName == OSC_CONSTANTS::ELEMENT__RANGE ;
        }

        std::vector<std::string> LogNormalDistributionXmlParser::SubElementRangeParser::GetExpectedTagNames()
        {
            return {
                OSC_CONSTANTS::ELEMENT__RANGE
                    };
        ...
        LogNormalDistributionXmlParser::LogNormalDistributionXmlParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions): 
        XmlComplexTypeParser(messageLogger, filename, parserOptions)
        {
            _subElementParser = std::make_shared<SubElementParser>(messageLogger, filename, parserOptions);
        }
        ...
        */
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
            MonitorDeclarationXmlParser::SubElementParser::SubElementParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions): XmlSequenceParser(messageLogger, filename, parserOptions) {}

        std::map<std::string, std::shared_ptr<IAttributeParser>> MonitorDeclarationXmlParser::GetAttributeNameToAttributeParserMap()
        {
            std::map<std::string, std::shared_ptr<IAttributeParser>> result;
            ...
            public:
                ...
                void Parse(Position& startPosition, Position& endPosition, Position& startValuePosition, std::string& attributeName, std::string& attributeValue, std::shared_ptr<BaseImpl> object) override
                {
                    ...
                    Textmarker endMarker(endPosition.GetLine(), endPosition.GetColumn(), _filename);
                    Textmarker startValueMarker(startValuePosition.GetLine(), startValuePosition.GetColumn(), _filename);
					auto typedObject = std::static_pointer_cast<MonitorDeclarationImpl>(object);
                    if (IsParametrized(attributeValue))
                    {
                        typedObject->SetAttributeParameter(OSC_CONSTANTS::ATTRIBUTE__NAME, attributeValue, startValueMarker); 
                    }
        ...
        std::vector<std::shared_ptr<IElementParser>> MonitorDeclarationXmlParser::SubElementParser::CreateParserList()
        {
            std::vector<std::shared_ptr<IElementParser>> result;
            return result;
        }
        ...
        MonitorDeclarationXmlParser::MonitorDeclarationXmlParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions): 
        XmlComplexTypeParser(messageLogger, filename, parserOptions)
        {
            _subElementParser = std::make_shared<SubElementParser>(messageLogger, filename, parserOptions);
        }
        ...
        */
        ...
        bool OpenScenarioXmlParser::SubElementOpenScenarioCategoryParser::DoesMatch(std::string& elementName)
        {
            return
                ...
                elementName == OSC_CONSTANTS::ELEMENT__MONITOR_DECLARATIONS || 
