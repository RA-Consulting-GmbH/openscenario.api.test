    ...
    namespace v1_3
    {
        ...
        */
        ...
        std::vector<std::shared_ptr<IElementParser>> PhaseXmlParser::SubElementParser::CreateParserList()
        {
            ...
            result.push_back(std::make_shared<SubElementTrafficSignalGroupStateParser>(_messageLogger, _filename, _parserOptions));
            return result;
        }
        ...
        PhaseXmlParser::SubElementTrafficSignalGroupStateParser::SubElementTrafficSignalGroupStateParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions)
        {
            _trafficSignalGroupStateXmlParser = std::make_shared<TrafficSignalGroupStateXmlParser>(messageLogger, filename, parserOptions);
        }

        void PhaseXmlParser::SubElementTrafficSignalGroupStateParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<BaseImpl> object)
        {
            auto trafficSignalGroupState = std::make_shared<TrafficSignalGroupStateImpl>();
            auto typedObject = std::static_pointer_cast<PhaseImpl>(object);                    
            // Setting the parent
            trafficSignalGroupState->SetParent(object);
            _trafficSignalGroupStateXmlParser->ParseElement(indexedElement, parserContext, trafficSignalGroupState);

            typedObject->SetTrafficSignalGroupState(trafficSignalGroupState);
            
            
        }
        
        int PhaseXmlParser::SubElementTrafficSignalGroupStateParser::GetMinOccur() 
        {
            return 0;
        }

        int PhaseXmlParser::SubElementTrafficSignalGroupStateParser::GetMaxOccur() 
        {
            return 1;
        }

        bool PhaseXmlParser::SubElementTrafficSignalGroupStateParser::DoesMatch(std::string& elementName)
        {
            return
                elementName == OSC_CONSTANTS::ELEMENT__TRAFFIC_SIGNAL_GROUP_STATE ;
        }

        std::vector<std::string> PhaseXmlParser::SubElementTrafficSignalGroupStateParser::GetExpectedTagNames()
        {
            return {
                OSC_CONSTANTS::ELEMENT__TRAFFIC_SIGNAL_GROUP_STATE
                    };
        }
        ...
        */
        ...
        /**
         * This is a automatic generated file according to the OpenSCENARIO specification version 1.3
         * Filling a PolygonImpl instance from an xml tree.
         * 
         * @author RA Consulting OpenSCENARIO generation facility
        */
            PolygonXmlParser::SubElementParser::SubElementParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions): XmlSequenceParser(messageLogger, filename, parserOptions) {}

        std::map<std::string, std::shared_ptr<IAttributeParser>> PolygonXmlParser::GetAttributeNameToAttributeParserMap()
        {
            std::map<std::string, std::shared_ptr<IAttributeParser>> result;
        ...
        std::vector<std::shared_ptr<IElementParser>> PolygonXmlParser::SubElementParser::CreateParserList()
        {
            std::vector<std::shared_ptr<IElementParser>> result;
        ...
        PolygonXmlParser::SubElementPositionsParser::SubElementPositionsParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions)
        {
            _positionXmlParser = std::make_shared<PositionXmlParser>(messageLogger, filename, parserOptions);
        }

        void PolygonXmlParser::SubElementPositionsParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<BaseImpl> object)
        {
            auto positions = std::make_shared<PositionImpl>();
            auto typedObject = std::static_pointer_cast<PolygonImpl>(object);                    
            // Setting the parent
        ...
        int PolygonXmlParser::SubElementPositionsParser::GetMinOccur() 
        {
            return 3;
        }

        int PolygonXmlParser::SubElementPositionsParser::GetMaxOccur() 
        {
            return -1;
        }

        bool PolygonXmlParser::SubElementPositionsParser::DoesMatch(std::string& elementName)
        {
            return
                elementName == OSC_CONSTANTS::ELEMENT__POSITION ;
        }

        std::vector<std::string> PolygonXmlParser::SubElementPositionsParser::GetExpectedTagNames()
        {
            return {
        ...
        PolygonXmlParser::PolygonXmlParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions): 
        XmlComplexTypeParser(messageLogger, filename, parserOptions)
        {
            _subElementParser = std::make_shared<SubElementParser>(messageLogger, filename, parserOptions);
        }
        ...
        */
        ...
        std::vector<std::shared_ptr<IElementParser>> PrivateActionXmlParser::SubElementParser::CreateParserList()
        {
            ...
            result.push_back(std::make_shared<SubElementTrailerActionParser>(_messageLogger, _filename, _parserOptions));
            return result;
        }
        ...
        PrivateActionXmlParser::SubElementTrailerActionParser::SubElementTrailerActionParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions)
        {
            _trailerActionXmlParser = std::make_shared<TrailerActionXmlParser>(messageLogger, filename, parserOptions);
        }

        void PrivateActionXmlParser::SubElementTrailerActionParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<BaseImpl> object)
        {
            auto trailerAction = std::make_shared<TrailerActionImpl>();
            auto typedObject = std::static_pointer_cast<PrivateActionImpl>(object);                    
            // Setting the parent
            trailerAction->SetParent(object);
            _trailerActionXmlParser->ParseElement(indexedElement, parserContext, trailerAction);

            typedObject->SetTrailerAction(trailerAction);
            
            
        }
        
        int PrivateActionXmlParser::SubElementTrailerActionParser::GetMinOccur() 
        {
            return 1;
        }

        int PrivateActionXmlParser::SubElementTrailerActionParser::GetMaxOccur() 
        {
            return 1;
        }

        bool PrivateActionXmlParser::SubElementTrailerActionParser::DoesMatch(std::string& elementName)
        {
            return
                elementName == OSC_CONSTANTS::ELEMENT__TRAILER_ACTION ;
        }

        std::vector<std::string> PrivateActionXmlParser::SubElementTrailerActionParser::GetExpectedTagNames()
        {
            return {
                OSC_CONSTANTS::ELEMENT__TRAILER_ACTION
                    };
        }
        ...
        */
        ...
        /**
         * This is a automatic generated file according to the OpenSCENARIO specification version 1.3
         * Filling a RandomRouteActionImpl instance from an xml tree.
         * 
         * @author RA Consulting OpenSCENARIO generation facility
        */
            RandomRouteActionXmlParser::SubElementParser::SubElementParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions): XmlSequenceParser(messageLogger, filename, parserOptions) {}

        std::map<std::string, std::shared_ptr<IAttributeParser>> RandomRouteActionXmlParser::GetAttributeNameToAttributeParserMap()
        {
            std::map<std::string, std::shared_ptr<IAttributeParser>> result;
        ...
        std::vector<std::shared_ptr<IElementParser>> RandomRouteActionXmlParser::SubElementParser::CreateParserList()
        {
            std::vector<std::shared_ptr<IElementParser>> result;
            return result;
        }
        ...
        RandomRouteActionXmlParser::RandomRouteActionXmlParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions): 
        XmlComplexTypeParser(messageLogger, filename, parserOptions)
        {
            _subElementParser = std::make_shared<SubElementParser>(messageLogger, filename, parserOptions);
        }
        ...
        */
        ...
        /**
         * This is a automatic generated file according to the OpenSCENARIO specification version 1.3
         * Filling a RelativeAngleConditionImpl instance from an xml tree.
         * 
         * @author RA Consulting OpenSCENARIO generation facility
        */
            RelativeAngleConditionXmlParser::SubElementParser::SubElementParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions): XmlSequenceParser(messageLogger, filename, parserOptions) {}

        std::map<std::string, std::shared_ptr<IAttributeParser>> RelativeAngleConditionXmlParser::GetAttributeNameToAttributeParserMap()
        {
            std::map<std::string, std::shared_ptr<IAttributeParser>> result;
            ...
            public:
                ...
                void Parse(Position& startPosition, Position& endPosition, Position& startValuePosition, std::string& attributeName, std::string& attributeValue, std::shared_ptr<BaseImpl> object) override
                {
                    ...
                    Textmarker endMarker(endPosition.GetLine(), endPosition.GetColumn(), _filename);
                    Textmarker startValueMarker(startValuePosition.GetLine(), startValuePosition.GetColumn(), _filename);
					auto typedObject = std::static_pointer_cast<RelativeAngleConditionImpl>(object);
                    if (IsParametrized(attributeValue))
                    {
        ...
        std::vector<std::shared_ptr<IElementParser>> RelativeAngleConditionXmlParser::SubElementParser::CreateParserList()
        {
            std::vector<std::shared_ptr<IElementParser>> result;
            return result;
        }
        ...
        RelativeAngleConditionXmlParser::RelativeAngleConditionXmlParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions): 
        XmlComplexTypeParser(messageLogger, filename, parserOptions)
        {
            _subElementParser = std::make_shared<SubElementParser>(messageLogger, filename, parserOptions);
        }
        ...
        */
        ...
        /**
         * This is a automatic generated file according to the OpenSCENARIO specification version 1.3
         * Filling a RoadCursorImpl instance from an xml tree.
         * 
         * @author RA Consulting OpenSCENARIO generation facility
        */
            RoadCursorXmlParser::SubElementParser::SubElementParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions): XmlSequenceParser(messageLogger, filename, parserOptions) {}

        std::map<std::string, std::shared_ptr<IAttributeParser>> RoadCursorXmlParser::GetAttributeNameToAttributeParserMap()
        {
            std::map<std::string, std::shared_ptr<IAttributeParser>> result;
            ...
            public:
                ...
                void Parse(Position& startPosition, Position& endPosition, Position& startValuePosition, std::string& attributeName, std::string& attributeValue, std::shared_ptr<BaseImpl> object) override
                {
                    ...
                    Textmarker endMarker(endPosition.GetLine(), endPosition.GetColumn(), _filename);
                    Textmarker startValueMarker(startValuePosition.GetLine(), startValuePosition.GetColumn(), _filename);
					auto typedObject = std::static_pointer_cast<RoadCursorImpl>(object);
                    if (IsParametrized(attributeValue))
                    {
        ...
        std::vector<std::shared_ptr<IElementParser>> RoadCursorXmlParser::SubElementParser::CreateParserList()
        {
            std::vector<std::shared_ptr<IElementParser>> result;
            result.push_back(std::make_shared<SubElementLaneParser>(_messageLogger, _filename, _parserOptions));
            return result;
        }

        RoadCursorXmlParser::SubElementLaneParser::SubElementLaneParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions)
        {
            _laneXmlParser = std::make_shared<LaneXmlParser>(messageLogger, filename, parserOptions);
        }

        void RoadCursorXmlParser::SubElementLaneParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<BaseImpl> object)
        {
            auto lane = std::make_shared<LaneImpl>();
            auto typedObject = std::static_pointer_cast<RoadCursorImpl>(object);                    
            // Setting the parent
            lane->SetParent(object);
            _laneXmlParser->ParseElement(indexedElement, parserContext, lane);
            auto laneList = typedObject->GetWriterLane();
            laneList.push_back(lane);
            typedObject->SetLane(laneList);
            
            
        }
        
        int RoadCursorXmlParser::SubElementLaneParser::GetMinOccur() 
        {
            return 0;
        }

        int RoadCursorXmlParser::SubElementLaneParser::GetMaxOccur() 
        {
            return -1;
        }

        bool RoadCursorXmlParser::SubElementLaneParser::DoesMatch(std::string& elementName)
        {
            return
                elementName == OSC_CONSTANTS::ELEMENT__LANE ;
        }

        std::vector<std::string> RoadCursorXmlParser::SubElementLaneParser::GetExpectedTagNames()
        {
            return {
                OSC_CONSTANTS::ELEMENT__LANE
                    };
        }
  
        RoadCursorXmlParser::RoadCursorXmlParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions): 
        XmlComplexTypeParser(messageLogger, filename, parserOptions)
        {
            _subElementParser = std::make_shared<SubElementParser>(messageLogger, filename, parserOptions);
        }
        ...
        */
        ...
        /**
         * This is a automatic generated file according to the OpenSCENARIO specification version 1.3
         * Filling a RoadRangeImpl instance from an xml tree.
         * 
         * @author RA Consulting OpenSCENARIO generation facility
        */
            RoadRangeXmlParser::SubElementParser::SubElementParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions): XmlSequenceParser(messageLogger, filename, parserOptions) {}

        std::map<std::string, std::shared_ptr<IAttributeParser>> RoadRangeXmlParser::GetAttributeNameToAttributeParserMap()
        {
            std::map<std::string, std::shared_ptr<IAttributeParser>> result;
            ...
            public:
                ...
                void Parse(Position& startPosition, Position& endPosition, Position& startValuePosition, std::string& attributeName, std::string& attributeValue, std::shared_ptr<BaseImpl> object) override
                {
                    ...
                    Textmarker endMarker(endPosition.GetLine(), endPosition.GetColumn(), _filename);
                    Textmarker startValueMarker(startValuePosition.GetLine(), startValuePosition.GetColumn(), _filename);
					auto typedObject = std::static_pointer_cast<RoadRangeImpl>(object);
                    if (IsParametrized(attributeValue))
                    {
        ...
        std::vector<std::shared_ptr<IElementParser>> RoadRangeXmlParser::SubElementParser::CreateParserList()
        {
            std::vector<std::shared_ptr<IElementParser>> result;
            result.push_back(std::make_shared<SubElementRoadCursorParser>(_messageLogger, _filename, _parserOptions));
            return result;
        }

        RoadRangeXmlParser::SubElementRoadCursorParser::SubElementRoadCursorParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions)
        {
            _roadCursorXmlParser = std::make_shared<RoadCursorXmlParser>(messageLogger, filename, parserOptions);
        }

        void RoadRangeXmlParser::SubElementRoadCursorParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<BaseImpl> object)
        {
            auto roadCursor = std::make_shared<RoadCursorImpl>();
            auto typedObject = std::static_pointer_cast<RoadRangeImpl>(object);                    
            // Setting the parent
            roadCursor->SetParent(object);
            _roadCursorXmlParser->ParseElement(indexedElement, parserContext, roadCursor);
            auto roadCursorList = typedObject->GetWriterRoadCursor();
            roadCursorList.push_back(roadCursor);
            typedObject->SetRoadCursor(roadCursorList);
            
            
        }
        
        int RoadRangeXmlParser::SubElementRoadCursorParser::GetMinOccur() 
        {
            return 2;
        }

        int RoadRangeXmlParser::SubElementRoadCursorParser::GetMaxOccur() 
        {
            return -1;
        }

        bool RoadRangeXmlParser::SubElementRoadCursorParser::DoesMatch(std::string& elementName)
        {
            return
                elementName == OSC_CONSTANTS::ELEMENT__ROAD_CURSOR ;
        }

        std::vector<std::string> RoadRangeXmlParser::SubElementRoadCursorParser::GetExpectedTagNames()
        {
            return {
                OSC_CONSTANTS::ELEMENT__ROAD_CURSOR
                    };
        }
  
        RoadRangeXmlParser::RoadRangeXmlParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions): 
        XmlComplexTypeParser(messageLogger, filename, parserOptions)
        {
            _subElementParser = std::make_shared<SubElementParser>(messageLogger, filename, parserOptions);
        }
        ...
        */
        ...
        std::vector<std::shared_ptr<IElementParser>> RoutingActionXmlParser::SubElementParser::CreateParserList()
        {
            ...
            result.push_back(std::make_shared<SubElementRandomRouteActionParser>(_messageLogger, _filename, _parserOptions));
            return result;
        }
        ...
        RoutingActionXmlParser::SubElementRandomRouteActionParser::SubElementRandomRouteActionParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions)
        {
            _randomRouteActionXmlParser = std::make_shared<RandomRouteActionXmlParser>(messageLogger, filename, parserOptions);
        }

        void RoutingActionXmlParser::SubElementRandomRouteActionParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<BaseImpl> object)
        {
            auto randomRouteAction = std::make_shared<RandomRouteActionImpl>();
            auto typedObject = std::static_pointer_cast<RoutingActionImpl>(object);                    
            // Setting the parent
            randomRouteAction->SetParent(object);
            _randomRouteActionXmlParser->ParseElement(indexedElement, parserContext, randomRouteAction);

            typedObject->SetRandomRouteAction(randomRouteAction);
            
            
        }
        
        int RoutingActionXmlParser::SubElementRandomRouteActionParser::GetMinOccur() 
        {
            return 1;
        }

        int RoutingActionXmlParser::SubElementRandomRouteActionParser::GetMaxOccur() 
        {
            return 1;
        }

        bool RoutingActionXmlParser::SubElementRandomRouteActionParser::DoesMatch(std::string& elementName)
        {
            return
                elementName == OSC_CONSTANTS::ELEMENT__RANDOM_ROUTE_ACTION ;
        }

        std::vector<std::string> RoutingActionXmlParser::SubElementRandomRouteActionParser::GetExpectedTagNames()
        {
            return {
                OSC_CONSTANTS::ELEMENT__RANDOM_ROUTE_ACTION
                    };
        }
        ...
        */
        ...
        std::vector<std::shared_ptr<IElementParser>> ScenarioDefinitionXmlParser::SubElementParser::CreateParserList()
        {
            ...
            result.push_back(std::make_shared<WrappedListParser>(_messageLogger, _filename, std::make_shared<SubElementMonitorDeclarationsParser>(_messageLogger, _filename, _parserOptions), OSC_CONSTANTS::ELEMENT__MONITOR_DECLARATIONS, _parserOptions) );
        ...
        ScenarioDefinitionXmlParser::SubElementMonitorDeclarationsParser::SubElementMonitorDeclarationsParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions)
        {
            _monitorDeclarationXmlParser = std::make_shared<MonitorDeclarationXmlParser>(messageLogger, filename, parserOptions);
        }

        void ScenarioDefinitionXmlParser::SubElementMonitorDeclarationsParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<BaseImpl> object)
        {
            auto monitorDeclarations = std::make_shared<MonitorDeclarationImpl>();
            auto typedObject = std::static_pointer_cast<ScenarioDefinitionImpl>(object);                    
            // Setting the parent
            monitorDeclarations->SetParent(object);
            _monitorDeclarationXmlParser->ParseElement(indexedElement, parserContext, monitorDeclarations);
            auto monitorDeclarationsList = typedObject->GetWriterMonitorDeclarations();
            monitorDeclarationsList.push_back(monitorDeclarations);
            typedObject->SetMonitorDeclarations(monitorDeclarationsList);
            
            
        }
        
        int ScenarioDefinitionXmlParser::SubElementMonitorDeclarationsParser::GetMinOccur() 
        {
            return 0;
        }

        int ScenarioDefinitionXmlParser::SubElementMonitorDeclarationsParser::GetMaxOccur() 
        {
            return -1;
        }

        bool ScenarioDefinitionXmlParser::SubElementMonitorDeclarationsParser::DoesMatch(std::string& elementName)
        {
            return elementName == OSC_CONSTANTS::ELEMENT__MONITOR_DECLARATION;
        }

        std::vector<std::string> ScenarioDefinitionXmlParser::SubElementMonitorDeclarationsParser::GetExpectedTagNames()
        {
            return {OSC_CONSTANTS::ELEMENT__MONITOR_DECLARATION};
        }
        ...
        */
        ...
        /**
         * This is a automatic generated file according to the OpenSCENARIO specification version 1.3
         * Filling a ScenarioObjectTemplateImpl instance from an xml tree.
         * 
         * @author RA Consulting OpenSCENARIO generation facility
        */
            ScenarioObjectTemplateXmlParser::SubElementParser::SubElementParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions): XmlSequenceParser(messageLogger, filename, parserOptions) {}

        std::map<std::string, std::shared_ptr<IAttributeParser>> ScenarioObjectTemplateXmlParser::GetAttributeNameToAttributeParserMap()
        {
            std::map<std::string, std::shared_ptr<IAttributeParser>> result;
        ...
        std::vector<std::shared_ptr<IElementParser>> ScenarioObjectTemplateXmlParser::SubElementParser::CreateParserList()
        {
            std::vector<std::shared_ptr<IElementParser>> result;
            result.push_back(std::make_shared<SubElementEntitiyObjectParser>(_messageLogger, _filename, _parserOptions));
            result.push_back(std::make_shared<SubElementObjectControllerParser>(_messageLogger, _filename, _parserOptions));
            return result;
        }

        ScenarioObjectTemplateXmlParser::SubElementEntitiyObjectParser::SubElementEntitiyObjectParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions)
        {
            _entityObjectXmlParser = std::make_shared<EntityObjectXmlParser>(messageLogger, filename, parserOptions);
        }

        void ScenarioObjectTemplateXmlParser::SubElementEntitiyObjectParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<BaseImpl> object)
        {
            auto entitiyObject = std::make_shared<EntityObjectImpl>();
            auto typedObject = std::static_pointer_cast<ScenarioObjectTemplateImpl>(object);                    
            // Setting the parent
            entitiyObject->SetParent(object);
            _entityObjectXmlParser->ParseElement(indexedElement, parserContext, entitiyObject);

            typedObject->SetEntitiyObject(entitiyObject);
            
            
        }
        
        int ScenarioObjectTemplateXmlParser::SubElementEntitiyObjectParser::GetMinOccur() 
        {
            return 1;
        }

        int ScenarioObjectTemplateXmlParser::SubElementEntitiyObjectParser::GetMaxOccur() 
        {
            return 1;
        }

        bool ScenarioObjectTemplateXmlParser::SubElementEntitiyObjectParser::DoesMatch(std::string& elementName)
        {
            return
                elementName == OSC_CONSTANTS::ELEMENT__CATALOG_REFERENCE || 
                elementName == OSC_CONSTANTS::ELEMENT__VEHICLE || 
        ...
        std::vector<std::string> ScenarioObjectTemplateXmlParser::SubElementEntitiyObjectParser::GetExpectedTagNames()
        {
            return {
                OSC_CONSTANTS::ELEMENT__CATALOG_REFERENCE,
                OSC_CONSTANTS::ELEMENT__VEHICLE,
        ...
        ScenarioObjectTemplateXmlParser::SubElementObjectControllerParser::SubElementObjectControllerParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions)
        {
            _objectControllerXmlParser = std::make_shared<ObjectControllerXmlParser>(messageLogger, filename, parserOptions);
        }

        void ScenarioObjectTemplateXmlParser::SubElementObjectControllerParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<BaseImpl> object)
        {
            auto objectController = std::make_shared<ObjectControllerImpl>();
            auto typedObject = std::static_pointer_cast<ScenarioObjectTemplateImpl>(object);                    
            // Setting the parent
        ...
        int ScenarioObjectTemplateXmlParser::SubElementObjectControllerParser::GetMinOccur() 
        {
            return 0;
        }

        int ScenarioObjectTemplateXmlParser::SubElementObjectControllerParser::GetMaxOccur() 
        {
            return -1;
        }

        bool ScenarioObjectTemplateXmlParser::SubElementObjectControllerParser::DoesMatch(std::string& elementName)
        {
            return
                elementName == OSC_CONSTANTS::ELEMENT__OBJECT_CONTROLLER ;
        }

        std::vector<std::string> ScenarioObjectTemplateXmlParser::SubElementObjectControllerParser::GetExpectedTagNames()
        {
            return {
                OSC_CONSTANTS::ELEMENT__OBJECT_CONTROLLER
                    };
        ...
        ScenarioObjectTemplateXmlParser::ScenarioObjectTemplateXmlParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions): 
        XmlComplexTypeParser(messageLogger, filename, parserOptions)
        {
            _subElementParser = std::make_shared<SubElementParser>(messageLogger, filename, parserOptions);
        }
        ...
        */
        ...
        /**
         * This is a automatic generated file according to the OpenSCENARIO specification version 1.3
         * Filling a SetMonitorActionImpl instance from an xml tree.
         * 
         * @author RA Consulting OpenSCENARIO generation facility
        */
            SetMonitorActionXmlParser::SubElementParser::SubElementParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions): XmlSequenceParser(messageLogger, filename, parserOptions) {}

        std::map<std::string, std::shared_ptr<IAttributeParser>> SetMonitorActionXmlParser::GetAttributeNameToAttributeParserMap()
        {
            std::map<std::string, std::shared_ptr<IAttributeParser>> result;

            class AttributeMonitorRef: public IAttributeParser, public XmlParserBase
            {
            public:
                AttributeMonitorRef(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions):XmlParserBase(messageLogger, filename, parserOptions) {}
                ...
                void Parse(Position& startPosition, Position& endPosition, Position& startValuePosition, std::string& attributeName, std::string& attributeValue, std::shared_ptr<BaseImpl> object) override
                {
                    ...
                    Textmarker endMarker(endPosition.GetLine(), endPosition.GetColumn(), _filename);
                    Textmarker startValueMarker(startValuePosition.GetLine(), startValuePosition.GetColumn(), _filename);
					auto typedObject = std::static_pointer_cast<SetMonitorActionImpl>(object);
                    if (IsParametrized(attributeValue))
                    {
                        typedObject->SetAttributeParameter(OSC_CONSTANTS::ATTRIBUTE__MONITOR_REF, attributeValue, startValueMarker); 
                    }
                    else
                    {
                        ...
                        // Parse value
                        // Proxy
                        auto proxy = std::make_shared<NamedReferenceProxy<IMonitorDeclaration>>(attributeValue);
                        proxy->SetParent(typedObject);
                        typedObject->SetMonitorRef(proxy);
                    }
                    typedObject->PutPropertyStartMarker(OSC_CONSTANTS::ATTRIBUTE__MONITOR_REF, std::make_shared<Textmarker>(startMarker));
                    typedObject->PutPropertyEndMarker(OSC_CONSTANTS::ATTRIBUTE__MONITOR_REF, std::make_shared<Textmarker>(endMarker));
            ...
            result.emplace(std::make_pair(OSC_CONSTANTS::ATTRIBUTE__MONITOR_REF, std::make_shared<AttributeMonitorRef>(_messageLogger, _filename, _parserOptions)));
            class AttributeValue: public IAttributeParser, public XmlParserBase
            {
            public:
                AttributeValue(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions):XmlParserBase(messageLogger, filename, parserOptions) {}
                ...
                void Parse(Position& startPosition, Position& endPosition, Position& startValuePosition, std::string& attributeName, std::string& attributeValue, std::shared_ptr<BaseImpl> object) override
                {
                    ...
                    else
                    {
                        ...
                        // Parse value
                        // Simple type
                        typedObject->SetValue(ParseBoolean(attributeValue, startMarker));
                    }
                    typedObject->PutPropertyStartMarker(OSC_CONSTANTS::ATTRIBUTE__VALUE, std::make_shared<Textmarker>(startMarker));
                    typedObject->PutPropertyEndMarker(OSC_CONSTANTS::ATTRIBUTE__VALUE, std::make_shared<Textmarker>(endMarker));
        ...
        std::vector<std::shared_ptr<IElementParser>> SetMonitorActionXmlParser::SubElementParser::CreateParserList()
        {
            std::vector<std::shared_ptr<IElementParser>> result;
            return result;
        }
        ...
        SetMonitorActionXmlParser::SetMonitorActionXmlParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions): 
        XmlComplexTypeParser(messageLogger, filename, parserOptions)
        {
            _subElementParser = std::make_shared<SubElementParser>(messageLogger, filename, parserOptions);
        }
        ...
        */
        ...
        std::vector<std::shared_ptr<IElementParser>> ShapeXmlParser::SubElementParser::CreateParserList()
        {
            ...
            result.push_back(std::make_shared<SubElementClothoidSplineParser>(_messageLogger, _filename, _parserOptions));
        ...
        ShapeXmlParser::SubElementClothoidSplineParser::SubElementClothoidSplineParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions)
        {
            _clothoidSplineXmlParser = std::make_shared<ClothoidSplineXmlParser>(messageLogger, filename, parserOptions);
        }

        void ShapeXmlParser::SubElementClothoidSplineParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<BaseImpl> object)
        {
            auto clothoidSpline = std::make_shared<ClothoidSplineImpl>();
            auto typedObject = std::static_pointer_cast<ShapeImpl>(object);                    
            // Setting the parent
            clothoidSpline->SetParent(object);
            _clothoidSplineXmlParser->ParseElement(indexedElement, parserContext, clothoidSpline);

            typedObject->SetClothoidSpline(clothoidSpline);
            
            
        }
        
        int ShapeXmlParser::SubElementClothoidSplineParser::GetMinOccur() 
        {
            return 1;
        }

        int ShapeXmlParser::SubElementClothoidSplineParser::GetMaxOccur() 
        {
            return 1;
        }

        bool ShapeXmlParser::SubElementClothoidSplineParser::DoesMatch(std::string& elementName)
        {
            return
                elementName == OSC_CONSTANTS::ELEMENT__CLOTHOID_SPLINE ;
        }

        std::vector<std::string> ShapeXmlParser::SubElementClothoidSplineParser::GetExpectedTagNames()
        {
            return {
                OSC_CONSTANTS::ELEMENT__CLOTHOID_SPLINE
                    };
        }
        ...
        */
        ...
        bool StochasticDistributionXmlParser::SubElementStochasticDistributionTypeParser::DoesMatch(std::string& elementName)
        {
            return
                ...
                elementName == OSC_CONSTANTS::ELEMENT__LOG_NORMAL_DISTRIBUTION || 
        ...
        std::vector<std::string> StochasticDistributionXmlParser::SubElementStochasticDistributionTypeParser::GetExpectedTagNames()
        {
            return {
                ...
                OSC_CONSTANTS::ELEMENT__LOG_NORMAL_DISTRIBUTION,
        ...
        */
        ...
        std::vector<std::shared_ptr<IElementParser>> StochasticDistributionTypeXmlParser::SubElementParser::CreateParserList()
        {
            ...
            result.push_back(std::make_shared<SubElementLogNormalDistributionParser>(_messageLogger, _filename, _parserOptions));
        ...
        StochasticDistributionTypeXmlParser::SubElementLogNormalDistributionParser::SubElementLogNormalDistributionParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions)
        {
            _logNormalDistributionXmlParser = std::make_shared<LogNormalDistributionXmlParser>(messageLogger, filename, parserOptions);
        }

        void StochasticDistributionTypeXmlParser::SubElementLogNormalDistributionParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<BaseImpl> object)
        {
            auto logNormalDistribution = std::make_shared<LogNormalDistributionImpl>();
            auto typedObject = std::static_pointer_cast<StochasticDistributionTypeImpl>(object);                    
            // Setting the parent
            logNormalDistribution->SetParent(object);
            _logNormalDistributionXmlParser->ParseElement(indexedElement, parserContext, logNormalDistribution);

            typedObject->SetLogNormalDistribution(logNormalDistribution);
            
            
        }
        
        int StochasticDistributionTypeXmlParser::SubElementLogNormalDistributionParser::GetMinOccur() 
        {
            return 1;
        }

        int StochasticDistributionTypeXmlParser::SubElementLogNormalDistributionParser::GetMaxOccur() 
        {
            return 1;
        }

        bool StochasticDistributionTypeXmlParser::SubElementLogNormalDistributionParser::DoesMatch(std::string& elementName)
        {
            return
                elementName == OSC_CONSTANTS::ELEMENT__LOG_NORMAL_DISTRIBUTION ;
        }

        std::vector<std::string> StochasticDistributionTypeXmlParser::SubElementLogNormalDistributionParser::GetExpectedTagNames()
        {
            return {
                OSC_CONSTANTS::ELEMENT__LOG_NORMAL_DISTRIBUTION
                    };
