...
namespace NET_ASAM_OPENSCENARIO
{
    namespace v1_3
    {
        ...
        */
        ...
        /**
         * This is a automatic generated file according to the OpenSCENARIO specification version 1.3
         * A union checker rule class for the type IAnimationType according to OpenSCENARIO standard
         * all xor elements are checked
         * 
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class AnimationTypeUnionCheckerRule: public UnionCheckerRule
        {
        private:
            std::vector<std::string> GetNotNullChildren(std::shared_ptr<IAnimationType> object);

            std::vector<std::string> GetAllChildren();

        public:
            AnimationTypeUnionCheckerRule();
        ...
        /**
         * This is a automatic generated file according to the OpenSCENARIO specification version 1.3
         * A union checker rule class for the type IAppearanceAction according to OpenSCENARIO standard
         * all xor elements are checked
         * 
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class AppearanceActionUnionCheckerRule: public UnionCheckerRule
        {
        private:
            std::vector<std::string> GetNotNullChildren(std::shared_ptr<IAppearanceAction> object);

            std::vector<std::string> GetAllChildren();

        public:
            AppearanceActionUnionCheckerRule();
        ...
        */
        ...
        /**
         * This is a automatic generated file according to the OpenSCENARIO specification version 1.3
         * A union checker rule class for the type IBrakeInput according to OpenSCENARIO standard
         * all xor elements are checked
         * 
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class BrakeInputUnionCheckerRule: public UnionCheckerRule
        {
        private:
            std::vector<std::string> GetNotNullChildren(std::shared_ptr<IBrakeInput> object);
        ...
        */
        ...
        /**
         * This is a automatic generated file according to the OpenSCENARIO specification version 1.3
         * A union checker rule class for the type IColor according to OpenSCENARIO standard
         * all xor elements are checked
         * 
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class ColorUnionCheckerRule: public UnionCheckerRule
        {
        private:
            std::vector<std::string> GetNotNullChildren(std::shared_ptr<IColor> object);
        ...
        /**
         * This is a automatic generated file according to the OpenSCENARIO specification version 1.3
         * A union checker rule class for the type IComponentAnimation according to OpenSCENARIO standard
         * all xor elements are checked
         * 
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class ComponentAnimationUnionCheckerRule: public UnionCheckerRule
        {
        private:
            std::vector<std::string> GetNotNullChildren(std::shared_ptr<IComponentAnimation> object);
        ...
        */
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class DeterministicParameterDistributionUnionCheckerRule: public UnionCheckerRule
        {
        private:
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class DeterministicSingleParameterDistributionTypeUnionCheckerRule: public UnionCheckerRule
        {
        private:
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class DistributionDefinitionUnionCheckerRule: public UnionCheckerRule
        {
        private:
        ...
        */
        ...
        /**
         * This is a automatic generated file according to the OpenSCENARIO specification version 1.3
         * A union checker rule class for the type IGear according to OpenSCENARIO standard
         * all xor elements are checked
         * 
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class GearUnionCheckerRule: public UnionCheckerRule
        {
        private:
            std::vector<std::string> GetNotNullChildren(std::shared_ptr<IGear> object);

            std::vector<std::string> GetAllChildren();

        public:
            GearUnionCheckerRule();
        ...
        */
        ...
        /**
         * This is a automatic generated file according to the OpenSCENARIO specification version 1.3
         * A union checker rule class for the type ILightType according to OpenSCENARIO standard
         * all xor elements are checked
         * 
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class LightTypeUnionCheckerRule: public UnionCheckerRule
        {
        private:
            std::vector<std::string> GetNotNullChildren(std::shared_ptr<ILightType> object);

            std::vector<std::string> GetAllChildren();

        public:
            LightTypeUnionCheckerRule();
        ...
        */
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class SteadyStateUnionCheckerRule: public UnionCheckerRule
        {
        private:
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class StochasticDistributionTypeUnionCheckerRule: public UnionCheckerRule
        {
        private:
        ...
        */
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class TrajectoryRefUnionCheckerRule: public UnionCheckerRule
        {
        private:
        ...
        /**
         * This is a automatic generated file according to the OpenSCENARIO specification version 1.3
         * A union checker rule class for the type IVariableAction according to OpenSCENARIO standard
         * all xor elements are checked
         * 
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class VariableActionUnionCheckerRule: public UnionCheckerRule
        {
        private:
            std::vector<std::string> GetNotNullChildren(std::shared_ptr<IVariableAction> object);

            std::vector<std::string> GetAllChildren();

        public:
            VariableActionUnionCheckerRule();
        ...
        /**
         * This is a automatic generated file according to the OpenSCENARIO specification version 1.3
         * A union checker rule class for the type IVariableModifyRule according to OpenSCENARIO standard
         * all xor elements are checked
         * 
         * @author RA Consulting OpenSCENARIO generation facility
        */
        class VariableModifyRuleUnionCheckerRule: public UnionCheckerRule
        {
        private:
            std::vector<std::string> GetNotNullChildren(std::shared_ptr<IVariableModifyRule> object);

            std::vector<std::string> GetAllChildren();

        public:
            VariableModifyRuleUnionCheckerRule();
