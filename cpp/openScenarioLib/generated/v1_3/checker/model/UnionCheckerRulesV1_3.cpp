...
namespace NET_ASAM_OPENSCENARIO
{
    namespace v1_3
    {
        ...
        std::vector<std::string> ActionUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__GLOBAL_ACTION);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__USER_DEFINED_ACTION);
        ...
        void ActionUnionCheckerRule::ApplyRuleInTreeContext(std::shared_ptr<ITreeMessageLogger> messageLogger, std::shared_ptr<IOpenScenarioModelElement> object)
        {
            ...
            if (propertyNamesNotNull.size() == 0)
            {
                ...
                auto msg = TreeContentMessage(GetTooFewMessage(propertyNamesNotNull), ERROR, std::make_shared<PropertyTreeContext>(typedObject, allChildren));
                messageLogger->LogMessage(msg);
            }
        }
        std::vector<std::string> AnimationTypeUnionCheckerRule::GetNotNullChildren(std::shared_ptr<IAnimationType> object)
        {
            std::vector<std::string> propertyNamesNotNull;
            if (object->GetComponentAnimation())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__COMPONENT_ANIMATION);
            }
            if (object->GetPedestrianAnimation())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__PEDESTRIAN_ANIMATION);
            }
            if (object->GetAnimationFile())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__ANIMATION_FILE);
            }
            if (object->GetUserDefinedAnimation())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__USER_DEFINED_ANIMATION);
            }
            return propertyNamesNotNull;
        }

        std::vector<std::string> AnimationTypeUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__COMPONENT_ANIMATION);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__PEDESTRIAN_ANIMATION);
        ...
        AnimationTypeUnionCheckerRule::AnimationTypeUnionCheckerRule() = default;

        void AnimationTypeUnionCheckerRule::ApplyRuleInFileContext(std::shared_ptr<IParserMessageLogger> messageLogger, std::shared_ptr<IOpenScenarioModelElement> object)
        {
        ...
        void AnimationTypeUnionCheckerRule::ApplyRuleInTreeContext(std::shared_ptr<ITreeMessageLogger> messageLogger, std::shared_ptr<IOpenScenarioModelElement> object)
        {
            auto typedObject = std::dynamic_pointer_cast<IAnimationType>(object);
            auto propertyNamesNotNull = GetNotNullChildren(typedObject);
            if (propertyNamesNotNull.size() > 1)
        ...
        std::vector<std::string> AppearanceActionUnionCheckerRule::GetNotNullChildren(std::shared_ptr<IAppearanceAction> object)
        {
            std::vector<std::string> propertyNamesNotNull;
            if (object->GetLightStateAction())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__LIGHT_STATE_ACTION);
            }
            if (object->GetAnimationAction())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__ANIMATION_ACTION);
            }
            return propertyNamesNotNull;
        }

        std::vector<std::string> AppearanceActionUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__LIGHT_STATE_ACTION);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__ANIMATION_ACTION);
        ...
        AppearanceActionUnionCheckerRule::AppearanceActionUnionCheckerRule() = default;

        void AppearanceActionUnionCheckerRule::ApplyRuleInFileContext(std::shared_ptr<IParserMessageLogger> messageLogger, std::shared_ptr<IOpenScenarioModelElement> object)
        {
        ...
        void AppearanceActionUnionCheckerRule::ApplyRuleInTreeContext(std::shared_ptr<ITreeMessageLogger> messageLogger, std::shared_ptr<IOpenScenarioModelElement> object)
        {
            auto typedObject = std::dynamic_pointer_cast<IAppearanceAction>(object);
            auto propertyNamesNotNull = GetNotNullChildren(typedObject);
            if (propertyNamesNotNull.size() > 1)
        ...
        std::vector<std::string> AssignControllerActionUnionCheckerRule::GetNotNullChildren(std::shared_ptr<IAssignControllerAction> object)
        {
            ...
            if (object->GetObjectController())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__OBJECT_CONTROLLER);
            }
            return propertyNamesNotNull;
        }
        ...
        std::vector<std::string> AssignRouteActionUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__ROUTE);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__CATALOG_REFERENCE);
        ...
        std::vector<std::string> BrakeInputUnionCheckerRule::GetNotNullChildren(std::shared_ptr<IBrakeInput> object)
        {
            std::vector<std::string> propertyNamesNotNull;
            if (object->GetBrakePercent())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__BRAKE_PERCENT);
            }
            if (object->GetBrakeForce())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__BRAKE_FORCE);
            }
            return propertyNamesNotNull;
        }

        std::vector<std::string> BrakeInputUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__BRAKE_PERCENT);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__BRAKE_FORCE);
        ...
        BrakeInputUnionCheckerRule::BrakeInputUnionCheckerRule() = default;

        void BrakeInputUnionCheckerRule::ApplyRuleInFileContext(std::shared_ptr<IParserMessageLogger> messageLogger, std::shared_ptr<IOpenScenarioModelElement> object)
        {
        ...
        void BrakeInputUnionCheckerRule::ApplyRuleInTreeContext(std::shared_ptr<ITreeMessageLogger> messageLogger, std::shared_ptr<IOpenScenarioModelElement> object)
        {
            auto typedObject = std::dynamic_pointer_cast<IBrakeInput>(object);
            auto propertyNamesNotNull = GetNotNullChildren(typedObject);
            if (propertyNamesNotNull.size() > 1)
        ...
        std::vector<std::string> ByValueConditionUnionCheckerRule::GetNotNullChildren(std::shared_ptr<IByValueCondition> object)
        {
            ...
            if (object->GetVariableCondition())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__VARIABLE_CONDITION);
            }
            return propertyNamesNotNull;
        }

        std::vector<std::string> ByValueConditionUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__PARAMETER_CONDITION);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__TIME_OF_DAY_CONDITION);
        ...
        std::vector<std::string> CollisionConditionUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__ENTITY_REF);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__BY_TYPE);
        ...
        std::vector<std::string> ColorUnionCheckerRule::GetNotNullChildren(std::shared_ptr<IColor> object)
        {
            std::vector<std::string> propertyNamesNotNull;
            if (object->GetColorRgb())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__COLOR_RGB);
            }
            if (object->GetColorCmyk())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__COLOR_CMYK);
            }
            return propertyNamesNotNull;
        }

        std::vector<std::string> ColorUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__COLOR_RGB);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__COLOR_CMYK);
        ...
        ColorUnionCheckerRule::ColorUnionCheckerRule() = default;

        void ColorUnionCheckerRule::ApplyRuleInFileContext(std::shared_ptr<IParserMessageLogger> messageLogger, std::shared_ptr<IOpenScenarioModelElement> object)
        {
        ...
        void ColorUnionCheckerRule::ApplyRuleInTreeContext(std::shared_ptr<ITreeMessageLogger> messageLogger, std::shared_ptr<IOpenScenarioModelElement> object)
        {
            auto typedObject = std::dynamic_pointer_cast<IColor>(object);
            auto propertyNamesNotNull = GetNotNullChildren(typedObject);
            if (propertyNamesNotNull.size() > 1)
        ...
        std::vector<std::string> ComponentAnimationUnionCheckerRule::GetNotNullChildren(std::shared_ptr<IComponentAnimation> object)
        {
            std::vector<std::string> propertyNamesNotNull;
            if (object->GetVehicleComponent())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__VEHICLE_COMPONENT);
            }
            if (object->GetUserDefinedComponent())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__USER_DEFINED_COMPONENT);
            }
            return propertyNamesNotNull;
        }

        std::vector<std::string> ComponentAnimationUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__VEHICLE_COMPONENT);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__USER_DEFINED_COMPONENT);
        ...
        ComponentAnimationUnionCheckerRule::ComponentAnimationUnionCheckerRule() = default;

        void ComponentAnimationUnionCheckerRule::ApplyRuleInFileContext(std::shared_ptr<IParserMessageLogger> messageLogger, std::shared_ptr<IOpenScenarioModelElement> object)
        {
        ...
        void ComponentAnimationUnionCheckerRule::ApplyRuleInTreeContext(std::shared_ptr<ITreeMessageLogger> messageLogger, std::shared_ptr<IOpenScenarioModelElement> object)
        {
            auto typedObject = std::dynamic_pointer_cast<IComponentAnimation>(object);
            auto propertyNamesNotNull = GetNotNullChildren(typedObject);
            if (propertyNamesNotNull.size() > 1)
        ...
        std::vector<std::string> ConditionUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__BY_ENTITY_CONDITION);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__BY_VALUE_CONDITION);
        ...
        std::vector<std::string> ControllerDistributionEntryUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__CONTROLLER);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__CATALOG_REFERENCE);
        ...
        std::vector<std::string> EntityActionUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__ADD_ENTITY_ACTION);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__DELETE_ENTITY_ACTION);
        ...
        std::vector<std::string> EntityConditionUnionCheckerRule::GetNotNullChildren(std::shared_ptr<IEntityCondition> object)
        {
            ...
            if (object->GetRelativeClearanceCondition())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__RELATIVE_CLEARANCE_CONDITION);
            }
            if (object->GetAngleCondition())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__ANGLE_CONDITION);
            }
            if (object->GetRelativeAngleCondition())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__RELATIVE_ANGLE_CONDITION);
            }
            return propertyNamesNotNull;
        }

        std::vector<std::string> EntityConditionUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__END_OF_ROAD_CONDITION);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__COLLISION_CONDITION);
        ...
        std::vector<std::string> EntityObjectUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__CATALOG_REFERENCE);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__VEHICLE);
        ...
        std::vector<std::string> EnvironmentActionUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__ENVIRONMENT);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__CATALOG_REFERENCE);
        ...
        std::vector<std::string> FinalSpeedUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__ABSOLUTE_SPEED);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__RELATIVE_SPEED_TO_MASTER);
        ...
        std::vector<std::string> GearUnionCheckerRule::GetNotNullChildren(std::shared_ptr<IGear> object)
        {
            std::vector<std::string> propertyNamesNotNull;
            if (object->GetManualGear())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__MANUAL_GEAR);
            }
            if (object->GetAutomaticGear())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__AUTOMATIC_GEAR);
            }
            return propertyNamesNotNull;
        }

        std::vector<std::string> GearUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__MANUAL_GEAR);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__AUTOMATIC_GEAR);
        ...
        void GearUnionCheckerRule::ApplyRuleInFileContext(std::shared_ptr<IParserMessageLogger> messageLogger, std::shared_ptr<IOpenScenarioModelElement> object)
        {
        ...
        void GearUnionCheckerRule::ApplyRuleInTreeContext(std::shared_ptr<ITreeMessageLogger> messageLogger, std::shared_ptr<IOpenScenarioModelElement> object)
        {
            auto typedObject = std::dynamic_pointer_cast<IGear>(object);
            auto propertyNamesNotNull = GetNotNullChildren(typedObject);
            if (propertyNamesNotNull.size() > 1)
        ...
        std::vector<std::string> GlobalActionUnionCheckerRule::GetNotNullChildren(std::shared_ptr<IGlobalAction> object)
        {
            ...
            if (object->GetSetMonitorAction())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__SET_MONITOR_ACTION);
            }
            ...
            if (object->GetVariableAction())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__VARIABLE_ACTION);
            }
            return propertyNamesNotNull;
        }

        std::vector<std::string> GlobalActionUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__ENVIRONMENT_ACTION);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__ENTITY_ACTION);
        ...
        std::vector<std::string> InRoutePositionUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__FROM_CURRENT_ENTITY);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__FROM_ROAD_COORDINATES);
        ...
        std::vector<std::string> LaneChangeTargetUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__RELATIVE_TARGET_LANE);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__ABSOLUTE_TARGET_LANE);
        ...
        std::vector<std::string> LaneOffsetTargetUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__RELATIVE_TARGET_LANE_OFFSET);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__ABSOLUTE_TARGET_LANE_OFFSET);
        ...
        std::vector<std::string> LateralActionUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__LANE_CHANGE_ACTION);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__LANE_OFFSET_ACTION);
        ...
        std::vector<std::string> LightTypeUnionCheckerRule::GetNotNullChildren(std::shared_ptr<ILightType> object)
        {
            std::vector<std::string> propertyNamesNotNull;
            if (object->GetVehicleLight())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__VEHICLE_LIGHT);
            }
            if (object->GetUserDefinedLight())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__USER_DEFINED_LIGHT);
            }
            return propertyNamesNotNull;
        }

        std::vector<std::string> LightTypeUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__VEHICLE_LIGHT);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__USER_DEFINED_LIGHT);
        ...
        LightTypeUnionCheckerRule::LightTypeUnionCheckerRule() = default;

        void LightTypeUnionCheckerRule::ApplyRuleInFileContext(std::shared_ptr<IParserMessageLogger> messageLogger, std::shared_ptr<IOpenScenarioModelElement> object)
        {
        ...
        void LightTypeUnionCheckerRule::ApplyRuleInTreeContext(std::shared_ptr<ITreeMessageLogger> messageLogger, std::shared_ptr<IOpenScenarioModelElement> object)
        {
            auto typedObject = std::dynamic_pointer_cast<ILightType>(object);
            auto propertyNamesNotNull = GetNotNullChildren(typedObject);
            if (propertyNamesNotNull.size() > 1)
        ...
        std::vector<std::string> LongitudinalActionUnionCheckerRule::GetNotNullChildren(std::shared_ptr<ILongitudinalAction> object)
        {
            ...
            if (object->GetSpeedProfileAction())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__SPEED_PROFILE_ACTION);
            }
            return propertyNamesNotNull;
        }

        std::vector<std::string> LongitudinalActionUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__SPEED_ACTION);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__LONGITUDINAL_DISTANCE_ACTION);
        ...
        std::vector<std::string> ModifyRuleUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__ADD_VALUE);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__MULTIPLY_BY_VALUE);
        ...
        std::vector<std::string> ObjectControllerUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__CATALOG_REFERENCE);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__CONTROLLER);
        ...
        std::vector<std::string> ParameterActionUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__SET_ACTION);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__MODIFY_ACTION);
        ...
        std::vector<std::string> PositionUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__WORLD_POSITION);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__RELATIVE_WORLD_POSITION);
        ...
        std::vector<std::string> PrivateActionUnionCheckerRule::GetNotNullChildren(std::shared_ptr<IPrivateAction> object)
        {
            ...
            if (object->GetAppearanceAction())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__APPEARANCE_ACTION);
            }
            if (object->GetTrailerAction())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__TRAILER_ACTION);
            }
            return propertyNamesNotNull;
        }

        std::vector<std::string> PrivateActionUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__LONGITUDINAL_ACTION);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__LATERAL_ACTION);
        ...
        std::vector<std::string> RouteRefUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__ROUTE);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__CATALOG_REFERENCE);
        ...
        std::vector<std::string> RoutingActionUnionCheckerRule::GetNotNullChildren(std::shared_ptr<IRoutingAction> object)
        {
            ...
            if (object->GetRandomRouteAction())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__RANDOM_ROUTE_ACTION);
            }
            return propertyNamesNotNull;
        }

        std::vector<std::string> RoutingActionUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__ASSIGN_ROUTE_ACTION);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__FOLLOW_TRAJECTORY_ACTION);
        ...
        std::vector<std::string> SelectedEntitiesUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__ENTITY_REF);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__BY_TYPE);
        ...
        std::vector<std::string> ShapeUnionCheckerRule::GetNotNullChildren(std::shared_ptr<IShape> object)
        {
            ...
            if (object->GetClothoidSpline())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__CLOTHOID_SPLINE);
            }
            if (object->GetNurbs())
            {
        ...
        std::vector<std::string> ShapeUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__POLYLINE);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__CLOTHOID);
        ...
        std::vector<std::string> SpeedActionTargetUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__RELATIVE_TARGET_SPEED);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__ABSOLUTE_TARGET_SPEED);
        ...
        std::vector<std::string> StochasticDistributionTypeUnionCheckerRule::GetNotNullChildren(std::shared_ptr<IStochasticDistributionType> object)
        {
            ...
            if (object->GetLogNormalDistribution())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__LOG_NORMAL_DISTRIBUTION);
            }
        ...
        std::vector<std::string> TimeReferenceUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__NONE);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__TIMING);
        ...
        std::vector<std::string> TimeToCollisionConditionTargetUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__POSITION);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__ENTITY_REF);
        ...
        std::vector<std::string> TrafficActionUnionCheckerRule::GetNotNullChildren(std::shared_ptr<ITrafficAction> object)
        {
            ...
            if (object->GetTrafficAreaAction())
            {
                propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__TRAFFIC_AREA_ACTION);
            }
        ...
        std::vector<std::string> TrafficActionUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__TRAFFIC_SOURCE_ACTION);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__TRAFFIC_SINK_ACTION);
        ...
        std::vector<std::string> TrafficSignalActionUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__TRAFFIC_SIGNAL_CONTROLLER_ACTION);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__TRAFFIC_SIGNAL_STATE_ACTION);
        ...
        std::vector<std::string> VariableActionUnionCheckerRule::GetNotNullChildren(std::shared_ptr<IVariableAction> object)
        {
            std::vector<std::string> propertyNamesNotNull;
            if (object->GetSetAction())
            {
        ...
        std::vector<std::string> VariableActionUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__SET_ACTION);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__MODIFY_ACTION);
        ...
        VariableActionUnionCheckerRule::VariableActionUnionCheckerRule() = default;

        void VariableActionUnionCheckerRule::ApplyRuleInFileContext(std::shared_ptr<IParserMessageLogger> messageLogger, std::shared_ptr<IOpenScenarioModelElement> object)
        {
        ...
        void VariableActionUnionCheckerRule::ApplyRuleInTreeContext(std::shared_ptr<ITreeMessageLogger> messageLogger, std::shared_ptr<IOpenScenarioModelElement> object)
        {
            auto typedObject = std::dynamic_pointer_cast<IVariableAction>(object);
            auto propertyNamesNotNull = GetNotNullChildren(typedObject);
            if (propertyNamesNotNull.size() > 1)
        ...
        std::vector<std::string> VariableModifyRuleUnionCheckerRule::GetNotNullChildren(std::shared_ptr<IVariableModifyRule> object)
        {
            std::vector<std::string> propertyNamesNotNull;
            if (object->GetAddValue())
            {
        ...
        std::vector<std::string> VariableModifyRuleUnionCheckerRule::GetAllChildren()
        {
            std::vector<std::string> propertyNamesNotNull;
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__ADD_VALUE);
            propertyNamesNotNull.push_back(OSC_CONSTANTS::ELEMENT__MULTIPLY_BY_VALUE);
        ...
        VariableModifyRuleUnionCheckerRule::VariableModifyRuleUnionCheckerRule() = default;

        void VariableModifyRuleUnionCheckerRule::ApplyRuleInFileContext(std::shared_ptr<IParserMessageLogger> messageLogger, std::shared_ptr<IOpenScenarioModelElement> object)
        {
        ...
        void VariableModifyRuleUnionCheckerRule::ApplyRuleInTreeContext(std::shared_ptr<ITreeMessageLogger> messageLogger, std::shared_ptr<IOpenScenarioModelElement> object)
        {
            auto typedObject = std::dynamic_pointer_cast<IVariableModifyRule>(object);
            auto propertyNamesNotNull = GetNotNullChildren(typedObject);
            if (propertyNamesNotNull.size() > 1)
