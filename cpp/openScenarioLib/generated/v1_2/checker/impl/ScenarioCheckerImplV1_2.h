        ...
        */
        ...
        private:
   	        ...
   	        void ApplyPhaseCheckerRules(std::shared_ptr<IContentMessageLogger> messageLogger, const std::shared_ptr<IOpenScenarioModelElement> object, const ContextMode contextMode)
	        {
	            ...
	            const auto kTrafficeSignalGroupState = typedObject->GetTrafficeSignalGroupState();
	            if ( kTrafficeSignalGroupState)
	            {
	                ApplyTrafficSignalGroupStateCheckerRules(messageLogger, kTrafficeSignalGroupState, contextMode);
	            }
	        }
