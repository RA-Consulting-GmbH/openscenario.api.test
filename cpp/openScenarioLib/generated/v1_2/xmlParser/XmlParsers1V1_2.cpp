...
namespace NET_ASAM_OPENSCENARIO
{
    namespace v1_2
    {
        ...
        */
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
            AppearanceActionXmlParser::SubElementParser::SubElementParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions): XmlSequenceParser(messageLogger, filename, parserOptions) {}
        ...
        */
         ...
         * @author RA Consulting OpenSCENARIO generation facility
        */
            ComponentAnimationXmlParser::SubElementParser::SubElementParser(IParserMessageLogger& messageLogger, std::string& filename, ParserOptions& parserOptions): XmlSequenceParser(messageLogger, filename, parserOptions) {}
