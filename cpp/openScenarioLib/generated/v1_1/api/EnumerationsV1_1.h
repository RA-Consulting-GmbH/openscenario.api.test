...
Trajectory-based s,t coordinate system (s-axis is the trajectory-arc, which the entity follows).
        ...
        */
        ...
        public:
            ...
            CoordinateSystem(CoordinateSystemEnum& coordinateSystem)
            {
                _literal = kCoordinateSystemEnumString[coordinateSystem+1];
                _coordinateSystemEnum = GetFromLiteral(_literal);
            }

            CoordinateSystem(const CoordinateSystemEnum coordinateSystem)
            {
                _literal = kCoordinateSystemEnumString[coordinateSystem+1];
                _coordinateSystemEnum = GetFromLiteral(_literal);
            }
             ...
             * @param literal_ as defined in OpenSCENARIO
             */
            CoordinateSystem(std::string& literal_):_literal(literal_) 
            {
                _coordinateSystemEnum = GetFromLiteral(_literal);
            }
            ...
            CoordinateSystem& operator= (const CoordinateSystemEnum &rhs)
            {
            ...
            CoordinateSystem& operator= (const CoordinateSystem &rhs ) 
            { 
                _literal = rhs._literal;
            ...
            bool operator== (const CoordinateSystemEnum &rhs) const
            {
             ...
             * @return the enumeration value
             */
            static CoordinateSystemEnum GetFromLiteral(const std::string literal_)
            {
                const auto kIt = _stringToEnum.find(literal_);
                if (kIt != _stringToEnum.end())
                    return kIt->second;
        ...
        */
        ...
        public:
            ...
            LateralDisplacement(LateralDisplacementEnum& lateralDisplacement)
            {
                _literal = kLateralDisplacementEnumString[lateralDisplacement+1];
                _lateralDisplacementEnum = GetFromLiteral(_literal);
            }

            LateralDisplacement(const LateralDisplacementEnum lateralDisplacement)
            {
                _literal = kLateralDisplacementEnumString[lateralDisplacement+1];
                _lateralDisplacementEnum = GetFromLiteral(_literal);
            }
             ...
             * @param literal_ as defined in OpenSCENARIO
             */
            LateralDisplacement(std::string& literal_):_literal(literal_) 
            {
                _lateralDisplacementEnum = GetFromLiteral(_literal);
            }
            ...
            LateralDisplacement& operator= (const LateralDisplacementEnum &rhs)
            {
            ...
            LateralDisplacement& operator= (const LateralDisplacement &rhs ) 
            { 
                _literal = rhs._literal;
            ...
            bool operator== (const LateralDisplacementEnum &rhs) const
            {
             ...
             * @return the enumeration value
             */
            static LateralDisplacementEnum GetFromLiteral(const std::string literal_)
            {
                const auto kIt = _stringToEnum.find(literal_);
                if (kIt != _stringToEnum.end())
                    return kIt->second;
        ...
        */
        ...
        public:
            ...
            LongitudinalDisplacement(LongitudinalDisplacementEnum& longitudinalDisplacement)
            {
                _literal = kLongitudinalDisplacementEnumString[longitudinalDisplacement+1];
                _longitudinalDisplacementEnum = GetFromLiteral(_literal);
            }

            LongitudinalDisplacement(const LongitudinalDisplacementEnum longitudinalDisplacement)
            {
                _literal = kLongitudinalDisplacementEnumString[longitudinalDisplacement+1];
                _longitudinalDisplacementEnum = GetFromLiteral(_literal);
            }
             ...
             * @param literal_ as defined in OpenSCENARIO
             */
            LongitudinalDisplacement(std::string& literal_):_literal(literal_) 
            {
                _longitudinalDisplacementEnum = GetFromLiteral(_literal);
            }
            ...
            LongitudinalDisplacement& operator= (const LongitudinalDisplacementEnum &rhs)
            {
            ...
            LongitudinalDisplacement& operator= (const LongitudinalDisplacement &rhs ) 
            { 
                _literal = rhs._literal;
            ...
            bool operator== (const LongitudinalDisplacementEnum &rhs) const
            {
             ...
             * @return the enumeration value
             */
            static LongitudinalDisplacementEnum GetFromLiteral(const std::string literal_)
            {
                const auto kIt = _stringToEnum.find(literal_);
                if (kIt != _stringToEnum.end())
                    return kIt->second;
