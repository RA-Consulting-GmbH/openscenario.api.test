        ...
        */
        ...
        public:
            ...
            */
            ...
            virtual void AddDeterministicCheckerRule(std::shared_ptr<ICheckerRule<IDeterministic>> checkerRule) = 0;
            virtual void AddDeterministicMultiParameterDistributionCheckerRule(std::shared_ptr<ICheckerRule<IDeterministicMultiParameterDistribution>> checkerRule) = 0;
            virtual void AddDeterministicMultiParameterDistributionTypeCheckerRule(std::shared_ptr<ICheckerRule<IDeterministicMultiParameterDistributionType>> checkerRule) = 0;
            virtual void AddDeterministicParameterDistributionCheckerRule(std::shared_ptr<ICheckerRule<IDeterministicParameterDistribution>> checkerRule) = 0;
            virtual void AddDeterministicSingleParameterDistributionCheckerRule(std::shared_ptr<ICheckerRule<IDeterministicSingleParameterDistribution>> checkerRule) = 0;
            virtual void AddDeterministicSingleParameterDistributionTypeCheckerRule(std::shared_ptr<ICheckerRule<IDeterministicSingleParameterDistributionType>> checkerRule) = 0;
            ...
            virtual void AddDistributionDefinitionCheckerRule(std::shared_ptr<ICheckerRule<IDistributionDefinition>> checkerRule) = 0;
            virtual void AddDistributionRangeCheckerRule(std::shared_ptr<ICheckerRule<IDistributionRange>> checkerRule) = 0;
            virtual void AddDistributionSetCheckerRule(std::shared_ptr<ICheckerRule<IDistributionSet>> checkerRule) = 0;
            virtual void AddDistributionSetElementCheckerRule(std::shared_ptr<ICheckerRule<IDistributionSetElement>> checkerRule) = 0;
            ...
            virtual void AddExternalObjectReferenceCheckerRule(std::shared_ptr<ICheckerRule<IExternalObjectReference>> checkerRule) = 0;
            ...
            virtual void AddGeoPositionCheckerRule(std::shared_ptr<ICheckerRule<IGeoPosition>> checkerRule) = 0;
            virtual void AddGlobalActionCheckerRule(std::shared_ptr<ICheckerRule<IGlobalAction>> checkerRule) = 0;
            virtual void AddHistogramCheckerRule(std::shared_ptr<ICheckerRule<IHistogram>> checkerRule) = 0;
            virtual void AddHistogramBinCheckerRule(std::shared_ptr<ICheckerRule<IHistogramBin>> checkerRule) = 0;
            ...
            virtual void AddLicenseCheckerRule(std::shared_ptr<ICheckerRule<ILicense>> checkerRule) = 0;
            ...
            virtual void AddNormalDistributionCheckerRule(std::shared_ptr<ICheckerRule<INormalDistribution>> checkerRule) = 0;
            ...
            virtual void AddParameterValueDistributionCheckerRule(std::shared_ptr<ICheckerRule<IParameterValueDistribution>> checkerRule) = 0;
            virtual void AddParameterValueDistributionDefinitionCheckerRule(std::shared_ptr<ICheckerRule<IParameterValueDistributionDefinition>> checkerRule) = 0;
            virtual void AddParameterValueSetCheckerRule(std::shared_ptr<ICheckerRule<IParameterValueSet>> checkerRule) = 0;
            ...
            virtual void AddPoissonDistributionCheckerRule(std::shared_ptr<ICheckerRule<IPoissonDistribution>> checkerRule) = 0;
            ...
            virtual void AddProbabilityDistributionSetCheckerRule(std::shared_ptr<ICheckerRule<IProbabilityDistributionSet>> checkerRule) = 0;
            virtual void AddProbabilityDistributionSetElementCheckerRule(std::shared_ptr<ICheckerRule<IProbabilityDistributionSetElement>> checkerRule) = 0;
            ...
            virtual void AddRangeCheckerRule(std::shared_ptr<ICheckerRule<IRange>> checkerRule) = 0;
            ...
            virtual void AddSteadyStateCheckerRule(std::shared_ptr<ICheckerRule<ISteadyState>> checkerRule) = 0;
            virtual void AddStochasticCheckerRule(std::shared_ptr<ICheckerRule<IStochastic>> checkerRule) = 0;
            virtual void AddStochasticDistributionCheckerRule(std::shared_ptr<ICheckerRule<IStochasticDistribution>> checkerRule) = 0;
            virtual void AddStochasticDistributionTypeCheckerRule(std::shared_ptr<ICheckerRule<IStochasticDistributionType>> checkerRule) = 0;
            ...
            virtual void AddTargetDistanceSteadyStateCheckerRule(std::shared_ptr<ICheckerRule<ITargetDistanceSteadyState>> checkerRule) = 0;
            virtual void AddTargetTimeSteadyStateCheckerRule(std::shared_ptr<ICheckerRule<ITargetTimeSteadyState>> checkerRule) = 0;
            ...
            virtual void AddTrafficStopActionCheckerRule(std::shared_ptr<ICheckerRule<ITrafficStopAction>> checkerRule) = 0;
            ...
            virtual void AddTrajectoryPositionCheckerRule(std::shared_ptr<ICheckerRule<ITrajectoryPosition>> checkerRule) = 0;
            virtual void AddTrajectoryRefCheckerRule(std::shared_ptr<ICheckerRule<ITrajectoryRef>> checkerRule) = 0;
            ...
            virtual void AddUniformDistributionCheckerRule(std::shared_ptr<ICheckerRule<IUniformDistribution>> checkerRule) = 0;
            virtual void AddUsedAreaCheckerRule(std::shared_ptr<ICheckerRule<IUsedArea>> checkerRule) = 0;
            virtual void AddUserDefinedActionCheckerRule(std::shared_ptr<ICheckerRule<IUserDefinedAction>> checkerRule) = 0;
            virtual void AddUserDefinedDistributionCheckerRule(std::shared_ptr<ICheckerRule<IUserDefinedDistribution>> checkerRule) = 0;
            ...
            virtual void AddValueConstraintCheckerRule(std::shared_ptr<ICheckerRule<IValueConstraint>> checkerRule) = 0;
            virtual void AddValueConstraintGroupCheckerRule(std::shared_ptr<ICheckerRule<IValueConstraintGroup>> checkerRule) = 0;
            virtual void AddValueSetDistributionCheckerRule(std::shared_ptr<ICheckerRule<IValueSetDistribution>> checkerRule) = 0;
            ...
            virtual void AddWindCheckerRule(std::shared_ptr<ICheckerRule<IWind>> checkerRule) = 0;
