        ...
        */
        ...
        public:
            ...
            */
            ...
            virtual void AddDeterministicCheckerRule(std::shared_ptr<ICheckerRule<IDeterministic>> checkerRule) {};
            virtual void AddDeterministicMultiParameterDistributionCheckerRule(std::shared_ptr<ICheckerRule<IDeterministicMultiParameterDistribution>> checkerRule) {};
            virtual void AddDeterministicMultiParameterDistributionTypeCheckerRule(std::shared_ptr<ICheckerRule<IDeterministicMultiParameterDistributionType>> checkerRule) {};
            virtual void AddDeterministicParameterDistributionCheckerRule(std::shared_ptr<ICheckerRule<IDeterministicParameterDistribution>> checkerRule) {};
            virtual void AddDeterministicSingleParameterDistributionCheckerRule(std::shared_ptr<ICheckerRule<IDeterministicSingleParameterDistribution>> checkerRule) {};
            virtual void AddDeterministicSingleParameterDistributionTypeCheckerRule(std::shared_ptr<ICheckerRule<IDeterministicSingleParameterDistributionType>> checkerRule) {};
            ...
            virtual void AddDistributionDefinitionCheckerRule(std::shared_ptr<ICheckerRule<IDistributionDefinition>> checkerRule) {};
            virtual void AddDistributionRangeCheckerRule(std::shared_ptr<ICheckerRule<IDistributionRange>> checkerRule) {};
            virtual void AddDistributionSetCheckerRule(std::shared_ptr<ICheckerRule<IDistributionSet>> checkerRule) {};
            virtual void AddDistributionSetElementCheckerRule(std::shared_ptr<ICheckerRule<IDistributionSetElement>> checkerRule) {};
            ...
            virtual void AddExternalObjectReferenceCheckerRule(std::shared_ptr<ICheckerRule<IExternalObjectReference>> checkerRule) {};
            ...
            virtual void AddGeoPositionCheckerRule(std::shared_ptr<ICheckerRule<IGeoPosition>> checkerRule) {};
            virtual void AddGlobalActionCheckerRule(std::shared_ptr<ICheckerRule<IGlobalAction>> checkerRule) {};
            virtual void AddHistogramCheckerRule(std::shared_ptr<ICheckerRule<IHistogram>> checkerRule) {};
            virtual void AddHistogramBinCheckerRule(std::shared_ptr<ICheckerRule<IHistogramBin>> checkerRule) {};
            ...
            virtual void AddLicenseCheckerRule(std::shared_ptr<ICheckerRule<ILicense>> checkerRule) {};
            ...
            virtual void AddNormalDistributionCheckerRule(std::shared_ptr<ICheckerRule<INormalDistribution>> checkerRule) {};
            ...
            virtual void AddParameterValueDistributionCheckerRule(std::shared_ptr<ICheckerRule<IParameterValueDistribution>> checkerRule) {};
            virtual void AddParameterValueDistributionDefinitionCheckerRule(std::shared_ptr<ICheckerRule<IParameterValueDistributionDefinition>> checkerRule) {};
            virtual void AddParameterValueSetCheckerRule(std::shared_ptr<ICheckerRule<IParameterValueSet>> checkerRule) {};
            ...
            virtual void AddPoissonDistributionCheckerRule(std::shared_ptr<ICheckerRule<IPoissonDistribution>> checkerRule) {};
            ...
            virtual void AddProbabilityDistributionSetCheckerRule(std::shared_ptr<ICheckerRule<IProbabilityDistributionSet>> checkerRule) {};
            virtual void AddProbabilityDistributionSetElementCheckerRule(std::shared_ptr<ICheckerRule<IProbabilityDistributionSetElement>> checkerRule) {};
            ...
            virtual void AddRangeCheckerRule(std::shared_ptr<ICheckerRule<IRange>> checkerRule) {};
            ...
            virtual void AddSteadyStateCheckerRule(std::shared_ptr<ICheckerRule<ISteadyState>> checkerRule) {};
            virtual void AddStochasticCheckerRule(std::shared_ptr<ICheckerRule<IStochastic>> checkerRule) {};
            virtual void AddStochasticDistributionCheckerRule(std::shared_ptr<ICheckerRule<IStochasticDistribution>> checkerRule) {};
            virtual void AddStochasticDistributionTypeCheckerRule(std::shared_ptr<ICheckerRule<IStochasticDistributionType>> checkerRule) {};
            ...
            virtual void AddTargetDistanceSteadyStateCheckerRule(std::shared_ptr<ICheckerRule<ITargetDistanceSteadyState>> checkerRule) {};
            virtual void AddTargetTimeSteadyStateCheckerRule(std::shared_ptr<ICheckerRule<ITargetTimeSteadyState>> checkerRule) {};
            ...
            virtual void AddTrafficStopActionCheckerRule(std::shared_ptr<ICheckerRule<ITrafficStopAction>> checkerRule) {};
            ...
            virtual void AddTrajectoryPositionCheckerRule(std::shared_ptr<ICheckerRule<ITrajectoryPosition>> checkerRule) {};
            virtual void AddTrajectoryRefCheckerRule(std::shared_ptr<ICheckerRule<ITrajectoryRef>> checkerRule) {};
            ...
            virtual void AddUniformDistributionCheckerRule(std::shared_ptr<ICheckerRule<IUniformDistribution>> checkerRule) {};
            virtual void AddUsedAreaCheckerRule(std::shared_ptr<ICheckerRule<IUsedArea>> checkerRule) {};
            virtual void AddUserDefinedActionCheckerRule(std::shared_ptr<ICheckerRule<IUserDefinedAction>> checkerRule) {};
            virtual void AddUserDefinedDistributionCheckerRule(std::shared_ptr<ICheckerRule<IUserDefinedDistribution>> checkerRule) {};
            virtual void AddUserDefinedValueConditionCheckerRule(std::shared_ptr<ICheckerRule<IUserDefinedValueCondition>> checkerRule) {};
            virtual void AddValueConstraintCheckerRule(std::shared_ptr<ICheckerRule<IValueConstraint>> checkerRule) {};
            virtual void AddValueConstraintGroupCheckerRule(std::shared_ptr<ICheckerRule<IValueConstraintGroup>> checkerRule) {};
            virtual void AddValueSetDistributionCheckerRule(std::shared_ptr<ICheckerRule<IValueSetDistribution>> checkerRule) {};
            ...
            virtual void AddWindCheckerRule(std::shared_ptr<ICheckerRule<IWind>> checkerRule) {};
