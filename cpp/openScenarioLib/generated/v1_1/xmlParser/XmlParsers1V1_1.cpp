...
namespace NET_ASAM_OPENSCENARIO
{
    namespace v1_1
    {
        ...
        */
        ...
        void AbsoluteSpeedXmlParser::SubElementSteadyStateParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<AbsoluteSpeedImpl>& object)
        {
        ...
        */
        ...
        std::map<std::string, std::shared_ptr<IAttributeParser<AssignControllerActionImpl>>> AssignControllerActionXmlParser::GetAttributeNameToAttributeParserMap()
        {
            ...
            class AttributeActivateLateral: public IAttributeParser<AssignControllerActionImpl>, public XmlParserBase<AssignControllerActionImpl>
            {
            public:
                AttributeActivateLateral(IParserMessageLogger& messageLogger, std::string& filename):XmlParserBase(messageLogger, filename) {}

                void Parse(Position& startPosition, Position& endPosition, std::string& attributeName, std::string& attributeValue, std::shared_ptr<AssignControllerActionImpl>& object) override
                {
                    Textmarker startMarker(startPosition.GetLine(), startPosition.GetColumn(), _filename);
                    Textmarker endMarker(endPosition.GetLine(), endPosition.GetColumn(), _filename);
                    if (IsParametrized(attributeValue))
                    {
                        object->SetAttributeParameter(OSC_CONSTANTS::ATTRIBUTE__ACTIVATE_LATERAL, StripDollarSign(attributeValue), startMarker); 
                    }
                    else
                    {
                        // Parse value
                        // Simple type
                        object->SetActivateLateral(ParseBoolean(attributeValue, startMarker));
                    }
                    object->PutPropertyStartMarker(OSC_CONSTANTS::ATTRIBUTE__ACTIVATE_LATERAL, std::make_shared<Textmarker>(startMarker));
                    object->PutPropertyEndMarker(OSC_CONSTANTS::ATTRIBUTE__ACTIVATE_LATERAL, std::make_shared<Textmarker>(endMarker));
            ...
            class AttributeActivateLongitudinal: public IAttributeParser<AssignControllerActionImpl>, public XmlParserBase<AssignControllerActionImpl>
            {
            public:
                ...
                void Parse(Position& startPosition, Position& endPosition, std::string& attributeName, std::string& attributeValue, std::shared_ptr<AssignControllerActionImpl>& object) override
                {
                    ...
                    if (IsParametrized(attributeValue))
                    {
                        object->SetAttributeParameter(OSC_CONSTANTS::ATTRIBUTE__ACTIVATE_LONGITUDINAL, StripDollarSign(attributeValue), startMarker); 
                    }
                    else
                    {
                        // Parse value
                        // Simple type
                        object->SetActivateLongitudinal(ParseBoolean(attributeValue, startMarker));
                    }
                    object->PutPropertyStartMarker(OSC_CONSTANTS::ATTRIBUTE__ACTIVATE_LONGITUDINAL, std::make_shared<Textmarker>(startMarker));
                    object->PutPropertyEndMarker(OSC_CONSTANTS::ATTRIBUTE__ACTIVATE_LONGITUDINAL, std::make_shared<Textmarker>(endMarker));
        ...
        */
        ...
        std::map<std::string, std::shared_ptr<IAttributeParser<ClothoidImpl>>> ClothoidXmlParser::GetAttributeNameToAttributeParserMap()
        {
            ...
            class AttributeCurvaturePrime: public IAttributeParser<ClothoidImpl>, public XmlParserBase<ClothoidImpl>
            {
            public:
                ...
                void Parse(Position& startPosition, Position& endPosition, std::string& attributeName, std::string& attributeValue, std::shared_ptr<ClothoidImpl>& object) override
                {
                    ...
                    if (IsParametrized(attributeValue))
                    {
                        object->SetAttributeParameter(OSC_CONSTANTS::ATTRIBUTE__CURVATURE_PRIME, StripDollarSign(attributeValue), startMarker); 
                    }
                    else
                    {
                        // Parse value
                        // Simple type
                        object->SetCurvaturePrime(ParseDouble(attributeValue, startMarker));
                    }
                    object->PutPropertyStartMarker(OSC_CONSTANTS::ATTRIBUTE__CURVATURE_PRIME, std::make_shared<Textmarker>(startMarker));
                    object->PutPropertyEndMarker(OSC_CONSTANTS::ATTRIBUTE__CURVATURE_PRIME, std::make_shared<Textmarker>(endMarker));
        ...
        */
        ...
        void ControllerActionXmlParser::SubElementActivateControllerActionParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<ControllerActionImpl>& object)
        {
        ...
        */
        ...
        std::map<std::string, std::shared_ptr<IAttributeParser<DeterministicImpl>>> DeterministicXmlParser::GetAttributeNameToAttributeParserMap()
        {
            std::map<std::string, std::shared_ptr<IAttributeParser<DeterministicImpl>>> result;

            return result;
        }

        std::vector<std::shared_ptr<IElementParser<DeterministicImpl>>> DeterministicXmlParser::SubElementParser::CreateParserList()
        {
            std::vector<std::shared_ptr<IElementParser<DeterministicImpl>>> result;
        ...
        void DeterministicXmlParser::SubElementDeterministicParameterDistributionsParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<DeterministicImpl>& object)
        {
            ...
            auto deterministicParameterDistributionsList = object->GetWriterDeterministicParameterDistributions();
            deterministicParameterDistributionsList.push_back(deterministicParameterDistributions);
            object->SetDeterministicParameterDistributions(deterministicParameterDistributionsList);
        }
        ...
        */
        ...
        std::map<std::string, std::shared_ptr<IAttributeParser<DeterministicMultiParameterDistributionImpl>>> DeterministicMultiParameterDistributionXmlParser::GetAttributeNameToAttributeParserMap()
        {
            std::map<std::string, std::shared_ptr<IAttributeParser<DeterministicMultiParameterDistributionImpl>>> result;

            return result;
        }

        std::vector<std::shared_ptr<IElementParser<DeterministicMultiParameterDistributionImpl>>> DeterministicMultiParameterDistributionXmlParser::SubElementParser::CreateParserList()
        {
            std::vector<std::shared_ptr<IElementParser<DeterministicMultiParameterDistributionImpl>>> result;
        ...
        void DeterministicMultiParameterDistributionXmlParser::SubElementDeterministicMultiParameterDistributionTypeParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<DeterministicMultiParameterDistributionImpl>& object)
        {
            ...
            object->SetDeterministicMultiParameterDistributionType(deterministicMultiParameterDistributionType);
        }
        ...
        */
        ...
        std::vector<std::shared_ptr<IElementParser<DeterministicMultiParameterDistributionTypeImpl>>> DeterministicMultiParameterDistributionTypeXmlParser::SubElementParser::CreateParserList()
        {
            std::vector<std::shared_ptr<IElementParser<DeterministicMultiParameterDistributionTypeImpl>>> result;
        ...
        void DeterministicMultiParameterDistributionTypeXmlParser::SubElementValueSetDistributionParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<DeterministicMultiParameterDistributionTypeImpl>& object)
        {
            ...
            object->SetValueSetDistribution(valueSetDistribution);
        }
        ...
        */
        ...
        std::vector<std::shared_ptr<IElementParser<DeterministicParameterDistributionImpl>>> DeterministicParameterDistributionXmlParser::SubElementParser::CreateParserList()
        {
            std::vector<std::shared_ptr<IElementParser<DeterministicParameterDistributionImpl>>> result;
        ...
        void DeterministicParameterDistributionXmlParser::SubElementDeterministicMultiParameterDistributionParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<DeterministicParameterDistributionImpl>& object)
        {
            ...
            object->SetDeterministicMultiParameterDistribution(deterministicMultiParameterDistribution);
        }
        ...
        void DeterministicParameterDistributionXmlParser::SubElementDeterministicSingleParameterDistributionParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<DeterministicParameterDistributionImpl>& object)
        {
            ...
            object->SetDeterministicSingleParameterDistribution(deterministicSingleParameterDistribution);
        }
        ...
        */
        ...
        std::map<std::string, std::shared_ptr<IAttributeParser<DeterministicSingleParameterDistributionImpl>>> DeterministicSingleParameterDistributionXmlParser::GetAttributeNameToAttributeParserMap()
        {
            std::map<std::string, std::shared_ptr<IAttributeParser<DeterministicSingleParameterDistributionImpl>>> result;

            class AttributeParameterName: public IAttributeParser<DeterministicSingleParameterDistributionImpl>, public XmlParserBase<DeterministicSingleParameterDistributionImpl>
            {
            public:
                AttributeParameterName(IParserMessageLogger& messageLogger, std::string& filename):XmlParserBase(messageLogger, filename) {}

                void Parse(Position& startPosition, Position& endPosition, std::string& attributeName, std::string& attributeValue, std::shared_ptr<DeterministicSingleParameterDistributionImpl>& object) override
                {
                    Textmarker startMarker(startPosition.GetLine(), startPosition.GetColumn(), _filename);
                    Textmarker endMarker(endPosition.GetLine(), endPosition.GetColumn(), _filename);
                    if (IsParametrized(attributeValue))
        ...
        std::vector<std::shared_ptr<IElementParser<DeterministicSingleParameterDistributionImpl>>> DeterministicSingleParameterDistributionXmlParser::SubElementParser::CreateParserList()
        {
            std::vector<std::shared_ptr<IElementParser<DeterministicSingleParameterDistributionImpl>>> result;
        ...
        void DeterministicSingleParameterDistributionXmlParser::SubElementDeterministicSingleParameterDistributionTypeParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<DeterministicSingleParameterDistributionImpl>& object)
        {
            ...
            object->SetDeterministicSingleParameterDistributionType(deterministicSingleParameterDistributionType);
        }
        ...
        */
        ...
        std::vector<std::shared_ptr<IElementParser<DeterministicSingleParameterDistributionTypeImpl>>> DeterministicSingleParameterDistributionTypeXmlParser::SubElementParser::CreateParserList()
        {
            std::vector<std::shared_ptr<IElementParser<DeterministicSingleParameterDistributionTypeImpl>>> result;
        ...
        void DeterministicSingleParameterDistributionTypeXmlParser::SubElementDistributionSetParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<DeterministicSingleParameterDistributionTypeImpl>& object)
        {
            ...
            object->SetDistributionSet(distributionSet);
        }
        ...
        void DeterministicSingleParameterDistributionTypeXmlParser::SubElementDistributionRangeParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<DeterministicSingleParameterDistributionTypeImpl>& object)
        {
            ...
            object->SetDistributionRange(distributionRange);
        }
        ...
        void DeterministicSingleParameterDistributionTypeXmlParser::SubElementUserDefinedDistributionParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<DeterministicSingleParameterDistributionTypeImpl>& object)
        {
        ...
        */
        ...
        std::map<std::string, std::shared_ptr<IAttributeParser<DistanceConditionImpl>>> DistanceConditionXmlParser::GetAttributeNameToAttributeParserMap()
        {
            ...
            class AttributeCoordinateSystem: public IAttributeParser<DistanceConditionImpl>, public XmlParserBase<DistanceConditionImpl>
            {
            public:
            ...
            class AttributeRelativeDistanceType: public IAttributeParser<DistanceConditionImpl>, public XmlParserBase<DistanceConditionImpl>
            {
            public:
        ...
        */
        ...
        std::vector<std::shared_ptr<IElementParser<DistributionDefinitionImpl>>> DistributionDefinitionXmlParser::SubElementParser::CreateParserList()
        {
            std::vector<std::shared_ptr<IElementParser<DistributionDefinitionImpl>>> result;
        ...
        void DistributionDefinitionXmlParser::SubElementDeterministicParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<DistributionDefinitionImpl>& object)
        {
            ...
            object->SetDeterministic(deterministic);
        }
        ...
        void DistributionDefinitionXmlParser::SubElementStochasticParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<DistributionDefinitionImpl>& object)
        {
            ...
            object->SetStochastic(stochastic);
        }
        ...
        */
        ...
        std::map<std::string, std::shared_ptr<IAttributeParser<DistributionRangeImpl>>> DistributionRangeXmlParser::GetAttributeNameToAttributeParserMap()
        {
            std::map<std::string, std::shared_ptr<IAttributeParser<DistributionRangeImpl>>> result;

            class AttributeStepWidth: public IAttributeParser<DistributionRangeImpl>, public XmlParserBase<DistributionRangeImpl>
            {
            public:
                AttributeStepWidth(IParserMessageLogger& messageLogger, std::string& filename):XmlParserBase(messageLogger, filename) {}

                void Parse(Position& startPosition, Position& endPosition, std::string& attributeName, std::string& attributeValue, std::shared_ptr<DistributionRangeImpl>& object) override
                {
                    Textmarker startMarker(startPosition.GetLine(), startPosition.GetColumn(), _filename);
                    Textmarker endMarker(endPosition.GetLine(), endPosition.GetColumn(), _filename);
                    if (IsParametrized(attributeValue))
                    {
                        object->SetAttributeParameter(OSC_CONSTANTS::ATTRIBUTE__STEP_WIDTH, StripDollarSign(attributeValue), startMarker); 
                    }
                    else
                    {
                        // Parse value
                        // Simple type
                        object->SetStepWidth(ParseDouble(attributeValue, startMarker));
                    }
                    object->PutPropertyStartMarker(OSC_CONSTANTS::ATTRIBUTE__STEP_WIDTH, std::make_shared<Textmarker>(startMarker));
                    object->PutPropertyEndMarker(OSC_CONSTANTS::ATTRIBUTE__STEP_WIDTH, std::make_shared<Textmarker>(endMarker));
        ...
        std::vector<std::shared_ptr<IElementParser<DistributionRangeImpl>>> DistributionRangeXmlParser::SubElementParser::CreateParserList()
        {
            std::vector<std::shared_ptr<IElementParser<DistributionRangeImpl>>> result;
        ...
        void DistributionRangeXmlParser::SubElementRangeParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<DistributionRangeImpl>& object)
        {
        ...
        */
        ...
        std::map<std::string, std::shared_ptr<IAttributeParser<DistributionSetImpl>>> DistributionSetXmlParser::GetAttributeNameToAttributeParserMap()
        {
            std::map<std::string, std::shared_ptr<IAttributeParser<DistributionSetImpl>>> result;

            return result;
        }

        std::vector<std::shared_ptr<IElementParser<DistributionSetImpl>>> DistributionSetXmlParser::SubElementParser::CreateParserList()
        {
            std::vector<std::shared_ptr<IElementParser<DistributionSetImpl>>> result;
        ...
        void DistributionSetXmlParser::SubElementElementsParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<DistributionSetImpl>& object)
        {
        ...
        */
        ...
        std::map<std::string, std::shared_ptr<IAttributeParser<DistributionSetElementImpl>>> DistributionSetElementXmlParser::GetAttributeNameToAttributeParserMap()
        {
            std::map<std::string, std::shared_ptr<IAttributeParser<DistributionSetElementImpl>>> result;

            class AttributeValue: public IAttributeParser<DistributionSetElementImpl>, public XmlParserBase<DistributionSetElementImpl>
            {
            public:
                AttributeValue(IParserMessageLogger& messageLogger, std::string& filename):XmlParserBase(messageLogger, filename) {}

                void Parse(Position& startPosition, Position& endPosition, std::string& attributeName, std::string& attributeValue, std::shared_ptr<DistributionSetElementImpl>& object) override
                {
                    Textmarker startMarker(startPosition.GetLine(), startPosition.GetColumn(), _filename);
                    Textmarker endMarker(endPosition.GetLine(), endPosition.GetColumn(), _filename);
                    if (IsParametrized(attributeValue))
        ...
        std::vector<std::shared_ptr<IElementParser<DistributionSetElementImpl>>> DistributionSetElementXmlParser::SubElementParser::CreateParserList()
        {
            std::vector<std::shared_ptr<IElementParser<DistributionSetElementImpl>>> result;
            return result;
        }
        ...
        */
        ...
        void EntityObjectXmlParser::SubElementExternalObjectReferenceParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<EntityObjectImpl>& object)
        {
            ...
            object->SetExternalObjectReference(externalObjectReference);
        }
        ...
        */
        ...
        std::map<std::string, std::shared_ptr<IAttributeParser<ExternalObjectReferenceImpl>>> ExternalObjectReferenceXmlParser::GetAttributeNameToAttributeParserMap()
        {
            std::map<std::string, std::shared_ptr<IAttributeParser<ExternalObjectReferenceImpl>>> result;

            class AttributeName: public IAttributeParser<ExternalObjectReferenceImpl>, public XmlParserBase<ExternalObjectReferenceImpl>
            {
            public:
                AttributeName(IParserMessageLogger& messageLogger, std::string& filename):XmlParserBase(messageLogger, filename) {}

                void Parse(Position& startPosition, Position& endPosition, std::string& attributeName, std::string& attributeValue, std::shared_ptr<ExternalObjectReferenceImpl>& object) override
                {
                    Textmarker startMarker(startPosition.GetLine(), startPosition.GetColumn(), _filename);
                    Textmarker endMarker(endPosition.GetLine(), endPosition.GetColumn(), _filename);
                    if (IsParametrized(attributeValue))
        ...
        std::vector<std::shared_ptr<IElementParser<ExternalObjectReferenceImpl>>> ExternalObjectReferenceXmlParser::SubElementParser::CreateParserList()
        {
            std::vector<std::shared_ptr<IElementParser<ExternalObjectReferenceImpl>>> result;
            return result;
        }
        ...
        */
        ...
        void FileHeaderXmlParser::SubElementLicenseParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<FileHeaderImpl>& object)
        {
        ...
        */
        ...
        std::map<std::string, std::shared_ptr<IAttributeParser<FollowTrajectoryActionImpl>>> FollowTrajectoryActionXmlParser::GetAttributeNameToAttributeParserMap()
        {
            ...
            class AttributeInitialDistanceOffset: public IAttributeParser<FollowTrajectoryActionImpl>, public XmlParserBase<FollowTrajectoryActionImpl>
            {
            public:
                ...
                void Parse(Position& startPosition, Position& endPosition, std::string& attributeName, std::string& attributeValue, std::shared_ptr<FollowTrajectoryActionImpl>& object) override
                {
                    Textmarker startMarker(startPosition.GetLine(), startPosition.GetColumn(), _filename);
                    Textmarker endMarker(endPosition.GetLine(), endPosition.GetColumn(), _filename);
                    if (IsParametrized(attributeValue))
                    {
                        object->SetAttributeParameter(OSC_CONSTANTS::ATTRIBUTE__INITIAL_DISTANCE_OFFSET, StripDollarSign(attributeValue), startMarker); 
                    }
                    else
                    {
                        // Parse value
                        // Simple type
                        object->SetInitialDistanceOffset(ParseDouble(attributeValue, startMarker));
                    }
                    object->PutPropertyStartMarker(OSC_CONSTANTS::ATTRIBUTE__INITIAL_DISTANCE_OFFSET, std::make_shared<Textmarker>(startMarker));
                    object->PutPropertyEndMarker(OSC_CONSTANTS::ATTRIBUTE__INITIAL_DISTANCE_OFFSET, std::make_shared<Textmarker>(endMarker));
        ...
        void FollowTrajectoryActionXmlParser::SubElementTrajectoryRefParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<FollowTrajectoryActionImpl>& object)
        {
        ...
        */
        ...
        std::map<std::string, std::shared_ptr<IAttributeParser<GeoPositionImpl>>> GeoPositionXmlParser::GetAttributeNameToAttributeParserMap()
        {
            std::map<std::string, std::shared_ptr<IAttributeParser<GeoPositionImpl>>> result;

            class AttributeHeight: public IAttributeParser<GeoPositionImpl>, public XmlParserBase<GeoPositionImpl>
            {
            public:
                AttributeHeight(IParserMessageLogger& messageLogger, std::string& filename):XmlParserBase(messageLogger, filename) {}

                void Parse(Position& startPosition, Position& endPosition, std::string& attributeName, std::string& attributeValue, std::shared_ptr<GeoPositionImpl>& object) override
                {
                    Textmarker startMarker(startPosition.GetLine(), startPosition.GetColumn(), _filename);
                    Textmarker endMarker(endPosition.GetLine(), endPosition.GetColumn(), _filename);
                    if (IsParametrized(attributeValue))
            ...
            result.emplace(std::make_pair(OSC_CONSTANTS::ATTRIBUTE__HEIGHT, std::make_shared<AttributeHeight>(_messageLogger, _filename)));
            class AttributeLatitude: public IAttributeParser<GeoPositionImpl>, public XmlParserBase<GeoPositionImpl>
            {
            public:
                ...
                void Parse(Position& startPosition, Position& endPosition, std::string& attributeName, std::string& attributeValue, std::shared_ptr<GeoPositionImpl>& object) override
                {
                    ...
                    if (IsParametrized(attributeValue))
                    {
                        object->SetAttributeParameter(OSC_CONSTANTS::ATTRIBUTE__LATITUDE, StripDollarSign(attributeValue), startMarker); 
                    }
                    else
                    {
                        // Parse value
                        // Simple type
                        object->SetLatitude(ParseDouble(attributeValue, startMarker));
                    }
                    object->PutPropertyStartMarker(OSC_CONSTANTS::ATTRIBUTE__LATITUDE, std::make_shared<Textmarker>(startMarker));
                    object->PutPropertyEndMarker(OSC_CONSTANTS::ATTRIBUTE__LATITUDE, std::make_shared<Textmarker>(endMarker));
            ...
            class AttributeLongitude: public IAttributeParser<GeoPositionImpl>, public XmlParserBase<GeoPositionImpl>
            {
            public:
                ...
                void Parse(Position& startPosition, Position& endPosition, std::string& attributeName, std::string& attributeValue, std::shared_ptr<GeoPositionImpl>& object) override
                {
                    ...
                    if (IsParametrized(attributeValue))
                    {
                        object->SetAttributeParameter(OSC_CONSTANTS::ATTRIBUTE__LONGITUDE, StripDollarSign(attributeValue), startMarker); 
                    }
                    else
                    {
                        // Parse value
                        // Simple type
                        object->SetLongitude(ParseDouble(attributeValue, startMarker));
                    }
                    object->PutPropertyStartMarker(OSC_CONSTANTS::ATTRIBUTE__LONGITUDE, std::make_shared<Textmarker>(startMarker));
                    object->PutPropertyEndMarker(OSC_CONSTANTS::ATTRIBUTE__LONGITUDE, std::make_shared<Textmarker>(endMarker));
        ...
        std::vector<std::shared_ptr<IElementParser<GeoPositionImpl>>> GeoPositionXmlParser::SubElementParser::CreateParserList()
        {
            std::vector<std::shared_ptr<IElementParser<GeoPositionImpl>>> result;
        ...
        void GeoPositionXmlParser::SubElementOrientationParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<GeoPositionImpl>& object)
        {
        ...
        */
        ...
        std::map<std::string, std::shared_ptr<IAttributeParser<HistogramImpl>>> HistogramXmlParser::GetAttributeNameToAttributeParserMap()
        {
            std::map<std::string, std::shared_ptr<IAttributeParser<HistogramImpl>>> result;

            return result;
        }

        std::vector<std::shared_ptr<IElementParser<HistogramImpl>>> HistogramXmlParser::SubElementParser::CreateParserList()
        {
            std::vector<std::shared_ptr<IElementParser<HistogramImpl>>> result;
        ...
        void HistogramXmlParser::SubElementBinsParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<HistogramImpl>& object)
        {
            ...
            auto binsList = object->GetWriterBins();
            binsList.push_back(bins);
            object->SetBins(binsList);
        }
        ...
        */
        ...
        std::map<std::string, std::shared_ptr<IAttributeParser<HistogramBinImpl>>> HistogramBinXmlParser::GetAttributeNameToAttributeParserMap()
        {
            std::map<std::string, std::shared_ptr<IAttributeParser<HistogramBinImpl>>> result;

            class AttributeWeight: public IAttributeParser<HistogramBinImpl>, public XmlParserBase<HistogramBinImpl>
            {
            public:
                AttributeWeight(IParserMessageLogger& messageLogger, std::string& filename):XmlParserBase(messageLogger, filename) {}

                void Parse(Position& startPosition, Position& endPosition, std::string& attributeName, std::string& attributeValue, std::shared_ptr<HistogramBinImpl>& object) override
                {
                    Textmarker startMarker(startPosition.GetLine(), startPosition.GetColumn(), _filename);
                    Textmarker endMarker(endPosition.GetLine(), endPosition.GetColumn(), _filename);
                    if (IsParametrized(attributeValue))
        ...
        std::vector<std::shared_ptr<IElementParser<HistogramBinImpl>>> HistogramBinXmlParser::SubElementParser::CreateParserList()
        {
            std::vector<std::shared_ptr<IElementParser<HistogramBinImpl>>> result;
            result.push_back(std::make_shared<SubElementRangeParser>(_messageLogger, _filename));
            return result;
        }
        ...
        void HistogramBinXmlParser::SubElementRangeParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<HistogramBinImpl>& object)
        {
            auto range = std::make_shared<RangeImpl>();
            // Setting the parent
            range->SetParent(object);
        ...
        */
        ...
        std::map<std::string, std::shared_ptr<IAttributeParser<LateralDistanceActionImpl>>> LateralDistanceActionXmlParser::GetAttributeNameToAttributeParserMap()
        {
            ...
            result.emplace(std::make_pair(OSC_CONSTANTS::ATTRIBUTE__CONTINUOUS, std::make_shared<AttributeContinuous>(_messageLogger, _filename)));
            class AttributeCoordinateSystem: public IAttributeParser<LateralDistanceActionImpl>, public XmlParserBase<LateralDistanceActionImpl>
            {
            public:
                AttributeCoordinateSystem(IParserMessageLogger& messageLogger, std::string& filename):XmlParserBase(messageLogger, filename) {}
            ...
            result.emplace(std::make_pair(OSC_CONSTANTS::ATTRIBUTE__COORDINATE_SYSTEM, std::make_shared<AttributeCoordinateSystem>(_messageLogger, _filename)));
            class AttributeDisplacement: public IAttributeParser<LateralDistanceActionImpl>, public XmlParserBase<LateralDistanceActionImpl>
            {
            public:
                ...
                void Parse(Position& startPosition, Position& endPosition, std::string& attributeName, std::string& attributeValue, std::shared_ptr<LateralDistanceActionImpl>& object) override
                {
                    ...
                    if (IsParametrized(attributeValue))
                    {
                        object->SetAttributeParameter(OSC_CONSTANTS::ATTRIBUTE__DISPLACEMENT, StripDollarSign(attributeValue), startMarker); 
                    }
                    else
                    {
                        // Parse value
                        ...
                        {
                            object->SetDisplacement(attributeValue);
                        }
                        else
                        {
                            auto msg = FileContentMessage("Value '" + attributeValue + "' is not allowed.", ERROR, startMarker);
                    ...
                    object->PutPropertyStartMarker(OSC_CONSTANTS::ATTRIBUTE__DISPLACEMENT, std::make_shared<Textmarker>(startMarker));
                    object->PutPropertyEndMarker(OSC_CONSTANTS::ATTRIBUTE__DISPLACEMENT, std::make_shared<Textmarker>(endMarker));
        ...
        */
        ...
        std::map<std::string, std::shared_ptr<IAttributeParser<LicenseImpl>>> LicenseXmlParser::GetAttributeNameToAttributeParserMap()
        {
            std::map<std::string, std::shared_ptr<IAttributeParser<LicenseImpl>>> result;

            class AttributeName: public IAttributeParser<LicenseImpl>, public XmlParserBase<LicenseImpl>
            {
            public:
                AttributeName(IParserMessageLogger& messageLogger, std::string& filename):XmlParserBase(messageLogger, filename) {}

                void Parse(Position& startPosition, Position& endPosition, std::string& attributeName, std::string& attributeValue, std::shared_ptr<LicenseImpl>& object) override
                {
                    Textmarker startMarker(startPosition.GetLine(), startPosition.GetColumn(), _filename);
                    Textmarker endMarker(endPosition.GetLine(), endPosition.GetColumn(), _filename);
                    if (IsParametrized(attributeValue))
            ...
            result.emplace(std::make_pair(OSC_CONSTANTS::ATTRIBUTE__NAME, std::make_shared<AttributeName>(_messageLogger, _filename)));
            class AttributeResource: public IAttributeParser<LicenseImpl>, public XmlParserBase<LicenseImpl>
            {
            public:
                ...
                void Parse(Position& startPosition, Position& endPosition, std::string& attributeName, std::string& attributeValue, std::shared_ptr<LicenseImpl>& object) override
                {
                    ...
                    if (IsParametrized(attributeValue))
                    {
                        object->SetAttributeParameter(OSC_CONSTANTS::ATTRIBUTE__RESOURCE, StripDollarSign(attributeValue), startMarker); 
                    }
                    else
                    {
                        // Parse value
                        // Simple type
                        object->SetResource(ParseString(attributeValue, startMarker));
                    }
                    object->PutPropertyStartMarker(OSC_CONSTANTS::ATTRIBUTE__RESOURCE, std::make_shared<Textmarker>(startMarker));
                    object->PutPropertyEndMarker(OSC_CONSTANTS::ATTRIBUTE__RESOURCE, std::make_shared<Textmarker>(endMarker));
            ...
            class AttributeSpdxId: public IAttributeParser<LicenseImpl>, public XmlParserBase<LicenseImpl>
            {
            public:
                ...
                void Parse(Position& startPosition, Position& endPosition, std::string& attributeName, std::string& attributeValue, std::shared_ptr<LicenseImpl>& object) override
                {
                    ...
                    if (IsParametrized(attributeValue))
                    {
                        object->SetAttributeParameter(OSC_CONSTANTS::ATTRIBUTE__SPDX_ID, StripDollarSign(attributeValue), startMarker); 
                    }
                    else
                    {
                        // Parse value
                        // Simple type
                        object->SetSpdxId(ParseString(attributeValue, startMarker));
                    }
                    object->PutPropertyStartMarker(OSC_CONSTANTS::ATTRIBUTE__SPDX_ID, std::make_shared<Textmarker>(startMarker));
                    object->PutPropertyEndMarker(OSC_CONSTANTS::ATTRIBUTE__SPDX_ID, std::make_shared<Textmarker>(endMarker));
        ...
        void LicenseXmlParser::SetContentProperty(const std::string content, std::shared_ptr<LicenseImpl>& object)
        {
        ...
        */
        ...
        std::map<std::string, std::shared_ptr<IAttributeParser<LongitudinalDistanceActionImpl>>> LongitudinalDistanceActionXmlParser::GetAttributeNameToAttributeParserMap()
        {
            ...
            result.emplace(std::make_pair(OSC_CONSTANTS::ATTRIBUTE__CONTINUOUS, std::make_shared<AttributeContinuous>(_messageLogger, _filename)));
            class AttributeCoordinateSystem: public IAttributeParser<LongitudinalDistanceActionImpl>, public XmlParserBase<LongitudinalDistanceActionImpl>
            {
            public:
                AttributeCoordinateSystem(IParserMessageLogger& messageLogger, std::string& filename):XmlParserBase(messageLogger, filename) {}
            ...
            result.emplace(std::make_pair(OSC_CONSTANTS::ATTRIBUTE__COORDINATE_SYSTEM, std::make_shared<AttributeCoordinateSystem>(_messageLogger, _filename)));
            class AttributeDisplacement: public IAttributeParser<LongitudinalDistanceActionImpl>, public XmlParserBase<LongitudinalDistanceActionImpl>
            {
            public:
                AttributeDisplacement(IParserMessageLogger& messageLogger, std::string& filename):XmlParserBase(messageLogger, filename) {}
        ...
        */
        ...
        std::map<std::string, std::shared_ptr<IAttributeParser<MiscObjectImpl>>> MiscObjectXmlParser::GetAttributeNameToAttributeParserMap()
        {
            ...
            class AttributeModel3d: public IAttributeParser<MiscObjectImpl>, public XmlParserBase<MiscObjectImpl>
            {
            public:
        ...
        */
        ...
        std::map<std::string, std::shared_ptr<IAttributeParser<NormalDistributionImpl>>> NormalDistributionXmlParser::GetAttributeNameToAttributeParserMap()
        {
            std::map<std::string, std::shared_ptr<IAttributeParser<NormalDistributionImpl>>> result;

            class AttributeExpectedValue: public IAttributeParser<NormalDistributionImpl>, public XmlParserBase<NormalDistributionImpl>
            {
            public:
                AttributeExpectedValue(IParserMessageLogger& messageLogger, std::string& filename):XmlParserBase(messageLogger, filename) {}

                void Parse(Position& startPosition, Position& endPosition, std::string& attributeName, std::string& attributeValue, std::shared_ptr<NormalDistributionImpl>& object) override
                {
                    Textmarker startMarker(startPosition.GetLine(), startPosition.GetColumn(), _filename);
                    Textmarker endMarker(endPosition.GetLine(), endPosition.GetColumn(), _filename);
                    if (IsParametrized(attributeValue))
            ...
            class AttributeVariance: public IAttributeParser<NormalDistributionImpl>, public XmlParserBase<NormalDistributionImpl>
            {
            public:
                ...
                void Parse(Position& startPosition, Position& endPosition, std::string& attributeName, std::string& attributeValue, std::shared_ptr<NormalDistributionImpl>& object) override
                {
                    ...
                    if (IsParametrized(attributeValue))
                    {
                        object->SetAttributeParameter(OSC_CONSTANTS::ATTRIBUTE__VARIANCE, StripDollarSign(attributeValue), startMarker); 
                    }
                    else
                    {
                        // Parse value
                        // Simple type
                        object->SetVariance(ParseDouble(attributeValue, startMarker));
                    }
                    object->PutPropertyStartMarker(OSC_CONSTANTS::ATTRIBUTE__VARIANCE, std::make_shared<Textmarker>(startMarker));
                    object->PutPropertyEndMarker(OSC_CONSTANTS::ATTRIBUTE__VARIANCE, std::make_shared<Textmarker>(endMarker));
        ...
        std::vector<std::shared_ptr<IElementParser<NormalDistributionImpl>>> NormalDistributionXmlParser::SubElementParser::CreateParserList()
        {
            std::vector<std::shared_ptr<IElementParser<NormalDistributionImpl>>> result;
            result.push_back(std::make_shared<SubElementRangeParser>(_messageLogger, _filename));
            return result;
        }
        ...
        void NormalDistributionXmlParser::SubElementRangeParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<NormalDistributionImpl>& object)
        {
            auto range = std::make_shared<RangeImpl>();
            // Setting the parent
            range->SetParent(object);
        ...
        */
        ...
        void OpenScenarioCategoryXmlParser::SubElementParameterValueDistributionDefinitionParser::Parse(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr<ParserContext>& parserContext, std::shared_ptr<OpenScenarioCategoryImpl>& object)
        {
            ...
            object->SetParameterValueDistributionDefinition(parameterValueDistributionDefinition);
        }
