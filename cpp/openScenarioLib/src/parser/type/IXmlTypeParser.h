...
namespace NET_ASAM_OPENSCENARIO
{
    ...
    */
    ...
    public:
        ...
        virtual void ParseElement(std::shared_ptr<IndexedElement>& indexedElement, std::shared_ptr <ParserContext>& parserContext, std::shared_ptr <BaseImpl> object) {} //throw(XmlParserException) {}
